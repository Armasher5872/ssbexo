...
pub unsafe extern "C" fn attack_hi4_cancel(fighter: &mut L2CFighterCommon) -> bool {
    ...
    let attack_dash_frame = WorkModule::get_int(boma, *FIGHTER_STATUS_ATTACK_DASH_WORK_INT_FRAME);
    ...
    WorkModule::is_enable_transition_term(boma, *FIGHTER_STATUS_TRANSITION_TERM_ID_CONT_ATTACK_HI4_START) && is_attack_hi4 && !AttackModule::is_infliction_status(boma, *COLLISION_KIND_MASK_SHIELD)
}
...
pub unsafe extern "C" fn attack_lw4_cancel(fighter: &mut L2CFighterCommon) -> bool {
    ...
    WorkModule::is_enable_transition_term(boma, *FIGHTER_STATUS_TRANSITION_TERM_ID_CONT_ATTACK_LW4_START) && is_attack_lw4 && !AttackModule::is_infliction_status(boma, *COLLISION_KIND_MASK_SHIELD)
}
