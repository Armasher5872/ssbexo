...
pub unsafe extern "C" fn calculate_finishing_hit(defender: u32, attacker: u32, knockback_info: *const f32) {
    *(knockback_info.add(0x4C/4) as *mut u32) = 60; //Hitstop Frames forcibly set to 60
    ...
    if defender_category == *BATTLE_OBJECT_CATEGORY_FIGHTER {
        WorkModule::off_flag(defender_boma, *FIGHTER_INSTANCE_WORK_ID_FLAG_FINAL_STOCK);
    }
    ...
    if defender_category == *BATTLE_OBJECT_CATEGORY_FIGHTER {
        WorkModule::on_flag(defender_boma, *FIGHTER_INSTANCE_WORK_ID_FLAG_FINAL_STOCK);
    }
...
unsafe extern "C" fn is_teammate_alive(defender_boma: &mut BattleObjectModuleAccessor) -> bool {
    for object_id in get_all_active_battle_object_ids() {
        ...
        if utility::get_kind(other_boma) == *FIGHTER_KIND_NANA { 
            continue; //skip nana
        }
        let defender_entry_id = WorkModule::get_int(defender_boma, *FIGHTER_INSTANCE_WORK_ID_INT_ENTRY_ID);
...
unsafe extern "C" fn call_finishing_hit_effects(defender_boma: &mut BattleObjectModuleAccessor, defender_agent: &mut L2CFighterCommon, attacker_boma: &mut BattleObjectModuleAccessor) {
    let attacker_category = utility::get_category(attacker_boma);
    let attacker_kind = utility::get_kind(attacker_boma);
    ...
    if is_final_killing_hit(defender_boma) {
        ...
        sv_animcmd::EFFECT_GLOBAL_BACK_GROUND(defender_agent.lua_state_agent);
    }
    else {
        if attacker_category == *BATTLE_OBJECT_CATEGORY_FIGHTER {
            ...
            match attacker_kind {
                _ if attacker_kind == *FIGHTER_KIND_MARIO => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_mario_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_DONKEY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_donkey_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_LINK => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_link_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SAMUS => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_samus_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SAMUSD => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_samusd_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_YOSHI => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_yoshi_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_KIRBY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_kirby_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_FOX => {
                    handle = EffectModule::req_on_joint(defender_boma, Hash40::new("sys_bg_vortex"), Hash40::new("top"), &Vector3f::zero(), &Vector3f::zero(), 1.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0);
                },
                _ if attacker_kind == *FIGHTER_KIND_PIKACHU => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_pikachu_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_LUIGI => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_luigi_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_NESS => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_ness_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_CAPTAIN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_captain_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PURIN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_purin_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PEACH => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_peach_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_DAISY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_daisy_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_KOOPA => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_koopa_final"), false, false, false);
                },
                _ if [*FIGHTER_KIND_POPO, *FIGHTER_KIND_NANA].contains(&attacker_kind) => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_popo_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SHEIK => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_sheik_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_ZELDA => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_zelda_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_MARIOD => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_mariod_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PICHU => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_pichu_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_FALCO => {
                    handle = EffectModule::req_on_joint(defender_boma, Hash40::new("sys_bg_lightning"), Hash40::new("top"), &Vector3f::zero(), &Vector3f::zero(), 1.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0)
                },
                _ if attacker_kind == *FIGHTER_KIND_MARTH => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_marth_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_LUCINA => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_lucina_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_YOUNGLINK => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_younglink_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_GANON => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_ganon_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_MEWTWO => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_mewtwo_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_ROY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_roy_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_CHROM => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_chrom_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_GAMEWATCH => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_gamewatch_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_METAKNIGHT => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_metaknight_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PIT => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_pit_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PITB => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_pitb_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SZEROSUIT => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_szerosuit_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_WARIO => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_wario_final2"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SNAKE => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_snake_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_IKE => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_ike_final"), false, false, false);
                },
                _ if [*FIGHTER_KIND_PZENIGAME, *FIGHTER_KIND_PFUSHIGISOU, *FIGHTER_KIND_PLIZARDON].contains(&attacker_kind) => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_ptrainer_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_DIDDY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_diddy_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_LUCAS => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_lucas_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SONIC => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_sonic_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_DEDEDE => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_dedede_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PIKMIN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_pikmin_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_LUCARIO => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_lucario_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_ROBOT => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_robot_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_TOONLINK => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_toonlink_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_WOLF => {
                    handle = EffectModule::req_on_joint(defender_boma, Hash40::new("sys_bg_vortex2"), Hash40::new("top"), &Vector3f::zero(), &Vector3f::zero(), 1.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0);
                },
                _ if attacker_kind == *FIGHTER_KIND_MURABITO => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_murabito_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_ROCKMAN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_rockman_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_WIIFIT => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_wiifit_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_ROSETTA => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_rosetta_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_LITTLEMAC => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_littlemac_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_GEKKOUGA => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_gekkouga_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PALUTENA => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_palutena_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PACMAN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_pacman_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_REFLET => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_reflet_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SHULK => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_shulk_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_KOOPAJR => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_koopajr_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_DUCKHUNT => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_duckhunt_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_RYU => {
                    handle = EffectModule::req_on_joint(defender_boma, Hash40::new("critical_hit"), Hash40::new("handr"), &Vector3f{x: 30.0*attacker_lr, y: 0.0, z: 0.0}, &Vector3f::zero(), 30.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0);
                },
                _ if attacker_kind == *FIGHTER_KIND_KEN => {
                    handle = EffectModule::req_on_joint(defender_boma, Hash40::new("critical_hit"), Hash40::new("top"), &Vector3f{x: 30.0*attacker_lr, y: 0.0, z: 0.0}, &Vector3f::zero(), 30.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0);
                },
                _ if attacker_kind == *FIGHTER_KIND_CLOUD => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_cloud_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_KAMUI => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_kamui_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_BAYONETTA => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_bayonetta_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_INKLING => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_inkling_final_l2"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_RIDLEY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_ridley_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SIMON => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_simon_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_RICHTER => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_richter_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_KROOL => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_krool_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_SHIZUE => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_shizue_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_GAOGAEN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_gaogaen_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PACKUN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_packun_final2"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_JACK => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_jack_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_BRAVE => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_brave_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_BUDDY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_buddy_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_DOLLY => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_dolly_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_MASTER => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_master_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_TANTAN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_tantan_final_endl"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_PICKEL => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_pickel_final_end"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_EDGE => {
                    handle = EffectModule::req_on_joint(defender_boma, Hash40::new("edge_win_fire"), Hash40::new("top"), &Vector3f{x: 500.0*attacker_lr, y: -300.0, z: 0.0}, &Vector3f::zero(), 20.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0);
                },
                _ if attacker_kind == *FIGHTER_KIND_EFLAME => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_eflame_final2"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_ELIGHT => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_eelight_final2"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_DEMON => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_demon_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_TRAIL => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_trail_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_MIIFIGHTER => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_miifighter_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_MIISWORDSMAN => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_miiswordsman_final"), false, false, false);
                },
                _ if attacker_kind == *FIGHTER_KIND_MIIGUNNER => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_miigunner_final"), false, false, false);
                },
                _ => {
                    handle = EffectModule::req_on_joint(defender_boma, Hash40::new("sys_bg_criticalhit"), Hash40::new("top"), &Vector3f::zero(), &Vector3f::zero(), 1.0, &Vector3f::zero(), &Vector3f::zero(), true, 0, 0, 0);
                }
            };
            EffectModule::set_billboard(defender_boma, handle as u32, true);
            EffectModule::set_disable_render_offset_last(defender_boma);
            EffectModule::set_rate(defender_boma, handle as u32, 2.0);
            WorkModule::set_int(defender_boma, handle as i32, *FIGHTER_INSTANCE_WORK_ID_INT_FINAL_ZOOM_HANDLE);
        ...
        if attacker_category == *BATTLE_OBJECT_CATEGORY_WEAPON {
            ...
            match attacker_kind {
                ...
                _ if [*WEAPON_KIND_TANTAN_BEAM, *WEAPON_KIND_TANTAN_PUNCH1, *WEAPON_KIND_TANTAN_PUNCH2, *WEAPON_KIND_TANTAN_PUNCH3, *WEAPON_KIND_TANTAN_RING, *WEAPON_KIND_TANTAN_SPIRALLEFT, *WEAPON_KIND_TANTAN_SPIRALLEFTLOUPE, *WEAPON_KIND_TANTAN_SPIRALRIGHT, *WEAPON_KIND_TANTAN_SPIRALRIGHTLOUPE, *WEAPON_KIND_TANTAN_SPIRALSIMPLE].contains(&attacker_kind) => {
                    handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_tantan_final_end"), false, false, false);
                },
