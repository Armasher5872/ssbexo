...
pub unsafe extern "C" fn cloud_var(boma: &mut BattleObjectModuleAccessor) {
...
pub unsafe extern "C" fn cloud_can_limit_break(fighter: &mut L2CFighterCommon, required_limit: i32) -> L2CValue {
    ...
    if ControlModule::check_button_trigger(boma, *CONTROL_PAD_BUTTON_SPECIAL) && special_wait_timer <= 0 {
