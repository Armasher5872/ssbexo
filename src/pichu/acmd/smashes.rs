...
unsafe extern "C" fn ssbexo_pichu_up_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 2.0, 95, 120, 80, 0, 5.0, 0.0, 4.0, 6.0, None, None, None, 0.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_elec"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_HEAD);
        macros::ATTACK(agent, 1, 0, Hash40::new("top"), 2.0, 95, 120, 80, 0, 5.0, 0.0, 4.0, -6.0, None, None, None, 0.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_B, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_elec"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_HEAD);
    }
...
unsafe extern "C" fn ssbexo_pichu_up_smash_effect(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::EFFECT_FOLLOW_NO_STOP(agent, Hash40::new("pichu_kaminari_hit2"), Hash40::new("top"), 0, 22, 0, 0, 90, 0, 1.15, true);
        macros::EFFECT_FOLLOW_NO_STOP(agent, Hash40::new("pichu_kaminari_hit"), Hash40::new("top"), 0, 22, 0, 0, 90, 0, 0.85, true);
...
pub fn install() {
    ...
    .effect_acmd("effect_attackhi4", ssbexo_pichu_up_smash_effect, Priority::Low)
    .sound_acmd("sound_attackhi4", ssbexo_pichu_up_smash_sound, Priority::Low)
    .expression_acmd("expression_attackhi4", ssbexo_pichu_up_smash_expression, Priority::Low)
    .install()
    ;
}