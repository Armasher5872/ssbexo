...
pub fn install() {
    Agent::new("snake")
    .game_acmd("game_catch", ssbexo_snake_grab_acmd, Priority::Low)
    .game_acmd("game_catchdash", ssbexo_snake_dash_grab_acmd, Priority::Low)
    .game_acmd("game_catchturn", ssbexo_snake_pivot_grab_acmd, Priority::Low)
    .install()
    ;
}