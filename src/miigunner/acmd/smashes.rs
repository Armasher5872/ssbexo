...
pub fn install() {
    Agent::new("miigunner")
    .game_acmd("game_attacks4", ssbexo_miigunner_forward_smash_acmd, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_miigunner_down_smash_acmd, Priority::Low)
    .install()
    ;
}