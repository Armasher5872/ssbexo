...
pub fn install() {
    Agent::new("daisy")
    .game_acmd("game_attacks4", ssbexo_daisy_forward_smash_acmd, Priority::Low)
    .effect_acmd("effect_attacks4", ssbexo_daisy_forward_smash_effect, Priority::Low)
    .sound_acmd("sound_attacks4", ssbexo_daisy_forward_smash_sound, Priority::Low)
    .expression_acmd("expression_attacks4", ssbexo_daisy_forward_smash_expression, Priority::Low)
    .game_acmd("game_attacks4hi", ssbexo_daisy_forward_smash_acmd, Priority::Low)
    .effect_acmd("effect_attacks4hi", ssbexo_daisy_forward_smash_effect, Priority::Low)
    .sound_acmd("sound_attacks4hi", ssbexo_daisy_forward_smash_sound, Priority::Low)
    .expression_acmd("expression_attacks4hi", ssbexo_daisy_forward_smash_expression, Priority::Low)
    .game_acmd("game_attacks4lw", ssbexo_daisy_forward_smash_acmd, Priority::Low)
    .effect_acmd("effect_attacks4lw", ssbexo_daisy_forward_smash_effect, Priority::Low)
    .sound_acmd("sound_attacks4lw", ssbexo_daisy_forward_smash_sound, Priority::Low)
    .expression_acmd("expression_attacks4lw", ssbexo_daisy_forward_smash_expression, Priority::Low)
    .game_acmd("game_attackhi4", ssbexo_daisy_up_smash_acmd, Priority::Low)
    .effect_acmd("effect_attackhi4", ssbexo_daisy_up_smash_effect, Priority::Low)
    .sound_acmd("sound_attackhi4", ssbexo_daisy_up_smash_sound, Priority::Low)
    .expression_acmd("expression_attackhi4", ssbexo_daisy_up_smash_expression, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_daisy_down_smash_acmd, Priority::Low)
    .effect_acmd("effect_attacklw4", ssbexo_daisy_down_smash_effect, Priority::Low)
    .sound_acmd("sound_attacklw4", ssbexo_daisy_down_smash_sound, Priority::Low)
    .expression_acmd("expression_attacklw4", ssbexo_daisy_down_smash_expression, Priority::Low)
    .install()
    ;
}