...
pub fn install() {
    Agent::new("daisy")
    .game_acmd("game_attackairn", ssbexo_daisy_nair_acmd, Priority::Low)
    .effect_acmd("effect_attackairn", ssbexo_daisy_nair_effect, Priority::Low)
    .sound_acmd("sound_attackairn", ssbexo_daisy_nair_sound, Priority::Low)
    .expression_acmd("expression_attackairn", ssbexo_daisy_nair_expression, Priority::Low)
    .game_acmd("game_attackairf", ssbexo_daisy_fair_acmd, Priority::Low)
    .effect_acmd("effect_attackairf", ssbexo_daisy_fair_effect, Priority::Low)
    .sound_acmd("sound_attackairf", ssbexo_daisy_fair_sound, Priority::Low)
    .expression_acmd("expression_attackairf", ssbexo_daisy_fair_expression, Priority::Low)
    .game_acmd("game_attackairb", ssbexo_daisy_bair_acmd, Priority::Low)
    .effect_acmd("effect_attackairb", ssbexo_daisy_bair_effect, Priority::Low)
    .sound_acmd("sound_attackairb", ssbexo_daisy_bair_sound, Priority::Low)
    .expression_acmd("expression_attackairb", ssbexo_daisy_bair_expression, Priority::Low)
    .game_acmd("game_attackairhi", ssbexo_daisy_uair_acmd, Priority::Low)
    .effect_acmd("effect_attackairhi", ssbexo_daisy_uair_effect, Priority::Low)
    .sound_acmd("sound_attackairhi", ssbexo_daisy_uair_sound, Priority::Low)
    .expression_acmd("expression_attackairhi", ssbexo_daisy_uair_expression, Priority::Low)
    .game_acmd("game_attackairlw", ssbexo_daisy_dair_acmd, Priority::Low)
    .effect_acmd("effect_attackairlw", ssbexo_daisy_dair_effect, Priority::Low)
    .sound_acmd("sound_attackairlw", ssbexo_daisy_dair_sound, Priority::Low)
    .expression_acmd("expression_attackairlw", ssbexo_daisy_dair_expression, Priority::Low)
    .install()
    ;
}