...
unsafe extern "C" fn ssbexo_mewtwo_up_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    for _ in 0..3 {
        if macros::is_excute(agent) {
            macros::ATTACK(agent, 0, 0, Hash40::new("top"), 2.0, 90, 80, 25, 0, 4.6, 0.0, 22.0, -5.8, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_NONE);
            macros::ATTACK(agent, 1, 0, Hash40::new("top"), 2.0, 90, 80, 25, 0, 4.6, 0.0, 22.0, 5.8, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_NONE);
            macros::ATTACK(agent, 2, 0, Hash40::new("top"), 2.0, 90, 80, 25, 0, 3.5, 0.0, 14.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_NONE);
            macros::ATTACK(agent, 3, 0, Hash40::new("top"), 2.0, 90, 80, 25, 0, 4.0, 0.0, 23.6, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_NONE);
...
unsafe extern "C" fn ssbexo_mewtwo_down_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 20.0);
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 16.0, 55, 118, 0, 20, 7.5, 0.0, 4.0, 13.7, None, None, None, 1.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_NONE);
...
pub fn install() {
    Agent::new("mewtwo")
    .effect_acmd("effect_attacks4charge", ssbexo_mewtwo_forward_smash_charge_effect)
    .game_acmd("game_attacks4", ssbexo_mewtwo_forward_smash_acmd)
    .game_acmd("game_attacks4hi", ssbexo_mewtwo_forward_smash_hi_acmd)
    .game_acmd("game_attacks4lw", ssbexo_mewtwo_forward_smash_lw_acmd)
    .effect_acmd("effect_attacks4", ssbexo_mewtwo_forward_smash_effect)
    .effect_acmd("effect_attacks4hi", ssbexo_mewtwo_forward_smash_hi_effect)
    .effect_acmd("effect_attacks4lw", ssbexo_mewtwo_forward_smash_lw_effect)
    .effect_acmd("effect_attackhi4charge", ssbexo_mewtwo_up_smash_charge_effect)
    .game_acmd("game_attackhi4", ssbexo_mewtwo_up_smash_acmd)
    .effect_acmd("effect_attackhi4", ssbexo_mewtwo_up_smash_effect)
    .effect_acmd("effect_attacklw4charge", ssbexo_mewtwo_down_smash_charge_effect)
    .game_acmd("game_attacklw4", ssbexo_mewtwo_down_smash_acmd)
    .effect_acmd("effect_attacklw4", ssbexo_mewtwo_down_smash_effect)
    .install()
    ;
}