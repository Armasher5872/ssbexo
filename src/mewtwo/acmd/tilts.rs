...
pub fn install() {
    ...
    .sound_acmd("sound_attacks3", ssbexo_mewtwo_forward_tilt_sound)
    .expression_acmd("expression_attacks3", ssbexo_mewtwo_forward_tilt_expression)
    .game_acmd("game_attacks3hi", ssbexo_mewtwo_forward_tilt_acmd)
    .effect_acmd("effect_attacks3hi", ssbexo_mewtwo_forward_tilt_effect)
    .sound_acmd("sound_attacks3hi", ssbexo_mewtwo_forward_tilt_sound)
    .expression_acmd("expression_attacks3hi", ssbexo_mewtwo_forward_tilt_expression)
    .game_acmd("game_attacks3lw", ssbexo_mewtwo_forward_tilt_acmd)
    .effect_acmd("effect_attacks3lw", ssbexo_mewtwo_forward_tilt_effect)
    .sound_acmd("sound_attacks3lw", ssbexo_mewtwo_forward_tilt_sound)
    .expression_acmd("expression_attacks3lw", ssbexo_mewtwo_forward_tilt_expression)
    ...
    .sound_acmd("sound_attacklw3", ssbexo_mewtwo_down_tilt_sound)
    .expression_acmd("expression_attacklw3", ssbexo_mewtwo_down_tilt_expression)
    .install()
    ;
}