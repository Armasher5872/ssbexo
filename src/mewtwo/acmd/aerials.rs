...
pub fn install() {
    ...
    .game_acmd("game_attackairf", ssbexo_mewtwo_fair_acmd, Priority::Low)
    .effect_acmd("effect_attackairf", ssbexo_mewtwo_fair_effect, Priority::Low)
    ...
    .game_acmd("game_attackairlw", ssbexo_mewtwo_dair_acmd, Priority::Low)
    .effect_acmd("effect_attackairlw", ssbexo_mewtwo_dair_effect, Priority::Low)
    .sound_acmd("sound_attackairlw", ssbexo_mewtwo_dair_sound, Priority::Low)
    .expression_acmd("expression_attackairlw", ssbexo_mewtwo_dair_expression, Priority::Low)
    .install()
    ;
}