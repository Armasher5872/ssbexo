...
unsafe fn ssbuexo_ivysaur_forward_throw_acmd(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        ...
        smash::app::lua_bind::FighterCutInManager::set_throw_finish_zoom_rate(FIGHTER_CUTIN_MANAGER, 1.6);
    }
...
unsafe fn ssbuexo_ivysaur_down_throw_acmd(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        ...
        smash::app::lua_bind::FighterCutInManager::set_throw_finish_zoom_rate(FIGHTER_CUTIN_MANAGER, 2.0);
