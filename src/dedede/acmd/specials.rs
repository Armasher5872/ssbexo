...
pub fn install() {
    ...
    ;
    Agent::new("dedede")
    .game_acmd("game_speciallwmax", ssbexo_dedede_grounded_down_special_max_acmd, Priority::Low)
    .game_acmd("game_specialairlwmax", ssbexo_dedede_aerial_down_special_max_acmd, Priority::Low)
    .install()
    ;
}