...
unsafe extern "C" fn ssbexo_toonlink_forward_smash_charge_effect(agent: &mut L2CAgentBase) {
    loop {
        ...
        if macros::is_excute(agent) {
            macros::FOOT_EFFECT(agent, Hash40::new("sys_run_smoke"), Hash40::new("top"), -2, 0, 0, 0, 0, 0, 1, 7, 0, 4, 0, 0, 0, false);
        }
        wait(agent.lua_state_agent, 5.0);
        macros::EFFECT(agent, Hash40::new("sys_smash_flash_s"), Hash40::new("haver"), 0, 0, 18, 0, 0, 0, 1, 5, 2.5, 2.5, 0, 0, 0, true);
...
unsafe extern "C" fn ssbexo_toonlink_forward_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("haver"), 24.0, 361, 50, 0, 85, 3.5, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_SWORD);
        macros::ATTACK(agent, 1, 0, Hash40::new("haver"), 24.0, 361, 50, 0, 85, 3.5, 0.0, 6.0, -1.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_SWORD);
        macros::ATTACK(agent, 2, 0, Hash40::new("haver"), 24.0, 361, 50, 0, 85, 3.5, 0.0, 12.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_SWORD);
        macros::ATTACK(agent, 3, 0, Hash40::new("haver"), 24.0, 361, 50, 0, 85, 7.0, 0.0, 18.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_SWORD);
    }
...
unsafe extern "C" fn ssbexo_toonlink_forward_smash_effect(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::EFFECT_FOLLOW(agent, Hash40::new("toonlink_kaiten_flare"), Hash40::new("haver"), 0, 18, 0, 0, 0, 0, 1, true);
        macros::AFTER_IMAGE4_ON_arg29(agent, Hash40::new("toonlink_sword3"), Hash40::new("toonlink_sword2"), 5, Hash40::new("haver"), 0, 0, 0, Hash40::new("haver"), 0, 18.0, 0, true, Hash40::new("null"), Hash40::new("haver"), 0, 0, 0, 0, 0, 0, 1, 0, *EFFECT_AXIS_X, 0, *TRAIL_BLEND_ALPHA, 101, *TRAIL_CULL_NONE, 1.5, 0.2);
    }
    ...
    if macros::is_excute(agent) {
        macros::EFFECT_OFF_KIND(agent, Hash40::new("toonlink_kaiten_flare"), false, false);
    }
}
...
unsafe extern "C" fn ssbexo_toonlink_forward_smash_expression(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 20.0);
    execute(agent.lua_state_agent, 20.0);
    if macros::is_excute(agent) {
        ItemModule::set_have_item_visibility(agent.module_accessor, false, 0);
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE, *SLOPE_STATUS_R);
...
pub fn install() {
    Agent::new("toonlink")
    .game_acmd("game_attacks4charge", ssbexo_toonlink_forward_smash_charge_acmd, Priority::Low)
    .effect_acmd("effect_attacks4charge", ssbexo_toonlink_forward_smash_charge_effect, Priority::Low)
    .expression_acmd("expression_attacks4charge", ssbexo_toonlink_forward_smash_charge_expression, Priority::Low)
    .game_acmd("game_attacks4", ssbexo_toonlink_forward_smash_acmd, Priority::Low)
    .effect_acmd("effect_attacks4", ssbexo_toonlink_forward_smash_effect, Priority::Low)
    .sound_acmd("sound_attacks4", ssbexo_toonlink_forward_smash_sound, Priority::Low)
    .expression_acmd("expression_attacks4", ssbexo_toonlink_forward_smash_expression, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_toonlink_down_smash_acmd, Priority::Low)
    .install()
    ;
}