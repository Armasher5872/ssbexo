...
unsafe extern "C" fn ssbexo_toonlink_grab_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::CATCH(agent, 1, Hash40::new("handr"), 1.5, 0.0, 0.0, 0.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA_d);
        macros::CATCH(agent, 2, Hash40::new("handr"), 4.0, 0.0, 0.0, 0.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA_d);
    }
...
pub fn install() {
    Agent::new("toonlink")
    .game_acmd("game_catch", ssbexo_toonlink_grab_acmd, Priority::Low)
    .game_acmd("game_catchdash", ssbexo_toonlink_dash_grab_acmd, Priority::Low)
    .game_acmd("game_catchturn", ssbexo_toonlink_pivot_grab_acmd, Priority::Low)
    .install()
    ;
}