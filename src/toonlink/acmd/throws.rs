...
pub fn install() {
    Agent::new("toonlink")
    .game_acmd("game_catch", ssbexo_toonlink_grab_acmd)
    .game_acmd("game_catchdash", ssbexo_toonlink_dash_grab_acmd)
    .game_acmd("game_catchturn", ssbexo_toonlink_pivot_grab_acmd)
    .install()
    ;
}