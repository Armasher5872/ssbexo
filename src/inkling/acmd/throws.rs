...
pub fn install() {
    Agent::new("inkling")
    .game_acmd("game_catch", ssbexo_inkling_grab_acmd)
    .game_acmd("game_catchdash", ssbexo_inkling_dash_grab_acmd)
    .game_acmd("game_catchturn", ssbexo_inkling_pivot_grab_acmd)
    .install()
    ;
}