...
unsafe fn ssbuexo_shulk_grab_acmd(fighter: &mut L2CAgentBase) 
{
    ...
    if macros::is_excute(fighter) {
        ...
        macros::CATCH(fighter, 0, Hash40::new("top"), 3.5, 0.0, 9.0, 4.0, Some(0.0), Some(9.0), Some(9.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
...
unsafe fn ssbuexo_shulk_dash_grab_acmd(fighter: &mut L2CAgentBase) 
{
    ...
    if macros::is_excute(fighter) {
        ...
        macros::CATCH(fighter, 0, Hash40::new("top"), 2.8, 0.0, 8.0, 4.0, Some(0.0), Some(8.0), Some(10.7), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
    macros::game_CaptureCutCommon(fighter);
    wait(fighter.lua_state_agent, 2.0);
    if macros::is_excute(fighter) {
...
unsafe fn ssbuexo_shulk_pivot_grab_acmd(fighter: &mut L2CAgentBase) 
{
    frame(fighter.lua_state_agent, 10.0);
    if macros::is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    ...
    if macros::is_excute(fighter) {
        ...
        macros::CATCH(fighter, 0, Hash40::new("top"), 3.5, 0.0, 8.0, -4.0, Some(0.0), Some(8.0), Some(-15.3), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
    macros::game_CaptureCutCommon(fighter);
    wait(fighter.lua_state_agent, 2.0);
    if macros::is_excute(fighter) {
...
pub fn install() {
    install_acmd_scripts!(
        ssbuexo_shulk_grab_acmd,
        ssbuexo_shulk_dash_grab_acmd,
        ssbuexo_shulk_pivot_grab_acmd
    );
}