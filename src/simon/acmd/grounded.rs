...
unsafe extern "C" fn ssbexo_simon_dash_attack_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 10.0, 30, 80, 0, 60, 10.5, 0.0, 8.8, 10.5, None, None, None, 0.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_whip"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_WHIP);
    }
    frame(agent.lua_state_agent, 14.0);
    if macros::is_excute(agent) {
        AttackModule::clear(agent.module_accessor, 0, false);
        macros::ATTACK(agent, 1, 0, Hash40::new("top"), 6.0, 65, 60, 0, 60, 9.5, 0.0, 8.8, 0.5, None, None, None, 0.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
    }
    frame(agent.lua_state_agent, 17.0);
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 12.0, 90, 60, 0, 40, 10.5, 0.0, 8.8, -4.0, Some(0.0), Some(8.8), Some(-15.0), 0.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_whip"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_WHIP);
    }
...
pub fn install() {
    Agent::new("simon")
    .game_acmd("game_attack11", ssbexo_simon_jab_1_acmd, Priority::Low)
    .game_acmd("game_attackhold", ssbexo_simon_whip_dangle_acmd, Priority::Low)
    .game_acmd("game_attackdash", ssbexo_simon_dash_attack_acmd, Priority::Low)
    .effect_acmd("effect_attackdash", ssbexo_simon_dash_attack_effect, Priority::Low)
    .sound_acmd("sound_attackdash", ssbexo_simon_dash_attack_sound, Priority::Low)
    .expression_acmd("expression_attackdash", ssbexo_simon_dash_attack_expression, Priority::Low)
    .install()
    ;
    Agent::new("simon_whip")
    .game_acmd("game_attackdash", ssbexo_simon_whip_dash_attack_acmd, Priority::Low)
    .effect_acmd("effect_attackdash", ssbexo_simon_whip_dash_attack_effect, Priority::Low)
    .install()
    ;
}