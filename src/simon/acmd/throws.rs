...
pub fn install() {
    Agent::new("simon")
    .game_acmd("game_catch", ssbexo_simon_grab_acmd, Priority::Low)
    .game_acmd("game_catchdash", ssbexo_simon_dash_grab_acmd, Priority::Low)
    .game_acmd("game_catchturn", ssbexo_simon_pivot_grab_acmd, Priority::Low)
    .install()
    ;
}