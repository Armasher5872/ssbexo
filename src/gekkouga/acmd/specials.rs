...
unsafe extern "C" fn ssbexo_gekkouga_side_special_acmd(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        macros::SEARCH(agent, 0, 0, Hash40::new("bust"), 75.0, 0.0, 0.0, 0.0, None, None, None, *COLLISION_KIND_MASK_ALL, *HIT_STATUS_MASK_ALL, 1, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, true);
    }
...
unsafe extern "C" fn ssbexo_gekkouga_down_special_effect(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::EFFECT_FLIP(agent, Hash40::new("sys_attack_speedline"), Hash40::new("sys_attack_speedline"), Hash40::new("top"), -4, 4, -3, -12, 17, 0, 1.1, 0, 0, 0, 0, 0, 0, true, *EF_FLIP_YZ);
    ...
    if macros::is_excute(agent) {
        macros::EFFECT(agent, Hash40::new("sys_smash_flash_s"), Hash40::new("top"), 0, 10, 15, 0, 0, 0, 1.5, 0, 0, 0, 0, 0, 0, true);
    }
}
...
pub fn install() {
    Agent::new("gekkouga")
    .game_acmd("game_specials", ssbexo_gekkouga_side_special_acmd, Priority::Low)
    .game_acmd("game_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_acmd, Priority::Low)
    .game_acmd("game_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_acmd, Priority::Low)
    .effect_acmd("effect_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_effect, Priority::Low)
    .effect_acmd("effect_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_effect, Priority::Low)
    .sound_acmd("sound_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_sound, Priority::Low)
    .sound_acmd("sound_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_sound, Priority::Low)
    .expression_acmd("expression_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_expression, Priority::Low)
    .expression_acmd("expression_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_expression, Priority::Low)
    .game_acmd("game_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_acmd, Priority::Low)
    .game_acmd("game_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_acmd, Priority::Low)
    .effect_acmd("effect_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_effect, Priority::Low)
    .effect_acmd("effect_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_effect, Priority::Low)
    .sound_acmd("sound_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_sound, Priority::Low)
    .sound_acmd("sound_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_sound, Priority::Low)
    .expression_acmd("expression_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_expression, Priority::Low)
    .expression_acmd("expression_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_expression, Priority::Low)
    .game_acmd("game_speciallw", ssbexo_gekkouga_down_special_acmd, Priority::Low)
    .game_acmd("game_specialairlw", ssbexo_gekkouga_down_special_acmd, Priority::Low)
    .effect_acmd("effect_speciallw", ssbexo_gekkouga_down_special_effect, Priority::Low)
    .effect_acmd("effect_specialairlw", ssbexo_gekkouga_down_special_effect, Priority::Low)
    .sound_acmd("sound_speciallw", ssbexo_gekkouga_down_special_sound, Priority::Low)
    .sound_acmd("sound_specialairlw", ssbexo_gekkouga_down_special_sound, Priority::Low)
    .expression_acmd("expression_speciallw", ssbexo_gekkouga_down_special_expression, Priority::Low)
    .expression_acmd("expression_specialairlw", ssbexo_gekkouga_down_special_expression, Priority::Low)
    .install()
    ;
}