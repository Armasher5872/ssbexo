...
pub fn install() {
    Agent::new("gekkouga")
    .game_acmd("game_attacks4", ssbexo_gekkouga_forward_smash_acmd, Priority::Low)
    .game_acmd("game_attackhi4", ssbexo_gekkouga_up_smash_acmd, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_gekkouga_down_smash_acmd, Priority::Low)
    .install()
    ;
}