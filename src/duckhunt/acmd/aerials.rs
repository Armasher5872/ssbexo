...
//Nair ACMD
unsafe extern "C" fn ssbexo_duckhunt_nair_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 5.0, 361, 90, 0, 22, 6.0, 0.0, 10.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
    }
...
//Uair ACMD
unsafe extern "C" fn ssbexo_duckhunt_uair_acmd(agent: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("duckhunt")
    .game_acmd("game_attackairn", ssbexo_duckhunt_nair_acmd, Priority::Low)
    .game_acmd("game_attackairhi", ssbexo_duckhunt_uair_acmd, Priority::Low)
    .install()
    ;
}