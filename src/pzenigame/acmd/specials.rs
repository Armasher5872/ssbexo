...
unsafe extern "C" fn ssbexo_pzenigame_shield_special_effect(agent: &mut L2CAgentBase) {
    ...
    for _ in 0..5 {
        if macros::is_excute(agent) {
            macros::EFFECT_FOLLOW(agent, Hash40::new("sys_steam3"), Hash40::new("top"), 0, 20, 0, 0, 0, 0, 2.0, true);
            macros::LAST_EFFECT_SET_COLOR(agent, 0.2, 0.2, 0.2);
            macros::EFFECT_FOLLOW(agent, Hash40::new("sys_steam3"), Hash40::new("top"), 0, 20, -10, 0, 0, 0, 2.0, true);
            macros::LAST_EFFECT_SET_COLOR(agent, 0.2, 0.2, 0.2);
            macros::EFFECT_FOLLOW(agent, Hash40::new("sys_steam3"), Hash40::new("top"), 0, 20, 10, 0, 0, 0, 2.0, true);
            macros::LAST_EFFECT_SET_COLOR(agent, 0.2, 0.2, 0.2);
            macros::EFFECT_FOLLOW(agent, Hash40::new("sys_atk_speedline"), Hash40::new("top"), 0, 15, 0, -90, 0, 0, 1.5, true);
