...
pub fn install() {
    Agent::new("elight")
    .game_acmd("game_attacks4", ssbexo_elight_forward_smash_acmd, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_elight_down_smash_acmd, Priority::Low)
    .install()
    ;
}