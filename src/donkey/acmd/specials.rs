...
pub fn install() {
    Agent::new("donkey")
    .game_acmd("game_specials", ssbexo_donkey_grounded_side_special_acmd)
    .game_acmd("game_specialairs", ssbexo_donkey_aerial_side_special_acmd)
    .effect_acmd("effect_specials", ssbexo_donkey_grounded_side_special_effect)
    .effect_acmd("effect_specialairs", ssbexo_donkey_aerial_side_special_effect)
    .sound_acmd("sound_specials", ssbexo_donkey_grounded_side_special_sound)
    .sound_acmd("sound_specialairs", ssbexo_donkey_aerial_side_special_sound)
    .expression_acmd("expression_specials", ssbexo_donkey_grounded_side_special_expression)
    .expression_acmd("expression_specialairs", ssbexo_donkey_aerial_side_special_expression)
    .game_acmd("game_specialhi", ssbexo_donkey_up_special_acmd)
    .game_acmd("game_specialairhi", ssbexo_donkey_up_special_acmd)
    .effect_acmd("effect_specialhi", ssbexo_donkey_up_special_effect)
    .effect_acmd("effect_specialairhi", ssbexo_donkey_up_special_effect)
    .sound_acmd("sound_specialhi", ssbexo_donkey_up_special_sound)
    .sound_acmd("sound_specialairhi", ssbexo_donkey_up_special_sound)
    .game_acmd("game_speciallwstart", ssbexo_donkey_down_special_acmd)
    .game_acmd("game_specialairlwstart", ssbexo_donkey_down_special_acmd)
    .effect_acmd("effect_speciallwstart", ssbexo_donkey_down_special_effect)
    .effect_acmd("effect_specialairlwstart", ssbexo_donkey_down_special_effect)
    .sound_acmd("sound_speciallwstart", ssbexo_donkey_down_special_sound)
    .sound_acmd("sound_specialairlwstart", ssbexo_donkey_down_special_sound)
    .expression_acmd("expression_speciallwstart", ssbexo_donkey_down_special_expression)
    .expression_acmd("expression_specialairlwstart", ssbexo_donkey_down_special_expression)
    .install()
    ;
}