...
unsafe extern "C" fn ssbexo_sonic_final_start_acmd(agent: &mut L2CAgentBase) {
    ...
    if WorkModule::is_flag(agent.module_accessor, *FIGHTER_INSTANCE_WORK_ID_FLAG_FINAL_CHARGE) {
        ...
        if macros::is_excute(agent) {
            ...
            macros::CAM_ZOOM_IN_arg5(agent, 0.3, 2.0, 40.0*scale, 0.0, 0.0);
        }
        ...
        if macros::is_excute(agent) {
            macros::CAM_ZOOM_OUT(agent);
            macros::CAM_ZOOM_IN_arg5(agent, 2.0, 0.0, 1.0*scale, 0.0, 0.0);
        }
        ...
        if macros::is_excute(agent) {
            macros::CHECK_VALID_FINAL_START_CAMERA(agent, 0, 7, 20, 0, 0, 0);
            macros::SLOW_OPPONENT(agent, 4.0, 60.0);
            macros::FT_SET_FINAL_FEAR_FACE(agent, 60);
            camera!(agent, *MA_MSC_CMD_CAMERA_CAM_OFFSET, -2.0*lr, 8);
            macros::FT_START_CUTIN(agent);
        }
...
unsafe extern "C" fn ssbexo_supersonic_final_start_ball_effect(agent: &mut L2CAgentBase) {
    if PostureModule::lr(agent.module_accessor) == 1.0 {
        macros::EFFECT_FOLLOW(agent, Hash40::new("sonic_final_chaos_start"), Hash40::new("hip"), 0, 0, 0, 0, 0, 0, 1, true);
    }
    else {
        macros::EFFECT_FOLLOW(agent, Hash40::new("sonic_final_chaos_start_l"), Hash40::new("hip"), 0, 0, 0, 0, 0, 0, 1, true);
    }
}
...
unsafe extern "C" fn ssbexo_supersonic_final_idle_acmd(agent: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
        if macros::is_excute(agent) {
            macros::WHOLE_HIT(agent, *HIT_STATUS_INVINCIBLE);
            macros::ATTACK(agent, 0, 0, Hash40::new("top"), 13.0, 361, 55, 0, 90, 15.0, 0.0, 7.5, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, f32::NAN, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_elec"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_NONE);
            AttackModule::set_force_reaction(agent.module_accessor, 0, true, false);
            AttackModule::set_final_finish_cut_in(agent.module_accessor, 0, true, true, -1.0, false);
        }
...
unsafe extern "C" fn ssbexo_supersonic_final_move_acmd(agent: &mut L2CAgentBase) {
    ...
    if WorkModule::is_flag(agent.module_accessor, *FIGHTER_INSTANCE_WORK_ID_FLAG_FINAL_CHARGE) {
        ...
        if macros::is_excute(agent) {
            macros::WHOLE_HIT(agent, *HIT_STATUS_INVINCIBLE);
            macros::ATTACK(agent, 0, 0, Hash40::new("top"), 18.0, 361, 80, 0, 90, 15.0, 0.0, 7.5, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, f32::NAN, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_elec"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_NONE);
            AttackModule::set_force_reaction(agent.module_accessor, 0, true, false);
            AttackModule::set_final_finish_cut_in(agent.module_accessor, 0, true, true, -1.0, false);
        }
    }
...
pub fn install() {
    ...
    .game_acmd("game_finalstart", ssbexo_sonic_final_start_acmd, Priority::Low)
    .game_acmd("game_finalairstart", ssbexo_sonic_final_start_acmd, Priority::Low)
    .install()
    ;
    Agent::new("sonic_supersonic")
    .game_acmd("game_finalstart", ssbexo_supersonic_final_start_acmd, Priority::Low)
    .game_acmd("game_finalairstart", ssbexo_supersonic_final_start_acmd, Priority::Low)
    .game_acmd("game_finalstartball", ssbexo_supersonic_final_start_ball_acmd, Priority::Low)
    .game_acmd("game_finalairstartball", ssbexo_supersonic_final_start_ball_acmd, Priority::Low)
    .effect_acmd("effect_finalballstart", ssbexo_supersonic_final_start_ball_effect, Priority::Low)
    .effect_acmd("effect_finalairballstart", ssbexo_supersonic_final_start_ball_effect, Priority::Low)
    .game_acmd("game_finalidle", ssbexo_supersonic_final_idle_acmd, Priority::Low)
    .effect_acmd("effect_finalidle", ssbexo_supersonic_final_idle_effect, Priority::Low)
    .game_acmd("game_finalturn", ssbexo_supersonic_final_turn_acmd, Priority::Low)
    .game_acmd("game_finalmovestart", ssbexo_supersonic_final_move_start_acmd, Priority::Low)
    .effect_acmd("effect_finalmovestart", ssbexo_supersonic_final_move_start_effect, Priority::Low)
    .game_acmd("game_finalmove", ssbexo_supersonic_final_move_acmd, Priority::Low)
    .effect_acmd("effect_finalmove", ssbexo_supersonic_final_move_effect, Priority::Low)
    .install()
    ;
}