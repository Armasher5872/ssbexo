...
pub fn install() {
    ...
    .effect_acmd("effect_specialsstart", ssbexo_sonic_grounded_boost_start_effect)
    .sound_acmd("sound_specialsstart", ssbexo_sonic_grounded_boost_start_sound)
    .expression_acmd("expression_specialsstart", ssbexo_sonic_grounded_boost_start_expression)
    .expression_acmd("expression_specialairsstart", ssbexo_sonic_aerial_boost_start_expression)
    .game_acmd("game_specialsloop", ssbexo_sonic_boost_loop_acmd)
    .game_acmd("game_specialairsloop", ssbexo_sonic_boost_loop_acmd)
    .effect_acmd("effect_specialsloop", ssbexo_sonic_boost_loop_effect)
    .effect_acmd("effect_specialairsloop", ssbexo_sonic_boost_loop_effect)
    .sound_acmd("sound_specialsloop", ssbexo_sonic_boost_loop_sound)
    .sound_acmd("sound_specialairsloop", ssbexo_sonic_boost_loop_sound)
    .expression_acmd("expression_specialsloop", ssbexo_sonic_boost_loop_expression)
    .expression_acmd("expression_specialairsloop", ssbexo_sonic_boost_loop_expression)
    .game_acmd("game_specialseagle", ssbexo_sonic_boost_eagle_acmd)
    .effect_acmd("effect_specialseagle", ssbexo_sonic_boost_eagle_effect)
    .sound_acmd("sound_specialseagle", ssbexo_sonic_boost_eagle_sound)
    .expression_acmd("expression_specialseagle", ssbexo_sonic_boost_eagle_expression)
    .game_acmd("game_specialsadventure", ssbexo_sonic_boost_adventure_acmd)
    .effect_acmd("effect_specialsadventure", ssbexo_sonic_boost_adventure_effect)
    .sound_acmd("sound_specialsadventure", ssbexo_sonic_boost_adventure_sound)
    .expression_acmd("expression_specialsadventure", ssbexo_sonic_boost_adventure_expression)
    .game_acmd("game_specialsdrop", ssbexo_sonic_boost_drop_acmd)
    .effect_acmd("effect_specialsdrop", ssbexo_sonic_boost_drop_effect)
    .sound_acmd("sound_specialsdrop", ssbexo_sonic_boost_drop_sound)
    .expression_acmd("expression_specialsdrop", ssbexo_sonic_boost_drop_expression)
    .expression_acmd("expression_specialsbounce", ssbexo_sonic_boost_bounce_expression)
