...
pub fn install() {
    Agent::new("pikachu")
    .game_acmd("game_catch", ssbexo_pikachu_grab_acmd)
    .game_acmd("game_catchdash", ssbexo_pikachu_dash_grab_acmd)
    .game_acmd("game_catchturn", ssbexo_pikachu_pivot_grab_acmd)
    .install()
    ;
}