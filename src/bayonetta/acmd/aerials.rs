...
pub fn install() {
    Agent::new("bayonetta")
    .game_acmd("game_attackairn", ssbexo_bayonetta_nair_acmd)
    .game_acmd("game_attackairnhold", ssbexo_bayonetta_nair_hold_acmd)
    .effect_acmd("effect_landingairn", ssbexo_bayonetta_nair_landing_effect)
    .game_acmd("game_shootingarml_atkon_attackairf", ssbexo_bayonetta_fair_1_bullet_art_on_acmd)
    .game_acmd("game_attackairf", ssbexo_bayonetta_fair_1_acmd)
    .effect_acmd("effect_landingairf", ssbexo_bayonetta_fair_1_landing_effect)
    .game_acmd("game_shootingarml_atkon_attackairf2", ssbexo_bayonetta_fair_2_bullet_art_on_acmd)
    .game_acmd("game_attackairf2", ssbexo_bayonetta_fair_2_acmd)
    .effect_acmd("effect_landingairf2", ssbexo_bayonetta_fair_2_landing_effect)
    .game_acmd("game_shootingarml_atkon_attackairf3", ssbexo_bayonetta_fair_3_bullet_art_on_left_arm_acmd)
    .game_acmd("game_shootingarmr_atkon_attackairf3", ssbexo_bayonetta_fair_3_bullet_art_on_right_arm_acmd)
    .game_acmd("game_shootinglegl_atkon_attackairf3", ssbexo_bayonetta_fair_3_bullet_art_on_left_leg_acmd)
    .game_acmd("game_shootinglegr_atkon_attackairf3", ssbexo_bayonetta_fair_3_bullet_art_on_right_leg_acmd)
    .game_acmd("game_attackairf3", ssbexo_bayonetta_fair_3_acmd)
    .effect_acmd("effect_landingairf3", ssbexo_bayonetta_fair_3_landing_effect)
    .game_acmd("game_attackairfdash", ssbexo_bayonetta_fair_dash_acmd)
    .effect_acmd("effect_attackairfdash", ssbexo_bayonetta_fair_dash_effect)
    .sound_acmd("sound_attackairfdash", ssbexo_bayonetta_fair_dash_sound)
    .expression_acmd("expression_attackairfdash", ssbexo_bayonetta_fair_dash_expression)
    .game_acmd("game_attackairfsmash", ssbexo_bayonetta_fair_f_smash_acmd)
    .effect_acmd("effect_attackairfsmash", ssbexo_bayonetta_fair_f_smash_effect)
    .sound_acmd("sound_attackairfsmash", ssbexo_bayonetta_fair_f_smash_sound)
    .expression_acmd("expression_attackairfsmash", ssbexo_bayonetta_fair_f_smash_expression)
    .game_acmd("game_attackairfhismash", ssbexo_bayonetta_fair_hi_smash_acmd)
    .effect_acmd("effect_attackairfhismash", ssbexo_bayonetta_fair_hi_smash_effect)
    .sound_acmd("sound_attackairfhismash", ssbexo_bayonetta_fair_hi_smash_sound)
    .expression_acmd("expression_attackairfhismash", ssbexo_bayonetta_fair_hi_smash_expression)
    .game_acmd("game_attackairflwsmash", ssbexo_bayonetta_fair_lw_smash_acmd)
    .effect_acmd("effect_attackairflwsmash", ssbexo_bayonetta_fair_lw_smash_effect)
    .sound_acmd("sound_attackairflwsmash", ssbexo_bayonetta_fair_lw_smash_sound)
    .expression_acmd("expression_attackairflwsmash", ssbexo_bayonetta_fair_lw_smash_expression)
    .game_acmd("game_shootinglegl_atkon_attackairb", ssbexo_bayonetta_bair_bullet_art_on_acmd)
    .effect_acmd("effect_landingairb", ssbexo_bayonetta_bair_landing_effect)
    .game_acmd("game_shootingarml_atkon_attackairhi", ssbexo_bayonetta_uair_bullet_art_on_left_arm_acmd)
    .game_acmd("game_shootingarmr_atkon_attackairhi", ssbexo_bayonetta_uair_bullet_art_on_right_arm_acmd)
    .game_acmd("game_shootinglegl_atkon_attackairhi", ssbexo_bayonetta_uair_bullet_art_on_left_leg_acmd)
    .game_acmd("game_shootinglegr_atkon_attackairhi", ssbexo_bayonetta_uair_bullet_art_on_right_leg_acmd)
    .game_acmd("game_attackairhi", ssbexo_bayonetta_uair_acmd)
    .effect_acmd("effect_landingairhi", ssbexo_bayonetta_uair_landing_effect)
    .game_acmd("game_shootinglegl_atkon_landingairlw", ssbexo_bayonetta_dair_landing_bullet_art_on_acmd)
    .install()
    ;
}