...
pub fn install() {
    Agent::new("bayonetta")
    .game_acmd("game_shootinglegr_atkon_specials", ssbexo_bayonetta_heel_slide_bullet_art_on_acmd)
    .game_acmd("game_shootinglegr_atkon_specials", ssbexo_bayonetta_heel_slide_hold_bullet_art_on_acmd)
    .game_acmd("game_shootinglegl_atkon_specialairsu", ssbexo_bayonetta_afterburner_kick_up_bullet_art_on_left_acmd)
    .game_acmd("game_shootinglegr_atkon_specialairsu", ssbexo_bayonetta_afterburner_kick_up_bullet_art_on_right_acmd)
    .game_acmd("game_shootingarml_atkon_specialhi", ssbexo_bayonetta_grounded_witch_twist_bullet_art_on_left_arm_acmd)
    .game_acmd("game_shootingarmr_atkon_specialhi", ssbexo_bayonetta_grounded_witch_twist_bullet_art_on_right_arm_acmd)
    .game_acmd("game_shootinglegl_atkon_specialhi", ssbexo_bayonetta_grounded_witch_twist_bullet_art_on_left_leg_acmd)
    .game_acmd("game_shootinglegr_atkon_specialhi", ssbexo_bayonetta_grounded_witch_twist_bullet_art_on_right_leg_acmd)
    .game_acmd("game_shootingarml_atkon_specialairhi", ssbexo_bayonetta_aerial_witch_twist_bullet_art_on_left_arm_acmd)
    .game_acmd("game_shootingarmr_atkon_specialairhi", ssbexo_bayonetta_aerial_witch_twist_bullet_art_on_right_arm_acmd)
    .game_acmd("game_shootinglegl_atkon_specialairhi", ssbexo_bayonetta_aerial_witch_twist_bullet_art_on_left_leg_acmd)
    .game_acmd("game_shootinglegr_atkon_specialairhi", ssbexo_bayonetta_aerial_witch_twist_bullet_art_on_right_leg_acmd)
    .game_acmd("game_speciallw", ssbexo_bayonetta_grounded_witch_time_acmd)
    .game_acmd("game_specialairlw", ssbexo_bayonetta_aerial_witch_time_acmd)
    .install()
    ;
}