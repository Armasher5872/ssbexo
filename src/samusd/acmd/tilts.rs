...
pub fn install() {
    Agent::new("samusd")
    .game_acmd("game_attacks3", ssbexo_samusd_forward_tilt_acmd)
    .game_acmd("game_attacks3hi", ssbexo_samusd_forward_tilt_acmd)
    .game_acmd("game_attacks3lw", ssbexo_samusd_forward_tilt_acmd)
    .effect_acmd("effect_attacks3", ssbexo_samusd_forward_tilt_effect)
    .effect_acmd("effect_attacks3hi", ssbexo_samusd_forward_tilt_effect)
    .effect_acmd("effect_attacks3lw", ssbexo_samusd_forward_tilt_effect)
    .sound_acmd("sound_attacks3", ssbexo_samusd_forward_tilt_sound)
    .sound_acmd("sound_attacks3hi", ssbexo_samusd_forward_tilt_sound)
    .sound_acmd("sound_attacks3lw", ssbexo_samusd_forward_tilt_sound)
    .game_acmd("game_attackhi3", ssbexo_samusd_up_tilt_acmd)
    .effect_acmd("effect_attackhi3", ssbexo_samusd_up_tilt_effect)
    .game_acmd("game_attacklw3", ssbexo_samusd_down_tilt_acmd)
    .effect_acmd("effect_attacklw3", ssbexo_samusd_down_tilt_effect)
    .install()
    ;
}