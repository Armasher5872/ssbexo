...
unsafe extern "C" fn ssbexo_samusd_dash_attack_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("bust"), 1.0, 364, 80, 40, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 0.3, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new_raw(0x13313725f6), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_ENERGY);
        macros::ATTACK(agent, 1, 0, Hash40::new("shoulderl"), 1.0, 364, 80, 40, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 0.3, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new_raw(0x13313725f6), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_ENERGY);
        macros::ATTACK(agent, 2, 0, Hash40::new("arml"), 1.0, 364, 80, 40, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 0.3, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new_raw(0x13313725f6), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_ENERGY);
    }
...
pub fn install() {
    Agent::new("samusd")
    .effect_acmd("effect_entryr", ssbexo_samusd_entry_effect, Priority::Low)
    .effect_acmd("effect_entryl", ssbexo_samusd_entry_effect, Priority::Low)
    .effect_acmd("effect_appeallwr", ssbexo_samusd_down_taunt_effect, Priority::Low)
    .effect_acmd("effect_appeallwl", ssbexo_samusd_down_taunt_effect, Priority::Low)
    .sound_acmd("sound_appeallwr", ssbexo_samusd_down_taunt_sound, Priority::Low)
    .sound_acmd("sound_appeallwl", ssbexo_samusd_down_taunt_sound, Priority::Low)
    .effect_acmd("effect_attack11", ssbexo_samusd_jab_effect, Priority::Low)
    .game_acmd("game_attackdash", ssbexo_samusd_dash_attack_acmd, Priority::Low)
    .effect_acmd("effect_attackdash", ssbexo_samusd_dash_attack_effect, Priority::Low)
    .install()
    ;
}