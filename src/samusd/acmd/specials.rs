...
pub fn install() {
    ...
    .effect_acmd("effect_specialairhi", ssbexo_samusd_up_special_effect, Priority::Low)
    .sound_acmd("sound_specialhi", ssbexo_samusd_up_special_sound, Priority::Low)
    ...
    .game_acmd("game_shoot", ssbexo_samusd_charge_shot_acmd, Priority::Low)
    .install()
    ;
    Agent::new("samusd_missile")
    .game_acmd("game_homing", ssbexo_samusd_missile_acmd, Priority::Low)
    .effect_acmd("effect_hburst", ssbexo_samusd_missile_effect, Priority::Low)
    .install()
    ;
    Agent::new("samusd_supermissile")
    .game_acmd("game_ready", ssbexo_samusd_super_missile_initial_acmd, Priority::Low)
    .game_acmd("game_straight", ssbexo_samusd_super_missile_fire_acmd, Priority::Low)
    .effect_acmd("effect_sburst", ssbexo_samusd_super_missile_effect, Priority::Low)
    .install()
    ;
    Agent::new("samusd_bomb")
    .game_acmd("game_fall", ssbexo_samusd_bomb_fall_acmd, Priority::Low)
    .game_acmd("game_burstattack", ssbexo_samusd_bomb_burst_attack_acmd, Priority::Low)
    .effect_acmd("effect_burstattack", ssbexo_samusd_bomb_burst_attack_effect, Priority::Low)
    .expression_acmd("expression_burstattack", ssbexo_samusd_bomb_burst_attack_expression, Priority::Low)
    .install()
    ;
}