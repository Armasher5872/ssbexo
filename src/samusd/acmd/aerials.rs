...
pub fn install() {
    Agent::new("samusd")
    .game_acmd("game_attackairn", ssbexo_samusd_nair_acmd)
    .effect_acmd("effect_attackairn", ssbexo_samusd_nair_effect)
    .game_acmd("game_attackairf", ssbexo_samusd_fair_acmd)
    .effect_acmd("effect_attackairf", ssbexo_samusd_fair_effect)
    .sound_acmd("sound_attackairf", ssbexo_samusd_fair_sound)
    .game_acmd("game_attackairb", ssbexo_samusd_bair_acmd)
    .effect_acmd("effect_attackairb", ssbexo_samusd_bair_effect)
    .sound_acmd("sound_attackairb", ssbexo_samusd_bair_sound)
    .game_acmd("game_attackairhi", ssbexo_samusd_uair_acmd)
    .effect_acmd("effect_attackairhi", ssbexo_samusd_uair_effect)
    .sound_acmd("sound_attackairhi", ssbexo_samusd_uair_sound)
    .game_acmd("game_attackairlw", ssbexo_samusd_dair_acmd)
    .effect_acmd("effect_attackairlw", ssbexo_samusd_dair_effect)
    .install()
    ;
}