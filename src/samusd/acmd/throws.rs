...
unsafe extern "C" fn ssbexo_samusd_grab_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::CATCH(agent, 0, Hash40::new("throw"), 4.0, 0.0, 0.0, 0.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA_d);
        macros::CATCH(agent, 1, Hash40::new("top"), 3.0, 0.0, 7.5, 13.0, Some(0.0), Some(7.5), Some(5.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA_d);
    }
...
unsafe extern "C" fn ssbexo_samusd_forward_throw_acmd(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        macros::ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 5.0, 15, 40, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new_raw(0x13313725f6), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
    ...
    if macros::is_excute(agent) {
        ...
        macros::ATTACK(agent, 0, 0, Hash40::new("armr"), 0.1, 0, 0, 0, 0, 9.0, 0.0, 0.0, 0.0, None, None, None, 0.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal_poison"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_BODY);
...
unsafe extern "C" fn ssbexo_samusd_back_throw_acmd(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        macros::ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 7.0, 45, 40, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_B, 0.0, true, Hash40::new("collision_attr_elec_whip"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
...
unsafe extern "C" fn ssbexo_samusd_up_throw_acmd(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        macros::ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 8.0, 75, 70, 0, 70, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_elec_whip"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
...
pub fn install() {
    Agent::new("samusd")
    .game_acmd("game_catch", ssbexo_samusd_grab_acmd, Priority::Low)
    .game_acmd("game_catchdash", ssbexo_samusd_dash_grab_acmd, Priority::Low)
    .game_acmd("game_catchturn", ssbexo_samusd_pivot_grab_acmd, Priority::Low)
    .game_acmd("game_catchattack", ssbexo_samusd_pummel_acmd, Priority::Low)
    .game_acmd("game_throwf", ssbexo_samusd_forward_throw_acmd, Priority::Low)
    .effect_acmd("effect_throwf", ssbexo_samusd_forward_throw_effect, Priority::Low)
    .sound_acmd("sound_throwf", ssbexo_samusd_forward_throw_sound, Priority::Low)
    .game_acmd("game_throwb", ssbexo_samusd_back_throw_acmd, Priority::Low)
    .effect_acmd("effect_throwb", ssbexo_samusd_back_throw_effect, Priority::Low)
    .sound_acmd("sound_throwb", ssbexo_samusd_back_throw_sound, Priority::Low)
    .game_acmd("game_throwhi", ssbexo_samusd_up_throw_acmd, Priority::Low)
    .effect_acmd("effect_throwhi", ssbexo_samusd_up_throw_effect, Priority::Low)
    .sound_acmd("sound_throwhi", ssbexo_samusd_up_throw_sound, Priority::Low)
    .install()
    ;
}