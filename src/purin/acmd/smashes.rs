...
pub fn install() {
    Agent::new("purin")
    .game_acmd("game_attacks4", ssbexo_purin_forward_smash_acmd)
    .effect_acmd("effect_attacks4", ssbexo_purin_forward_smash_effect)
    .sound_acmd("sound_attacks4", ssbexo_purin_forward_smash_sound)
    .expression_acmd("expression_attacks4", ssbexo_purin_forward_smash_expression)
    .game_acmd("game_attackhi4", ssbexo_purin_up_smash_acmd)
    .effect_acmd("effect_attackhi4", ssbexo_purin_up_smash_effect)
    .sound_acmd("sound_attackhi4", ssbexo_purin_up_smash_sound)
    .expression_acmd("expression_attackhi4", ssbexo_purin_up_smash_expression)
    .game_acmd("game_attacklw4", ssbexo_purin_down_smash_acmd)
    .effect_acmd("effect_attacklw4", ssbexo_purin_down_smash_effect)
    .sound_acmd("sound_attacklw4", ssbexo_purin_down_smash_sound)
    .expression_acmd("expression_attacklw4", ssbexo_purin_down_smash_expression)
    .install()
    ;
}