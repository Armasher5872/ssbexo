...
pub fn install() {
    Agent::new("purin")
    .game_acmd("game_specialnstartr", ssbexo_purin_neutral_special_acmd, Priority::Low)
    .game_acmd("game_specialairnstartr", ssbexo_purin_neutral_special_acmd, Priority::Low)
    .effect_acmd("effect_specialnstartr", ssbexo_purin_neutral_special_effect, Priority::Low)
    .effect_acmd("effect_specialairnstartr", ssbexo_purin_neutral_special_effect, Priority::Low)
    .sound_acmd("sound_specialnstartr", ssbexo_purin_neutral_special_sound, Priority::Low)
    .sound_acmd("sound_specialairnstartr", ssbexo_purin_neutral_special_sound, Priority::Low)
    .expression_acmd("expression_specialnstartr", ssbexo_purin_neutral_special_expression, Priority::Low)
    .expression_acmd("expression_specialairnstartr", ssbexo_purin_neutral_special_expression, Priority::Low)
    .game_acmd("game_specials", ssbexo_purin_grounded_side_special_acmd, Priority::Low)
    .game_acmd("game_specialairs", ssbexo_purin_aerial_side_special_acmd, Priority::Low)
    .game_acmd("game_specialhir", ssbexo_purin_up_special_acmd, Priority::Low)
    .game_acmd("game_specialhil", ssbexo_purin_up_special_acmd, Priority::Low)
    .game_acmd("game_specialairhir", ssbexo_purin_up_special_acmd, Priority::Low)
    .game_acmd("game_specialairhil", ssbexo_purin_up_special_acmd, Priority::Low)
    .install()
    ;
    Agent::new("purin_disarmingvoice")
    .game_acmd("game_shoot", ssbexo_purin_disarming_voice_acmd, Priority::Low)
    .effect_acmd("effect_shoot", ssbexo_purin_disarming_voice_effect, Priority::Low)
    .install()
    ;
}