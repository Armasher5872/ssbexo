...
pub fn install() {
    Agent::new("purin")
    .game_acmd("game_attacks3", ssbexo_purin_forward_tilt_acmd, Priority::Low)
    .game_acmd("game_attacks3hi", ssbexo_purin_forward_tilt_acmd, Priority::Low)
    .game_acmd("game_attacks3lw", ssbexo_purin_forward_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacks3", ssbexo_purin_forward_tilt_effect, Priority::Low)
    .effect_acmd("effect_attacks3hi", ssbexo_purin_forward_tilt_effect, Priority::Low)
    .effect_acmd("effect_attacks3lw", ssbexo_purin_forward_tilt_effect, Priority::Low)
    .expression_acmd("expression_attacks3", ssbexo_purin_forward_tilt_expression, Priority::Low)
    .expression_acmd("expression_attacks3hi", ssbexo_purin_forward_tilt_expression, Priority::Low)
    .expression_acmd("expression_attacks3lw", ssbexo_purin_forward_tilt_expression, Priority::Low)
    .game_acmd("game_attackhi3", ssbexo_purin_up_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attackhi3", ssbexo_purin_up_tilt_effect, Priority::Low)
    .sound_acmd("sound_attackhi3", ssbexo_purin_up_tilt_sound, Priority::Low)
    .expression_acmd("expression_attackhi3", ssbexo_purin_up_tilt_expression, Priority::Low)
    .game_acmd("game_attacklw3", ssbexo_purin_down_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacklw3", ssbexo_purin_down_tilt_effect, Priority::Low)
    .expression_acmd("expression_attacklw3", ssbexo_purin_down_tilt_expression, Priority::Low)
    .install()
    ;
}