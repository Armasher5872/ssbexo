...
unsafe fn status_saving_damage_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    if StatusModule::prev_status_kind(fighter.module_accessor, 0) == *FIGHTER_STATUS_KIND_FURAFURA {
        fighter.sub_shift_status_main(L2CValue::Ptr(crumple_status_loop as *const () as _));
    }
    L2CValue::I32(0)
}

pub unsafe fn crumple_status_loop(fighter: &mut L2CFighterCommon) -> bool {
...
pub fn install() {
	install_status_scripts!(
        ft_status_uniq_process_guard_off_exit_status,
