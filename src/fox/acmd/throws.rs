...
unsafe fn ssbuexo_fox_grab_acmd(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        ...
        macros::CATCH(fighter, 0, Hash40::new("top"), 3.0, 0.0, 7.0, 4.0, Some(0.0), Some(7.0), Some(8.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
...
pub fn install() {
    install_acmd_scripts!(
        ssbuexo_fox_grab_acmd,
        ssbuexo_fox_dash_grab_acmd,
        ssbuexo_fox_pivot_grab_acmd
    );
}