...
unsafe fn ssbuexo_marth_jab_2_acmd(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    install_acmd_scripts!(
        ssbuexo_marth_jab_1_acmd,
        ssbuexo_marth_jab_2_acmd,
