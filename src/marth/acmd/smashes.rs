...
unsafe fn ssbuexo_marth_forward_smash_acmd(fighter: &mut L2CAgentBase) 
{
...
unsafe fn ssbuexo_marth_down_smash_acmd(fighter: &mut L2CAgentBase) 
{
...
pub fn install() {
    install_acmd_scripts!(
        ssbuexo_marth_forward_smash_acmd,
        ssbuexo_marth_down_smash_acmd
    );
}