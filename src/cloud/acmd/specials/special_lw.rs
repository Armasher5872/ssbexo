...
unsafe extern "C" fn ssbexo_cloud_grounded_operator_down_special_effect(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        macros::EFFECT(agent, Hash40::new("sys_muzzleflash"), Hash40::new("waist"), 0, 0, 0, 0, 0, 90, 1, 0, 0, 0, 0, 0, 0, true);
    }
...
unsafe extern "C" fn ssbexo_cloud_grounded_operator_down_special_sound(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::PLAY_SE(agent, Hash40::new("se_cloud_step_left_m"));
    }
    frame(agent.lua_state_agent, 17.0);
    if macros::is_excute(agent) {
        macros::PLAY_SE(agent, Hash40::new("se_cloud_step_right_m"));
    }
    frame(agent.lua_state_agent, 65.0);
    if macros::is_excute(agent) {
        macros::PLAY_SE(agent, Hash40::new("se_cloud_landing03"));
    }
}
...
pub fn install() {
    Agent::new("cloud")
    .game_acmd("game_speciallwstart", ssbexo_cloud_operator_down_special_acmd, Priority::Low)
    .game_acmd("game_specialairlwstart", ssbexo_cloud_operator_down_special_acmd, Priority::Low)
    .effect_acmd("effect_speciallwstart", ssbexo_cloud_grounded_operator_down_special_effect, Priority::Low)
    .effect_acmd("effect_specialairlwstart", ssbexo_cloud_aerial_operator_down_special_effect, Priority::Low)
    .sound_acmd("sound_speciallwstart", ssbexo_cloud_grounded_operator_down_special_sound, Priority::Low)
    .sound_acmd("sound_specialairlwstart", ssbexo_cloud_aerial_operator_down_special_sound, Priority::Low)
    .expression_acmd("expression_speciallwstart", ssbexo_cloud_grounded_operator_down_special_expression, Priority::Low)
    .expression_acmd("expression_specialairlwstart", ssbexo_cloud_aerial_operator_down_special_expression, Priority::Low)
    .install()
    ;
}