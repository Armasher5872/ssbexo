...
pub fn install() {
    Agent::new("cloud")
    .game_acmd("game_specialhicombo2", ssbexo_cloud_up_special_combo_2_acmd, Priority::Low)
    .effect_acmd("effect_specialhicombo2", ssbexo_cloud_up_special_combo_2_effect, Priority::Low)
    .sound_acmd("sound_specialhicombo2", ssbexo_cloud_up_special_combo_2_sound, Priority::Low)
    .expression_acmd("expression_specialhicombo2", ssbexo_cloud_up_special_combo_2_expression, Priority::Low)
    .install()
    ;
}