...
unsafe extern "C" fn ssbexo_cloud_punisher_down_special_sound(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        macros::PLAY_SE(agent, Hash40::new("se_cloud_special_l02"));
    }
...
pub fn install() {
    Agent::new("cloud")
    .game_acmd("game_punishspeciallw", ssbexo_cloud_punisher_down_special_acmd, Priority::Low)
    .game_acmd("game_punishspecialairlw", ssbexo_cloud_punisher_down_special_acmd, Priority::Low)
    .effect_acmd("effect_punishspeciallw", ssbexo_cloud_grounded_punisher_down_special_effect, Priority::Low)
    .effect_acmd("effect_punishspecialairlw", ssbexo_cloud_aerial_punisher_down_special_effect, Priority::Low)
    .sound_acmd("sound_punishspeciallw", ssbexo_cloud_punisher_down_special_sound, Priority::Low)
    .sound_acmd("sound_punishspecialairlw", ssbexo_cloud_punisher_down_special_sound, Priority::Low)
    .expression_acmd("expression_punishspeciallw", ssbexo_cloud_punisher_down_special_expression, Priority::Low)
    .expression_acmd("expression_punishspecialairlw", ssbexo_cloud_punisher_down_special_expression, Priority::Low)
    .install()
    ;
}