...
pub fn install() {
    Agent::new("cloud")
    .game_acmd("game_catch", ssbexo_cloud_grab_acmd, Priority::Low)
    .game_acmd("game_catchdash", ssbexo_cloud_dash_grab_acmd, Priority::Low)
    .game_acmd("game_catchturn", ssbexo_cloud_pivot_grab_acmd, Priority::Low)
    .install()
    ;
}