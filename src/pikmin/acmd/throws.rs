...
//Standing Grab ACMD
#[acmd_script( agent = "pikmin", script = "game_catch", category = ACMD_GAME )]
unsafe fn ssbuexo_pikmin_grab_acmd(fighter: &mut L2CAgentBase) {
...
//Dash Grab ACMD
#[acmd_script( agent = "pikmin", script = "game_catchdash", category = ACMD_GAME )]
unsafe fn ssbuexo_pikmin_dash_grab_acmd(fighter: &mut L2CAgentBase) {
...
//Pivot Grab ACMD
#[acmd_script( agent = "pikmin", script = "game_catchturn", category = ACMD_GAME )]
unsafe fn ssbuexo_pikmin_pivot_grab_acmd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 12.0);
    if macros::is_excute(fighter) {
        GrabModule::set_rebound(fighter.module_accessor, true);
    }
...
pub fn install() {
    install_acmd_scripts!(
        ssbuexo_pikmin_grab_acmd,
        ssbuexo_pikmin_dash_grab_acmd,
        ssbuexo_pikmin_pivot_grab_acmd
    );
}