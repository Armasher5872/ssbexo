...
pub fn install() {
    Agent::new("brave")
    .game_acmd("game_attackairb", ssbexo_brave_bair_acmd, Priority::Low)
    .game_acmd("game_attackairhi", ssbexo_brave_uair_acmd, Priority::Low)
    .game_acmd("game_attackairlw", ssbexo_brave_dair_acmd, Priority::Low)
    .install()
    ;
}