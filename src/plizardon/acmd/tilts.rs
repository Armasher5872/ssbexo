...
unsafe fn ssbuexo_plizardon_up_tilt_acmd(fighter: &mut L2CAgentBase) {
...
unsafe fn ssbuexo_plizardon_down_tilt_acmd(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    install_acmd_scripts!(
        ssbuexo_plizardon_up_tilt_acmd,
        ssbuexo_plizardon_down_tilt_acmd
    );
}