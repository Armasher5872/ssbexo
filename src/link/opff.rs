...
unsafe extern "C" fn link_bowarrow_init(weapon: &mut L2CFighterBase) {
    ...
    WorkModule::off_flag(boma, *WN_LINK_BOWARROW_INSTANCE_WORK_ID_FLAG_FUSE_DEDEDE_SWALLOW);
}
...
unsafe extern "C" fn link_boomerang_init(weapon: &mut L2CFighterBase) {
    ...
    WorkModule::off_flag(boma, *WN_LINK_BOOMERANG_INSTANCE_WORK_ID_FLAG_FUSE_REFLECT);
}
