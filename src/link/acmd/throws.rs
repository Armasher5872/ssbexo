...
pub fn install() {
    Agent::new("link")
    .game_acmd("game_catch", ssbexo_link_grab_acmd)
    .game_acmd("game_catchdash", ssbexo_link_dash_grab_acmd)
    .game_acmd("game_catchturn", ssbexo_link_pivot_grab_acmd)
    .game_acmd("game_throwf", ssbexo_link_forward_throw_acmd)
    .effect_acmd("effect_throwf", ssbexo_link_forward_throw_effect)
    .sound_acmd("sound_throwf", ssbexo_link_forward_throw_sound)
    .expression_acmd("expression_throwf", ssbexo_link_forward_throw_expression)
    .game_acmd("game_throwb", ssbexo_link_back_throw_acmd)
    .effect_acmd("effect_throwb", ssbexo_link_back_throw_effect)
    .sound_acmd("sound_throwb", ssbexo_link_back_throw_sound)
    .expression_acmd("expression_throwb", ssbexo_link_back_throw_expression)
    .install()
    ;
}