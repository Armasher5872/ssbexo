...
pub fn install() {
    Agent::new("richter")
    .game_acmd("game_catch", ssbexo_richter_grab_acmd)
    .game_acmd("game_catchdash", ssbexo_richter_dash_grab_acmd)
    .game_acmd("game_catchturn", ssbexo_richter_pivot_grab_acmd)
    .install()
    ;
}