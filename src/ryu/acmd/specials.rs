...
unsafe extern "C" fn ssbexo_ryu_hadoken_special_move_last_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 6.0, 55, 60, 0, 58, 5.0, 0.0, 0.0, -1.0, None, None, None, 1.5, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 5, true, true, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_ENERGY);
    }
}
...
unsafe extern "C" fn ssbexo_ryu_tatsumaki_loop_acmd(agent: &mut L2CAgentBase) {
    ...
    if strength == *FIGHTER_RYU_STRENGTH_W {
        ...
        if macros::is_excute(agent) {
            macros::ATTACK(agent, 0, 0, Hash40::new("top"), 12.0, 62, 67, 0, 80, 3.5, 0.0, 12.5, 12.5, Some(0.0), Some(12.5), Some(2.0), 1.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, -4, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_RYU_KICK, *ATTACK_REGION_KICK);
        }
    }
    else {
        if macros::is_excute(agent) {
            macros::ATTACK(agent, 0, 0, Hash40::new("top"), 13.0, 70, 71, 0, 80, 3.5, 0.0, 12.5, 12.5, Some(0.0), Some(12.5), Some(2.0), 1.5, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, false, -4, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_RYU_KICK, *ATTACK_REGION_KICK);
        }
    }
...
unsafe extern "C" fn ssbexo_ryu_shoryuken_acmd(agent: &mut L2CAgentBase) {
    ...
    wait(agent.lua_state_agent, 1.0);
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("handr"), 12.0, 80, 64, 0, 80, 4.0, 0.0, 0.0, 0.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, -8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_RYU_PUNCH, *ATTACK_REGION_PUNCH);
...
pub fn install() {
    Agent::new("ryu")
    .game_acmd("game_specialn", ssbexo_ryu_hadoken_acmd, Priority::Low)
    .game_acmd("game_specialairn", ssbexo_ryu_hadoken_acmd, Priority::Low)
    .game_acmd("game_specialsstart", ssbexo_ryu_tatsumaki_start_acmd, Priority::Low)
    .game_acmd("game_specialairsstart", ssbexo_ryu_tatsumaki_start_acmd, Priority::Low)
    .game_acmd("game_specials", ssbexo_ryu_tatsumaki_loop_acmd, Priority::Low)
    .game_acmd("game_specialairs", ssbexo_ryu_tatsumaki_loop_acmd, Priority::Low)
    .game_acmd("game_specialsend", ssbexo_ryu_tatsumaki_end_acmd, Priority::Low)
    .game_acmd("game_specialairsend", ssbexo_ryu_tatsumaki_end_acmd, Priority::Low)
    .game_acmd("game_specialhi", ssbexo_ryu_shoryuken_acmd, Priority::Low)
    .game_acmd("game_specialairhi", ssbexo_ryu_shoryuken_acmd, Priority::Low)
    .install()
    ;
    Agent::new("ryu_hadoken")
    .game_acmd("game_movew", ssbexo_ryu_hadoken_move_w_acmd, Priority::Low)
    .game_acmd("game_movem", ssbexo_ryu_hadoken_move_m_acmd, Priority::Low)
    .game_acmd("game_moves", ssbexo_ryu_hadoken_move_s_acmd, Priority::Low)
    .game_acmd("game_movespw", ssbexo_ryu_hadoken_special_move_w_acmd, Priority::Low)
    .game_acmd("game_movespm", ssbexo_ryu_hadoken_special_move_m_acmd, Priority::Low)
    .game_acmd("game_movesps", ssbexo_ryu_hadoken_special_move_s_acmd, Priority::Low)
    .game_acmd("game_movespwlast", ssbexo_ryu_hadoken_special_move_last_acmd, Priority::Low)
    .game_acmd("game_movespmlast", ssbexo_ryu_hadoken_special_move_last_acmd, Priority::Low)
    .game_acmd("game_movespslast", ssbexo_ryu_hadoken_special_move_last_acmd, Priority::Low)
    .install()
    ;
}