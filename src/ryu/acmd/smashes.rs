...
pub fn install() {
    Agent::new("ryu")
    .game_acmd("game_attacks4", ssbexo_ryu_forward_smash_acmd, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_ryu_down_smash_acmd, Priority::Low)
    .install()
    ;
}