...
pub fn install() {
    Agent::new("samus")
    .game_acmd("game_attacks3", ssbexo_samus_forward_tilt_acmd, Priority::Low)
    .game_acmd("game_attacks3hi", ssbexo_samus_forward_tilt_acmd, Priority::Low)
    .game_acmd("game_attacks3lw", ssbexo_samus_forward_tilt_acmd, Priority::Low)
    .game_acmd("game_attackhi3", ssbexo_samus_up_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attackhi3", ssbexo_samus_up_tilt_effect, Priority::Low)
    .sound_acmd("sound_attackhi3", ssbexo_samus_up_tilt_sound, Priority::Low)
    .expression_acmd("expression_attackhi3", ssbexo_samus_up_tilt_expression, Priority::Low)
    .game_acmd("game_attacklw3", ssbexo_samus_down_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacklw3", ssbexo_samus_down_tilt_effect, Priority::Low)
    .sound_acmd("sound_attacklw3", ssbexo_samus_down_tilt_sound, Priority::Low)
    .expression_acmd("expression_attacklw3", ssbexo_samus_down_tilt_expression, Priority::Low)
    .install()
    ;
}