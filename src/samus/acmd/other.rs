    ...
    if WorkModule::is_flag(agent.module_accessor, *FIGHTER_INSTANCE_WORK_ID_FLAG_FINAL_CHARGE) {
        ...
        if WorkModule::is_flag(agent.module_accessor, *FIGHTER_INSTANCE_WORK_ID_FLAG_DISABLE_FINAL_START_CAMERA) {
            if macros::is_excute(agent) {
                ...
                if macros::is_excute(agent) {
                    macros::CAM_ZOOM_IN_arg5(agent, 1.7, 0.0, 3.0*scale, 0.0, 0.0);
...
pub fn install() {
    Agent::new("samus")
    .game_acmd("game_finalstart", ssbexo_samus_final_smash_start_acmd, Priority::Low)
    .game_acmd("game_finalairstart", ssbexo_samus_final_smash_start_acmd, Priority::Low)
    .game_acmd("game_final", ssbexo_samus_final_smash_acmd, Priority::Low)
    .game_acmd("game_finalair", ssbexo_samus_final_smash_acmd, Priority::Low)
    .install()
    ;
    Agent::new("samus_laser")
    .game_acmd("game_shoot", ssbexo_samus_laser_shoot_acmd, Priority::Low)
    .install()
    ;
    Agent::new("samus_laser2")
    .game_acmd("game_lower", ssbexo_samus_laser_2_lower_acmd, Priority::Low)
    .game_acmd("game_upper", ssbexo_samus_laser_2_upper_acmd, Priority::Low)
    .install()
    ;
}