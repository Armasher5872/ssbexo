...
pub fn install() {
    Agent::new("master")
    .game_acmd("game_speciallw", ssbexo_master_grounded_down_special_acmd, Priority::Low)
    .game_acmd("game_specialairlw", ssbexo_master_aerial_down_special_acmd, Priority::Low)
    .install()
    ;
}