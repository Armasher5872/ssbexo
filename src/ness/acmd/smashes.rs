...
pub fn install() {
    ...
    .game_acmd("game_attackhi4charge", ssbexo_ness_yoyo_smash_charge_acmd, Priority::Low)
    .game_acmd("game_attacklw4charge", ssbexo_ness_yoyo_smash_charge_acmd, Priority::Low)
    .install()
    ;
}