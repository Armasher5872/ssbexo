...
unsafe extern "C" fn lucina_frame(fighter: &mut L2CFighterCommon) {
    ...
    && statuses {
        EffectModule::req_follow(boma, Hash40{hash: hash40("sys_damage_elec")}, Hash40::new("sword2"), &valuea, &valuea, 0.25, true, *EFFECT_SUB_ATTRIBUTE_NO_JOINT_SCALE as u32 | *EFFECT_SUB_ATTRIBUTE_FOLLOW as u32 | *EFFECT_SUB_ATTRIBUTE_CONCLUDE_STATUS as u32, 0, 0, 0, 0, true, true);
        macros::LAST_EFFECT_SET_COLOR(fighter, 0.0, 0.3, 1.0);
        EffectModule::req_follow(boma, Hash40{hash: hash40("sys_damage_elec")}, Hash40{hash: hash40("sword2")}, &valueb, &valueb, 0.25, true, *EFFECT_SUB_ATTRIBUTE_NO_JOINT_SCALE as u32 | *EFFECT_SUB_ATTRIBUTE_FOLLOW as u32 | *EFFECT_SUB_ATTRIBUTE_CONCLUDE_STATUS as u32, 0, 0, 0, 0, true, true);
        macros::LAST_EFFECT_SET_COLOR(fighter, 0.0, 0.3, 1.0);
        EffectModule::req_follow(boma, Hash40{hash: hash40("sys_damage_elec")}, Hash40::new("sword2"), &valuec, &valuec, 0.25, true, *EFFECT_SUB_ATTRIBUTE_NO_JOINT_SCALE as u32 | *EFFECT_SUB_ATTRIBUTE_FOLLOW as u32 | *EFFECT_SUB_ATTRIBUTE_CONCLUDE_STATUS as u32, 0, 0, 0, 0, true, true);
        macros::LAST_EFFECT_SET_COLOR(fighter, 0.0, 0.3, 1.0);
    ...
    && MotionModule::end_frame(boma) - frame <= 2.0 {
    ...
    && KineticModule::get_kinetic_type(boma) != *FIGHTER_KINETIC_TYPE_MOTION_AIR {
