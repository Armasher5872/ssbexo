...
unsafe extern "C" fn ssbexo_wario_down_smash_charge_effect(agent: &mut L2CAgentBase) {
    ...
    for _ in 0..i32::MAX {
        ...
        macros::EFFECT(agent, Hash40::new("sys_smash_flash_s"), Hash40::new("handr"), 5, 0, 0, 0, 0, 0, 1, 3, 3, 3, 0, 0, 0, true);
    }
}
...
unsafe extern "C" fn ssbexo_wario_down_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("handr"), 16.0, 270, 80, 0, 20, 5.7, 2.3, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_PUNCH);
        macros::ATTACK(agent, 1, 0, Hash40::new("armr"), 16.0, 270, 80, 0, 20, 3.0, -0.5, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_PUNCH);
    }
    frame(agent.lua_state_agent, 14.0);
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 2, 0, Hash40::new("top"), 10.0, 15, 60, 0, 65, 8.0, 0.0, 4.0, 3.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_NONE);
        macros::ATTACK(agent, 3, 0, Hash40::new("top"), 10.0, 15, 60, 0, 65, 8.0, 0.0, 4.0, -3.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_NONE);
    }
...
unsafe extern "C" fn ssbexo_wario_down_smash_effect(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::LAST_EFFECT_SET_RATE(agent, 1.2);
        macros::EFFECT(agent, Hash40::new("edge_gokumon_impact"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 2.0, 0, 0, 0, 0, 0, 0, true);
...
unsafe extern "C" fn ssbexo_wario_down_smash_sound(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::PLAY_SE(agent, Hash40::new("vc_wario_attack05"));
        macros::PLAY_SE(agent, Hash40::new("se_wario_smash_l01"));
    }
    frame(agent.lua_state_agent, 13.0);
    if macros::is_excute(agent) {
...
pub fn install() {
    Agent::new("wario")
    .effect_acmd("effect_attacklw4charge", ssbexo_wario_down_smash_charge_effect, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_wario_down_smash_acmd, Priority::Low)
    .effect_acmd("effect_attacklw4", ssbexo_wario_down_smash_effect, Priority::Low)
    .sound_acmd("sound_attacklw4", ssbexo_wario_down_smash_sound, Priority::Low)
    .expression_acmd("expression_attacklw4", ssbexo_wario_down_smash_expression, Priority::Low)
    .install()
    ;
}