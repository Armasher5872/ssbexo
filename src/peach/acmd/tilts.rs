...
unsafe extern "C" fn ssbexo_peach_forward_tilt_effect(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::EFFECT_FOLLOW(agent, Hash40::new("sys_attack_arc_d"), Hash40::new("top"), 2, 6, 2.2, 5, -1, 11.8, 0.95, true);
        macros::LAST_EFFECT_SET_COLOR(agent, 1.0, 0.8, 0.9);
...
unsafe extern "C" fn ssbexo_peach_forward_tilt_sound(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::PLAY_SE(agent, Hash40::new("se_peach_attackhard_s01"));
    }
}
...
pub fn install() {
    Agent::new("peach")
    .game_acmd("game_attacks3", ssbexo_peach_forward_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacks3", ssbexo_peach_forward_tilt_effect, Priority::Low)
    .sound_acmd("sound_attacks3", ssbexo_peach_forward_tilt_sound, Priority::Low)
    .expression_acmd("expression_attacks3", ssbexo_peach_forward_tilt_expression, Priority::Low)
    .install()
    ;
}