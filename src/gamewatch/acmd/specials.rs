...
pub fn install() {
    Agent::new("gamewatch")
    .game_acmd("game_specials1", ssbexo_gamewatch_judge_one_acmd, Priority::Low)
    .game_acmd("game_specialairs1", ssbexo_gamewatch_judge_one_acmd, Priority::Low)
    .game_acmd("game_specials2", ssbexo_gamewatch_judge_two_acmd, Priority::Low)
    .game_acmd("game_specialairs2", ssbexo_gamewatch_judge_two_acmd, Priority::Low)
    .game_acmd("game_specials3", ssbexo_gamewatch_judge_three_acmd, Priority::Low)
    .game_acmd("game_specialairs3", ssbexo_gamewatch_judge_three_acmd, Priority::Low)
    .game_acmd("game_specials4", ssbexo_gamewatch_judge_four_acmd, Priority::Low)
    .game_acmd("game_specialairs4", ssbexo_gamewatch_judge_four_acmd, Priority::Low)
    .game_acmd("game_specials5", ssbexo_gamewatch_judge_five_acmd, Priority::Low)
    .game_acmd("game_specialairs5", ssbexo_gamewatch_judge_five_acmd, Priority::Low)
    .game_acmd("game_specials6", ssbexo_gamewatch_judge_six_acmd, Priority::Low)
    .game_acmd("game_specialairs6", ssbexo_gamewatch_judge_six_acmd, Priority::Low)
    .game_acmd("game_specials7", ssbexo_gamewatch_judge_seven_acmd, Priority::Low)
    .game_acmd("game_specialairs7", ssbexo_gamewatch_judge_seven_acmd, Priority::Low)
    .game_acmd("game_specials8", ssbexo_gamewatch_judge_eight_acmd, Priority::Low)
    .game_acmd("game_specialairs8", ssbexo_gamewatch_judge_eight_acmd, Priority::Low)
    .game_acmd("game_specials9", ssbexo_gamewatch_judge_nine_acmd, Priority::Low)
    .game_acmd("game_specialairs9", ssbexo_gamewatch_judge_nine_acmd, Priority::Low)
    .game_acmd("game_specialhi", ssbexo_gamewatch_special_hi_acmd, Priority::Low)
    .game_acmd("game_specialairhi", ssbexo_gamewatch_special_hi_acmd, Priority::Low)
    .install()
    ;
}