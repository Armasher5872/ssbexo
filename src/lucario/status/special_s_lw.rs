...
unsafe extern "C" fn lucario_side_special_lw_pre_status(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn lucario_side_special_lw_init_status(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn lucario_side_special_lw_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    fighter.sub_change_motion_by_situation(L2CValue::Hash40s("special_s_lw"), L2CValue::Hash40s("special_air_s_lw"), false.into());
    fighter.sub_shift_status_main(L2CValue::Ptr(lucario_side_special_lw_main_loop as *const () as _))
}

unsafe extern "C" fn lucario_side_special_lw_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if situation_kind == *SITUATION_KIND_AIR && current_frame == 17.0 {
        KineticModule::change_kinetic(fighter.module_accessor, *FIGHTER_KINETIC_TYPE_FALL);
...
unsafe extern "C" fn lucario_side_special_lw_exec_status(_fighter: &mut L2CFighterCommon) -> L2CValue {
    0.into()
}
