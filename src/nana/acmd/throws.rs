...
//Standing Grab ACMD
#[acmd_script( agent = "nana", script = "game_catch", category = ACMD_GAME )]
unsafe fn ssbuexo_nana_grab_acmd(fighter: &mut L2CAgentBase) {
...
//Dash Grab ACMD
#[acmd_script( agent = "nana", script = "game_catchdash", category = ACMD_GAME )]
unsafe fn ssbuexo_nana_dash_grab_acmd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
//Pivot Grab ACMD
#[acmd_script( agent = "nana", script = "game_catchturn", category = ACMD_GAME )]
unsafe fn ssbuexo_nana_pivot_grab_acmd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
...
pub fn install() {
    install_acmd_scripts!(
        ssbuexo_nana_grab_acmd,
        ssbuexo_nana_dash_grab_acmd,
        ssbuexo_nana_pivot_grab_acmd
    );
}