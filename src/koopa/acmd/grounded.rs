...
pub fn install() {
    Agent::new("koopa")
    .expression_acmd("expression_wait2", ssbexo_koopa_wait_2_expression)
    .expression_acmd("expression_wait3", ssbexo_koopa_wait_3_expression)
    .effect_acmd("effect_appealhil", ssbexo_koopa_up_taunt_effect)
    .effect_acmd("effect_appealhir", ssbexo_koopa_up_taunt_effect)
    .sound_acmd("sound_appealhil", ssbexo_koopa_up_taunt_sound)
    .sound_acmd("sound_appealhir", ssbexo_koopa_up_taunt_sound)
    .expression_acmd("expression_appealhil", ssbexo_koopa_up_taunt_expression)
    .expression_acmd("expression_appealhir", ssbexo_koopa_up_taunt_expression)
    .game_acmd("game_appealsr", ssbexo_koopa_side_taunt_acmd)
    .game_acmd("game_appealsl", ssbexo_koopa_side_taunt_acmd)
    .expression_acmd("expression_appealsl", ssbexo_koopa_side_taunt_expression)
    .expression_acmd("expression_appealsr", ssbexo_koopa_side_taunt_expression)
    .game_acmd("game_attack11", ssbexo_koopa_jab_1_acmd)
    .game_acmd("game_attackdash", ssbexo_koopa_dash_attack_acmd)
    .effect_acmd("effect_attackdash", ssbexo_koopa_dash_attack_effect)
    .install()
    ;
}