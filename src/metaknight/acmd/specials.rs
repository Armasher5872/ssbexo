...
pub fn install() {
    ...
    .game_acmd("game_specialnspin", ssbexo_metaknight_neutral_special_spin_acmd, Priority::Low)
    .game_acmd("game_specialnend", ssbexo_metaknight_neutral_special_end_acmd, Priority::Low)
    .game_acmd("game_specialairnend", ssbexo_metaknight_neutral_special_end_acmd, Priority::Low)
    .game_acmd("game_specialsstart", ssbexo_metaknight_galaxia_beam_fire_acmd, Priority::Low)
    .effect_acmd("effect_specialsstart", ssbexo_metaknight_galaxia_beam_grounded_fire_effect, Priority::Low)
    .sound_acmd("sound_specialsstart", ssbexo_metaknight_galaxia_beam_grounded_fire_sound, Priority::Low)
    .expression_acmd("expression_specialsstart", ssbexo_metaknight_galaxia_beam_grounded_fire_expression, Priority::Low)
    .game_acmd("game_specialairsstart", ssbexo_metaknight_galaxia_beam_fire_acmd, Priority::Low)
    .effect_acmd("effect_specialairsstart", ssbexo_metaknight_galaxia_beam_aerial_fire_effect, Priority::Low)
    .sound_acmd("sound_specialairsstart", ssbexo_metaknight_galaxia_beam_aerial_fire_sound, Priority::Low)
    .expression_acmd("expression_specialairsstart", ssbexo_metaknight_galaxia_beam_aerial_fire_expression, Priority::Low)
    .game_acmd("game_specialhi", ssbexo_metaknight_up_special_acmd, Priority::Low)
    .effect_acmd("effect_specialhi", ssbexo_metaknight_up_special_effect, Priority::Low)
    .sound_acmd("sound_specialhi", ssbexo_metaknight_up_special_sound, Priority::Low)
    .game_acmd("game_specialhiloop", ssbexo_metaknight_up_special_loop_acmd, Priority::Low)
    .effect_acmd("effect_specialhiloop", ssbexo_metaknight_up_special_loop_effect, Priority::Low)
    .sound_acmd("sound_specialhiloop", ssbexo_metaknight_up_special_loop_sound, Priority::Low)
    .game_acmd("game_glidestart", ssbexo_metaknight_glide_start_acmd, Priority::Low)
    .effect_acmd("effect_glidestart", ssbexo_metaknight_glide_start_effect, Priority::Low)
    .sound_acmd("sound_glidestart", ssbexo_metaknight_glide_start_sound, Priority::Low)
    .effect_acmd("effect_glidewing", ssbexo_metaknight_glide_wing_effect, Priority::Low)
    .game_acmd("game_glideattack", ssbexo_metaknight_glide_attack_acmd, Priority::Low)
    .effect_acmd("effect_glideattack", ssbexo_metaknight_glide_attack_effect, Priority::Low)
    .sound_acmd("sound_glideattack", ssbexo_metaknight_glide_attack_sound, Priority::Low)
    .effect_acmd("effect_glidelanding", ssbexo_metaknight_glide_landing_effect, Priority::Low)
    .sound_acmd("sound_glidelanding", ssbexo_metaknight_glide_landing_sound, Priority::Low)
    .sound_acmd("sound_glideend", ssbexo_metaknight_glide_end_sound, Priority::Low)
    .install()
    ;
    Agent::new("metaknight_galaxiabeam")
    .game_acmd("game_shoot", ssbexo_metaknight_galaxia_beam_acmd, Priority::Low)
    .effect_acmd("effect_shoot", ssbexo_metaknight_galaxia_beam_effect, Priority::Low)
    .sound_acmd("sound_shoot", ssbexo_metaknight_galaxia_beam_sound, Priority::Low)
    .install()
    ;
}