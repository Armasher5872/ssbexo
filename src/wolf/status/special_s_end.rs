...
unsafe extern "C" fn wolf_special_s_end_substatus(fighter: &mut L2CFighterCommon, param_3: L2CValue) -> L2CValue {
    if param_3.get_bool() {
...
unsafe extern "C" fn wolf_special_s_end_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if AttackModule::is_infliction_status(fighter.module_accessor, *COLLISION_KIND_MASK_HIT) && LAST_ATTACK_HITBOX_ID == 0 {
