...
unsafe extern "C" fn wolf_special_s_substatus(fighter: &mut L2CFighterCommon, param_3: L2CValue) -> L2CValue {
    if param_3.get_bool() {
...
unsafe extern "C" fn wolf_special_s_end_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    0.into()
}
