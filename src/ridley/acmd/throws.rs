...
pub fn install() {
    Agent::new("ridley")
    .game_acmd("game_catch", ssbexo_ridley_grab_acmd)
    .game_acmd("game_catchdash", ssbexo_ridley_dash_grab_acmd)
    .game_acmd("game_catchturn", ssbexo_ridley_pivot_grab_acmd)
    .install()
    ;
}