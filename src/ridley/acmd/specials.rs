...
pub fn install() {
    Agent::new("ridley")
    .game_acmd("game_specialairhiwallf", ssbexo_ridley_up_special_wall_bounce_forward_acmd)
    .game_acmd("game_specialairhiwallb", ssbexo_ridley_up_special_wall_bounce_back_acmd)
    .game_acmd("game_specialairhiceil", ssbexo_ridley_up_special_wall_bounce_up_acmd)
    .game_acmd("game_speciallwrelease", ssbexo_ridley_grounded_down_special_stab_acmd)
    .game_acmd("game_speciallwfinish", ssbexo_ridley_grounded_down_special_release_acmd)
    .game_acmd("game_specialairlwstab", ssbexo_ridley_aerial_down_special_acmd)
    .effect_acmd("effect_specialairlwstab", ssbexo_ridley_aerial_down_special_effect)
    .sound_acmd("sound_specialairlwstab", ssbexo_ridley_aerial_down_special_sound)
    .expression_acmd("expression_specialairlwstab", ssbexo_ridley_aerial_down_special_expression)
    .game_acmd("game_speciallwpogolanding", ssbexo_ridley_aerial_down_special_landing_acmd)
    .effect_acmd("effect_speciallwpogolanding", ssbexo_ridley_aerial_down_special_landing_effect)
    .sound_acmd("sound_speciallwpogolanding", ssbexo_ridley_aerial_down_special_landing_sound)
    .expression_acmd("expression_speciallwpogolanding", ssbexo_ridley_aerial_down_special_landing_expression)
    .install()
    ;
}