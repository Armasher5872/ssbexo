...
pub fn install() {
    Agent::new("kirby")
    .game_acmd("game_attacks3", ssbexo_kirby_forward_tilt_f_acmd, Priority::Low)
    .game_acmd("game_attacks3hi", ssbexo_kirby_forward_tilt_hi_acmd, Priority::Low)
    .game_acmd("game_attacks3lw", ssbexo_kirby_forward_tilt_lw_acmd, Priority::Low)
    .effect_acmd("effect_attacks3", ssbexo_kirby_forward_tilt_effect, Priority::Low)
    .effect_acmd("effect_attacks3hi", ssbexo_kirby_forward_tilt_effect, Priority::Low)
    .effect_acmd("effect_attacks3lw", ssbexo_kirby_forward_tilt_effect, Priority::Low)
    .effect_acmd("effect_attackhi3", ssbexo_kirby_up_tilt_effect, Priority::Low)
    .game_acmd("game_attacklw3", ssbexo_kirby_down_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacklw3", ssbexo_kirby_down_tilt_effect, Priority::Low)
    .sound_acmd("sound_attacklw3", ssbexo_kirby_down_tilt_sound, Priority::Low)
    .game_acmd("game_attacklw32", ssbexo_kirby_down_tilt_bounce_acmd, Priority::Low)
    .effect_acmd("effect_attacklw32", ssbexo_kirby_down_tilt_bounce_effect, Priority::Low)
    .install()
    ;
}