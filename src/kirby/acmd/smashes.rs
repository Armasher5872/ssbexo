...
pub fn install() {
    Agent::new("kirby")
    .game_acmd("game_attacks4", ssbexo_kirby_forward_smash_acmd)
    .game_acmd("game_attacks4hi", ssbexo_kirby_forward_smash_acmd)
    .game_acmd("game_attacks4lw", ssbexo_kirby_forward_smash_acmd)
    .effect_acmd("effect_attacks4", ssbexo_kirby_forward_smash_effect)
    .effect_acmd("effect_attacks4hi", ssbexo_kirby_forward_smash_effect)
    .effect_acmd("effect_attacks4lw", ssbexo_kirby_forward_smash_effect)
    .sound_acmd("sound_attacks4", ssbexo_kirby_forward_smash_sound)
    .sound_acmd("sound_attacks4hi", ssbexo_kirby_forward_smash_sound)
    .sound_acmd("sound_attacks4lw", ssbexo_kirby_forward_smash_sound)
    .expression_acmd("expression_attacks4", ssbexo_kirby_forward_smash_expression)
    .expression_acmd("expression_attacks4hi", ssbexo_kirby_forward_smash_expression)
    .expression_acmd("expression_attacks4lw", ssbexo_kirby_forward_smash_expression)
    .effect_acmd("effect_attackhi4charge", ssbexo_kirby_up_smash_charge_effect)
    .game_acmd("game_attackhi4", ssbexo_kirby_up_smash_acmd)
    .effect_acmd("effect_attackhi4", ssbexo_kirby_up_smash_effect)
    .sound_acmd("sound_attackhi4", ssbexo_kirby_up_smash_sound)
    .expression_acmd("expression_attackhi4", ssbexo_kirby_up_smash_expression)
    .game_acmd("game_attacklw4", ssbexo_kirby_down_smash_acmd)
    .effect_acmd("effect_attacklw4", ssbexo_kirby_down_smash_effect)
    .install()
    ;
    Agent::new("kirby_hammer")
    .effect_acmd("effect_attackhi4", ssbexo_kirby_up_smash_hammer_effect)
    .install()
    ;
}