...
unsafe extern "C" fn ssbexo_younglink_forward_tilt_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 6.0, 80, 65, 0, 55, 6.0, 0.0, 6.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
    }
    frame(agent.lua_state_agent, 13.0);
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 4.0, 80, 40, 0, 55, 6.0, 0.0, 6.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
    }
...
unsafe extern "C" fn ssbexo_younglink_forward_tilt_effect(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::LANDING_EFFECT(agent, Hash40::new("sys_atk_smoke"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 0.65, 0, 0, 0, 0, 0, 0, false);
    }
    frame(agent.lua_state_agent, 17.0);
    if macros::is_excute(agent) {
        macros::FOOT_EFFECT(agent, Hash40::new("sys_down_smoke"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 0.65, 0, 0, 0, 0, 0, 0, false);
    }
}
...
unsafe extern "C" fn ssbexo_younglink_down_tilt_effect(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 8.0);
    if macros::is_excute(agent) {
        macros::EFFECT(agent, Hash40::new("sys_smash_flash"), Hash40::new("sword"), 8.5, 0, 0.0, 0, 0, 0, 0.6, 0, 0, 0, 0, 0, 0, true);
...
pub fn install() {
    Agent::new("younglink")
    .game_acmd("game_attacks3", ssbexo_younglink_forward_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacks3", ssbexo_younglink_forward_tilt_effect, Priority::Low)
    .sound_acmd("sound_attacks3", ssbexo_younglink_forward_tilt_sound, Priority::Low)
    .expression_acmd("expression_attacks3", ssbexo_younglink_forward_tilt_expression, Priority::Low)
    .game_acmd("game_attacklw3", ssbexo_younglink_down_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacklw3", ssbexo_younglink_down_tilt_effect, Priority::Low)
    .sound_acmd("sound_attacklw3", ssbexo_younglink_down_tilt_sound, Priority::Low)
    .expression_acmd("expression_attacklw3", ssbexo_younglink_down_tilt_expression, Priority::Low)
    .install()
    ;
}