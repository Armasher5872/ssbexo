...
pub fn install() {
    Agent::new("littlemac")
    .game_acmd("game_specialn2", ssbexo_littlemac_grounded_star_punch_acmd, Priority::Low)
    .game_acmd("game_specialairn2", ssbexo_littlemac_aerial_star_punch_acmd, Priority::Low)
    .game_acmd("game_speciallw", ssbexo_littlemac_slip_counter_acmd, Priority::Low)
    .game_acmd("game_specialairlw", ssbexo_littlemac_slip_counter_acmd, Priority::Low)
    .game_acmd("game_speciallwhit", ssbexo_littlemac_grounded_slip_counter_hit_acmd, Priority::Low)
    .game_acmd("game_specialairlwhit", ssbexo_littlemac_aerial_slip_counter_hit_acmd, Priority::Low)
    .effect_acmd("effect_speciallwhit", ssbexo_littlemac_grounded_slip_counter_hit_effect, Priority::Low)
    .effect_acmd("effect_specialairlwhit", ssbexo_littlemac_aerial_slip_counter_hit_effect, Priority::Low)
    .sound_acmd("sound_speciallwhit", ssbexo_littlemac_slip_counter_hit_sound, Priority::Low)
    .sound_acmd("sound_specialairlwhit", ssbexo_littlemac_slip_counter_hit_sound, Priority::Low)
    .expression_acmd("expression_speciallwhit", ssbexo_littlemac_grounded_slip_counter_hit_expression, Priority::Low)
    .expression_acmd("expression_specialairlwhit", ssbexo_littlemac_aerial_slip_counter_hit_expression, Priority::Low)
    .install()
    ;
}