...
pub fn install() {
    ...
    .effect_acmd("effect_specialairsstart", ssbexo_luigi_grounded_side_special_effect)
    .sound_acmd("sound_specialsstart", ssbexo_luigi_aerial_side_special_sound)
    .sound_acmd("sound_specialairsstart", ssbexo_luigi_grounded_side_special_sound)
    .expression_acmd("expression_specialsstart", ssbexo_luigi_aerial_side_special_expression)
