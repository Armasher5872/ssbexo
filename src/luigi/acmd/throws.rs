...
pub fn install() {
    ...
    .game_acmd("game_throwf", ssbexo_luigi_forward_throw_acmd)
    .effect_acmd("effect_throwf", ssbexo_luigi_forward_throw_effect)
    .sound_acmd("sound_throwf", ssbexo_luigi_forward_throw_sound)
    .expression_acmd("expression_throwf", ssbexo_luigi_forward_throw_expression)
    .game_acmd("game_throwb", ssbexo_luigi_back_throw_acmd)
    .effect_acmd("effect_throwb", ssbexo_luigi_back_throw_effect)
    .sound_acmd("sound_throwb", ssbexo_luigi_back_throw_sound)
    .expression_acmd("expression_throwb", ssbexo_luigi_back_throw_expression)
    .game_acmd("game_throwhi", ssbexo_luigi_up_throw_acmd)
    .effect_acmd("effect_throwhi", ssbexo_luigi_up_throw_effect)
    .sound_acmd("sound_throwhi", ssbexo_luigi_up_throw_sound)
    .expression_acmd("expression_throwhi", ssbexo_luigi_up_throw_expression)
    .game_acmd("game_throwlw", ssbexo_luigi_down_throw_acmd)
    .install()
    ;
}