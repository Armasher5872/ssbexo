...
pub fn install() {
    Agent::new("luigi")
    .effect_acmd("effect_attacks4charge", ssbexo_luigi_forward_smash_charge_effect, Priority::Low)
    .sound_acmd("sound_attacks4charge", ssbexo_luigi_forward_smash_charge_sound, Priority::Low)
    .expression_acmd("expression_attacks4charge", ssbexo_luigi_forward_smash_charge_expression, Priority::Low)
    .game_acmd("game_attacks4", ssbexo_luigi_forward_smash_acmd, Priority::Low)
    .game_acmd("game_attacks4hi", ssbexo_luigi_forward_smash_acmd, Priority::Low)
    .game_acmd("game_attacks4lw", ssbexo_luigi_forward_smash_acmd, Priority::Low)
    .effect_acmd("effect_attacks4", ssbexo_luigi_forward_smash_f_effect, Priority::Low)
    .effect_acmd("effect_attacks4hi", ssbexo_luigi_forward_smash_hi_effect, Priority::Low)
    .effect_acmd("effect_attacks4lw", ssbexo_luigi_forward_smash_lw_effect, Priority::Low)
    .sound_acmd("sound_attacks4", ssbexo_luigi_forward_smash_sound, Priority::Low)
    .sound_acmd("sound_attacks4hi", ssbexo_luigi_forward_smash_sound, Priority::Low)
    .sound_acmd("sound_attacks4lw", ssbexo_luigi_forward_smash_sound, Priority::Low)
    .expression_acmd("expression_attacks4", ssbexo_luigi_forward_smash_expression, Priority::Low)
    .expression_acmd("expression_attacks4hi", ssbexo_luigi_forward_smash_expression, Priority::Low)
    .expression_acmd("expression_attacks4lw", ssbexo_luigi_forward_smash_expression, Priority::Low)
    .game_acmd("game_attackhi4", ssbexo_luigi_up_smash_acmd, Priority::Low)
    .game_acmd("game_attacklw4", ssbexo_luigi_down_smash_acmd, Priority::Low)
    .install()
    ;
}