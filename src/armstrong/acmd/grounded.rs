...
unsafe fn ssbuexo_armstrong_jab_effect(fighter: &mut L2CAgentBase) 
{
    ...
    if macros::is_excute(fighter) {
        ...
        macros::EFFECT(fighter, Hash40::new("sys_attack_line"), Hash40::new("top"), 0, 13.3, -0.5, 20, 0, 0, 1.2, 0, 0, 0, 0, 0, 0, true);
