...
pub fn install() {
    Agent::new("ganon")
    .game_acmd("game_attacks3", ssbexo_armstrong_forward_tilt_acmd, Priority::Low)
    .game_acmd("game_attacks3hi", ssbexo_armstrong_forward_tilt_acmd, Priority::Low)
    .game_acmd("game_attacks3lw", ssbexo_armstrong_forward_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacks3", ssbexo_armstrong_forward_tilt_effect, Priority::Low)
    .effect_acmd("effect_attacks3hi", ssbexo_armstrong_forward_tilt_hi_effect, Priority::Low)
    .effect_acmd("effect_attacks3lw", ssbexo_armstrong_forward_tilt_lw_effect, Priority::Low)
    .sound_acmd("sound_attacks3", ssbexo_armstrong_forward_tilt_sound, Priority::Low)
    .sound_acmd("sound_attacks3hi", ssbexo_armstrong_forward_tilt_sound, Priority::Low)
    .sound_acmd("sound_attacks3lw", ssbexo_armstrong_forward_tilt_sound, Priority::Low)
    .game_acmd("game_attackhi3", ssbexo_armstrong_up_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attackhi3", ssbexo_armstrong_up_tilt_effect, Priority::Low)
    .sound_acmd("sound_attackhi3", ssbexo_armstrong_up_tilt_sound, Priority::Low)
    .expression_acmd("expression_attackhi3", ssbexo_armstrong_up_tilt_expression, Priority::Low)
    .game_acmd("game_attacklw3", ssbexo_armstrong_down_tilt_acmd, Priority::Low)
    .effect_acmd("effect_attacklw3", ssbexo_armstrong_down_tilt_effect, Priority::Low)
    .install()
    ;
}