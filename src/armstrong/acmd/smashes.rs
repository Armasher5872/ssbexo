...
unsafe extern "C" fn ssbexo_armstrong_forward_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("handr"), 24.0, 40, 60, 0, 60, 5.0, 0.0, 0.0, 0.0, None, None, None, 1.75, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_PUNCH);
        macros::ATTACK(agent, 1, 0, Hash40::new("armr"), 24.0, 40, 60, 0, 60, 4.5, 0.0, 0.0, 0.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_BODY);
        macros::ATTACK(agent, 2, 0, Hash40::new("shoulderr"), 24.0, 40, 60, 0, 60, 4.0, 0.0, 0.0, 0.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_HEAVY, *ATTACK_REGION_BODY);
    }
...
pub fn install() {
    Agent::new("ganon")
    .effect_acmd("effect_attacks4charge", ssbexo_armstrong_forward_smash_charge_effect)
    .game_acmd("game_attacks4", ssbexo_armstrong_forward_smash_acmd)
    .effect_acmd("effect_attacks4", ssbexo_armstrong_forward_smash_effect)
    .sound_acmd("sound_attacks4", ssbexo_armstrong_forward_smash_sound)
    .game_acmd("game_attackhi4", ssbexo_armstrong_up_smash_acmd)
    .effect_acmd("effect_attackhi4", ssbexo_armstrong_up_smash_effect)
    .game_acmd("game_attacklw4", ssbexo_armstrong_down_smash_acmd)
    .effect_acmd("effect_attacklw4", ssbexo_armstrong_down_smash_effect)
    .sound_acmd("sound_attacklw4", ssbexo_armstrong_down_smash_sound)
    .install()
    ;
}