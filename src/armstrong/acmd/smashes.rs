...
unsafe fn ssbuexo_armstrong_forward_smash_charge_effect(fighter: &mut L2CAgentBase) 
{
    ...
    for _ in 0..15 {
        if macros::is_excute(fighter) {
            macros::EFFECT(fighter, Hash40::new("sys_smash_flash_s"), Hash40::new("haver"), -6, 9, 0, 0, 0, 0, 0.5, 4, 4, 4, 0, 0, 0, true);
            macros::EFFECT_FOLLOW(fighter, Hash40::new("ganon_majinken_flash"), Hash40::new("haver"), 0, 0, 0, 0, 0, 0, 0.5, true);
