...
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_DAMAGED: smash::lib::LuaConst = smash::lib::LuaConst::new(0x20000122);
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_DAMAGED_PREVENT: smash::lib::LuaConst = smash::lib::LuaConst::new(0x20000123);
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_DID_MAX_JUMP_COUNT: smash::lib::LuaConst = smash::lib::LuaConst::new(0x20000124);
...
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_FULL_SMASH_ATTACK: smash::lib::LuaConst = smash::lib::LuaConst::new(0x20000127);
...
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_READY_GO: smash::lib::LuaConst = smash::lib::LuaConst::new(0x2000012C); //Returns false for exactly one frame after is_ready_go becomes true, used to initiate certain events exactly once at the start of a match
...
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_USED_FS: smash::lib::LuaConst = smash::lib::LuaConst::new(0x20000131); //Flags when you just used a Final Smash in Special Smash
...
pub const FIGHTER_INSTANCE_WORK_ID_INT_GOT_HIT: smash::lib::LuaConst = smash::lib::LuaConst::new(0x100000F2); //Tracks if a player got hit during One-Hit mode
pub const FIGHTER_INSTANCE_WORK_ID_INT_MASHING: smash::lib::LuaConst = smash::lib::LuaConst::new(0x100000F3);
pub const FIGHTER_INSTANCE_WORK_ID_INT_PARRIED: smash::lib::LuaConst = smash::lib::LuaConst::new(0x100000F4);
pub const FIGHTER_INSTANCE_WORK_ID_INT_PARRY_TIMER: smash::lib::LuaConst = smash::lib::LuaConst::new(0x100000F5);
pub const FIGHTER_INSTANCE_WORK_ID_INT_SHIELD_BREAK_TIMER: smash::lib::LuaConst = smash::lib::LuaConst::new(0x100000F6);
