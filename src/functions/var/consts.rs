...
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_HITFLOW: i32 = 0x20000129;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_HIT_MOVE: i32 = 0x2000012A;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_IS_CC: i32 = 0x2000012B;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_READY_GO: i32 = 0x2000012C; //Returns false for exactly one frame after is_ready_go becomes true, used to initiate certain events exactly once at the start of a match
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_DISABLE: i32 = 0x2000012D;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_SPECIAL_LW_DISABLE: i32 = 0x2000012E;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_SPECIAL_N_DISABLE: i32 = 0x2000012F;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_SPECIAL_S_DISABLE: i32 = 0x20000130;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_WAVEDASH: i32 = 0x20000131;
pub const FIGHTER_INSTANCE_WORK_ID_FLAG_USED_FS: i32 = 0x20000132; //Flags when you just used a Final Smash in Special Smash
...
pub const FIGHTER_INSTANCE_WORK_ID_INT_GOT_HIT: i32 = 0x100000EE; //Tracks if a player got hit during One-Hit mode
pub const FIGHTER_INSTANCE_WORK_ID_INT_MASHING: i32 = 0x100000EF;
pub const FIGHTER_INSTANCE_WORK_ID_INT_PARRIED: i32 = 0x100000F0;
pub const FIGHTER_INSTANCE_WORK_ID_INT_PARRY_TIMER: i32 = 0x100000F1;
pub const FIGHTER_INSTANCE_WORK_ID_INT_SHIELD_BREAK_TIMER: i32 = 0x100000F2;
pub const FIGHTER_INSTANCE_WORK_ID_INT_SHIELD_DAMAGE: i32 = 0x100000F3;
pub const FIGHTER_INSTANCE_WORK_ID_INT_SPECIAL_ZOOM_GFX: i32 = 0x100000F4;
