...
const ARMSTRONG_VTABLE_ON_DAMAGE_OFFSET: usize = 0x68d9e0;
const ARMSTRONG_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xaa6510;
const ARMSTRONG_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
