...
const DONKEY_VTABLE_LINK_EVENT_OFFSET: usize = 0x993ee0;
const DONKEY_VTABLE_ONCE_PER_FIGHTER_FRAME: usize = 0x68d670;
const DONKEY_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x993750;
const DONKEY_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x993ae0;
