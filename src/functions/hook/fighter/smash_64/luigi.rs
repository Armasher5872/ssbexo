...
const LUIGI_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xca0ce0;
const LUIGI_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const LUIGI_VTABLE_LINK_EVENT_OFFSET: usize = 0xca0e70;
const LUIGI_VTABLE_CHANGE_MOTION_CALLBACK_OFFSET: usize = 0xca1510;
...
unsafe extern "C" fn luigi_reset_initialization(vtable: u64, fighter: &mut Fighter) -> u64 {
    let boma = fighter.battle_object.module_accessor;
    let entry_id = WorkModule::get_int(boma, *FIGHTER_INSTANCE_WORK_ID_INT_ENTRY_ID) as usize;
    WorkModule::set_flag(boma, false, FIGHTER_INSTANCE_WORK_ID_FLAG_ALL_LAST_STOCK);
    WorkModule::set_flag(boma, false, FIGHTER_INSTANCE_WORK_ID_FLAG_ALREADY_BOUNCED);
