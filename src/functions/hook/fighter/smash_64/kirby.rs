...
const KIRBY_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xb96100;
const KIRBY_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0xb96350;
const KIRBY_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xb97b30;
