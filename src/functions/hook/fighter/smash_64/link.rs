...
const LINK_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xc280f0;
const LINK_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0xc28280;
const LINK_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xc289e0;
