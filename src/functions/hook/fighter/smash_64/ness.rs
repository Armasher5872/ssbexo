...
const NESS_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xdefdf0;
const NESS_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const NESS_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xdf0360;
