...
const SHEIK_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x1120c60;
const SHEIK_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x1120910;
const SHEIK_VTABLE_ONCE_PER_FIGHTER_FRAME: usize = 0x1120e10;

//Sheik Startup Initialization
#[skyline::hook(offset = SHEIK_VTABLE_START_INITIALIZATION_OFFSET)]
unsafe extern "C" fn sheik_start_initialization(vtable: u64, fighter: &mut Fighter) {
...
unsafe extern "C" fn sheik_opff(vtable: u64, fighter: &mut Fighter) -> u64 {
    ...
    if WorkModule::is_flag(boma, FIGHTER_SHEIK_INSTANCE_WORK_ID_FLAG_SPECIAL_LW_HAS_VANISHED) {
        ...
        && status_kind != FIGHTER_SHEIK_STATUS_KIND_SPECIAL_LW_VANISH_CANCEL {
