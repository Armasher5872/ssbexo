...
const CHROM_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x10bb480;
const CHROM_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const CHROM_VTABLE_ONCE_PER_FIGHTER_FRAME: usize = 0x10bbaa0;
