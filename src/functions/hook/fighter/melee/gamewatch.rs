...
const GAMEWATCH_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xa80d30;
const GAMEWATCH_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0xa80fd0;
const GAMEWATCH_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xa815d0;
