...
const KOOPA_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x68d5a0;
const KOOPA_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0xbc1dd0;
const KOOPA_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xbc2290;
