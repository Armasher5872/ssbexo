...
const LUCINA_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xcd98a0;
const LUCINA_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0xc732a0;
const LUCINA_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0x68d670;
