...
const FALCO_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xa44a90;
const FALCO_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0xa44b90;
const FALCO_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xa45450;
