...
const DOLLY_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x9708f0;
const DOLLY_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x970900;
const DOLLY_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0x971c80;
