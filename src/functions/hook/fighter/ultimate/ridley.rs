...
const RIDLEY_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x68d5a0;
const RIDLEY_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x1043a20;
const RIDLEY_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0x1044440;
