...
const DEDEDE_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x903c80;
const DEDEDE_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x904520;
const DEDEDE_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0x904e70;
