...
const PLIZARDON_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xf93940;
const PLIZARDON_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const PLIZARDON_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xf947e0;
