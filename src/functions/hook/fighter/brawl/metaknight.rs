...
const METAKNIGHT_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x68d5a0;
const METAKNIGHT_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const METAKNIGHT_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xd12be0;
