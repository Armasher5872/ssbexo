...
const DIDDY_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x68d5a0;
const DIDDY_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const DIDDY_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0x956600;
