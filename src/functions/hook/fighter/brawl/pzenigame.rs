...
const PZENIGAME_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xfeef30;
const PZENIGAME_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const PZENIGAME_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xf95c90;
