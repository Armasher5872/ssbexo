...
const SONIC_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x11d56f0;
const SONIC_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const SONIC_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0x11d7b20;
