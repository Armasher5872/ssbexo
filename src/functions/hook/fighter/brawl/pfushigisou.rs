...
const PFUSHIGISOU_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xea03d0;
const PFUSHIGISOU_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const PFUSHIGISOU_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xf95c90;
