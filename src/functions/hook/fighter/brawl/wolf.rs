...
const WOLF_VTABLE_START_INITIALIZATION_OFFSET: usize = 0xa61650;
const WOLF_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0xa617c0;
const WOLF_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xa62480;
