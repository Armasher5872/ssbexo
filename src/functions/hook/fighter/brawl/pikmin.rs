...
const PIKMIN_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0xf53ed0; //Olimar only
...
//Olimar Once Per Fighter Frame
#[skyline::hook(offset = PIKMIN_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET)]
unsafe extern "C" fn pikmin_opff(vtable: u64, fighter: &mut Fighter) -> u64 {
    let boma = fighter.battle_object.module_accessor;
    let agent = get_fighter_common_from_accessor(&mut *boma);
