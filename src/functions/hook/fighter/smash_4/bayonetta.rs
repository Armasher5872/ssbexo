...
const BAYONETTA_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x819430;
const BAYONETTA_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x819440;
//const BAYONETTA_VTABLE_ONCE_PER_FIGHTER_FRAME: usize = 0x81b450;
