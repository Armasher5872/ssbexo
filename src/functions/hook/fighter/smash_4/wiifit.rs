...
const WIIFIT_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET: usize = 0x12ab1f0; //Wii Fit Trainer only
...
//Wii Fit Trainer Once Per Fighter Frame
#[skyline::hook(offset = WIIFIT_VTABLE_ONCE_PER_FIGHTER_FRAME_OFFSET)]
unsafe extern "C" fn wiifit_opff(vtable: u64, fighter: &mut Fighter) -> u64 {
    let boma = fighter.battle_object.module_accessor;
    let agent = get_fighter_common_from_accessor(&mut *boma);
