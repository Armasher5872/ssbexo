...
const WIIFIT_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x12aab40;
const WIIFIT_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;

//Wii Fit Trainer Startup Initialization
#[skyline::hook(offset = WIIFIT_VTABLE_START_INITIALIZATION_OFFSET)]
unsafe extern "C" fn wiifit_start_initialization(vtable: u64, fighter: &mut Fighter) {
