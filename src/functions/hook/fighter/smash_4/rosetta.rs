...
const ROSETTA_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x10a81a0;
const ROSETTA_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x68d5e0;
const ROSETTA_VTABLE_ONCE_PER_FIGHTER_FRAME: usize = 0x10a8f60;
