...
const SHULK_VTABLE_START_INITIALIZATION_OFFSET: usize = 0x11623f0; //Shared
const SHULK_VTABLE_RESET_INITIALIZATION_OFFSET: usize = 0x1162490; //Shared
const SHULK_VTABLE_DEATH_INITIALIZATION_OFFSET: usize = 0x1163580; //Shulk only
const SHULK_CHECK_VALID_ART_STATUSES_OFFSET: usize = 0x116a3d0; //Shared
const SHULK_CHECK_CAN_ACTIVATE_ART_WHEEL: usize = 0x116d8a0; //Shared
...
unsafe extern "C" fn shulk_start_initialization(vtable: u64, fighter: &mut Fighter) -> u64 {
    ...
    if fighter.battle_object.kind == *FIGHTER_KIND_SHULK as u32 {
