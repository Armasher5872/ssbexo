...
//Pfushigisou Sludge Functions

pub unsafe extern "C" fn is_sludge(object_boma: *mut BattleObjectModuleAccessor) -> bool {
...
pub unsafe extern "C" fn should_remove_sludge_on_hit(weapon: &mut L2CWeaponCommon) -> bool {
    if AttackModule::is_infliction_status(weapon.module_accessor, WEAPON_PFUSHIGISOU_SLUDGE_STATUS_KIND_SHOOT)
...
pub unsafe extern "C" fn sludge_hit_removal(weapon: &mut L2CWeaponCommon) {
    let pos = *PostureModule::pos(weapon.module_accessor);
