...
pub fn install() {
    Agent::new("wiifit")
    .effect_acmd("effect_attackairn", ssbexo_wiifit_nair_effect)
    .game_acmd("game_attackairf", ssbexo_wiifit_fair_acmd)
    .effect_acmd("effect_attackairf", ssbexo_wiifit_fair_effect)
    .sound_acmd("sound_attackairf", ssbexo_wiifit_fair_sound)
    .expression_acmd("expression_attackairf", ssbexo_wiifit_fair_expression)
    .effect_acmd("effect_attackairb", ssbexo_wiifit_bair_effect)
    .game_acmd("game_attackairhi", ssbexo_wiifit_uair_acmd)
    .effect_acmd("effect_attackairhi", ssbexo_wiifit_uair_effect)
    .sound_acmd("sound_attackairhi", ssbexo_wiifit_uair_sound)
    .expression_acmd("expression_attackairhi", ssbexo_wiifit_uair_expression)
    .game_acmd("game_landingairhi", ssbexo_wiifit_uair_landing_acmd)
    .game_acmd("game_attackairlw", ssbexo_wiifit_dair_acmd)
    .effect_acmd("effect_attackairlw", ssbexo_wiifit_dair_effect)
    .install()
    ;
}