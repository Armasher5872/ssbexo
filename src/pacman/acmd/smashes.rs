...
//Forward Smash ACMD
unsafe extern "C" fn ssbexo_pacman_forward_smash_acmd(agent: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("pacman")
    .game_acmd("game_attacks4", ssbexo_pacman_forward_smash_acmd, Priority::Low)
