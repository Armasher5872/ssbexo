...
unsafe extern "C" fn pacman_special_n_pre_status(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    Agent::new("pacman")
    .status(Pre, *FIGHTER_STATUS_KIND_SPECIAL_N, pacman_special_n_pre_status)
    .install()
    ;
}