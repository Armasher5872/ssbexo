...
pub fn install() {
    Agent::new("popo")
    .game_acmd("game_attackhi3_nana", ssbexo_popo_partner_up_tilt_acmd, Priority::Low)
    .install()
    ;
}