...
unsafe fn status_attackhi4start_pre(fighter: &mut L2CFighterCommon, param_1: L2CValue) -> L2CValue {
    ...
    FighterStatusModuleImpl::set_fighter_status_data(fighter.module_accessor, false, *FIGHTER_TREADED_KIND_NO_REAC, false, false, false, *FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP as u64, 0, param_1.get_i32() as u32, 0);
    0.into()
}
