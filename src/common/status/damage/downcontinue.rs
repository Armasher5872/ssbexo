...
#[skyline::hook(replace = smash::lua2cpp::L2CFighterCommon_status_pre_DownContinue)]
unsafe fn status_pre_down_continue(fighter: &mut L2CFighterCommon) -> L2CValue {
