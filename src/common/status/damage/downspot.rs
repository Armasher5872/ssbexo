...
#[skyline::hook(replace = smash::lua2cpp::L2CFighterCommon_status_pre_DownSpot)]
unsafe fn status_pre_down_spot(fighter: &mut L2CFighterCommon) -> L2CValue {
