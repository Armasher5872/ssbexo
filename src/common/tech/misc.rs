...
pub fn install() {
    Agent::new("mario").on_line(Main, all_frame).install();
	Agent::new("donkey").on_line(Main, all_frame).install();
	Agent::new("link").on_line(Main, all_frame).install();
	Agent::new("samus").on_line(Main, all_frame).install();
	Agent::new("samusd").on_line(Main, all_frame).install();
	Agent::new("yoshi").on_line(Main, all_frame).install();
	Agent::new("kirby").on_line(Main, all_frame).install();
	Agent::new("fox").on_line(Main, all_frame).install();
	Agent::new("pikachu").on_line(Main, all_frame).install();
	Agent::new("luigi").on_line(Main, all_frame).install();
	Agent::new("ness").on_line(Main, all_frame).install();
	Agent::new("captain").on_line(Main, all_frame).install();
	Agent::new("purin").on_line(Main, all_frame).install();
	Agent::new("peach").on_line(Main, all_frame).install();
	Agent::new("daisy").on_line(Main, all_frame).install();
	Agent::new("koopa").on_line(Main, all_frame).install();
	Agent::new("popo").on_line(Main, all_frame).install();
	Agent::new("nana").on_line(Main, all_frame).install();
	Agent::new("sheik").on_line(Main, all_frame).install();
	Agent::new("zelda").on_line(Main, all_frame).install();
	Agent::new("mariod").on_line(Main, all_frame).install();
	Agent::new("pichu").on_line(Main, all_frame).install();
	Agent::new("falco").on_line(Main, all_frame).install();
	Agent::new("marth").on_line(Main, all_frame).install();
	Agent::new("lucina").on_line(Main, all_frame).install();
	Agent::new("younglink").on_line(Main, all_frame).install();
	Agent::new("ganon").on_line(Main, all_frame).install();
	Agent::new("mewtwo").on_line(Main, all_frame).install();
	Agent::new("roy").on_line(Main, all_frame).install();
	Agent::new("chrom").on_line(Main, all_frame).install();
	Agent::new("gamewatch").on_line(Main, all_frame).install();
	Agent::new("metaknight").on_line(Main, all_frame).install();
	Agent::new("pit").on_line(Main, all_frame).install();
	Agent::new("pitb").on_line(Main, all_frame).install();
	Agent::new("szerosuit").on_line(Main, all_frame).install();
	Agent::new("wario").on_line(Main, all_frame).install();
	Agent::new("snake").on_line(Main, all_frame).install();
	Agent::new("ike").on_line(Main, all_frame).install();
	Agent::new("pzenigame").on_line(Main, all_frame).install();
	Agent::new("pfushigisou").on_line(Main, all_frame).install();
	Agent::new("plizardon").on_line(Main, all_frame).install();
	Agent::new("diddy").on_line(Main, all_frame).install();
	Agent::new("lucas").on_line(Main, all_frame).install();
	Agent::new("sonic").on_line(Main, all_frame).install();
	Agent::new("dedede").on_line(Main, all_frame).install();
	Agent::new("pikmin").on_line(Main, all_frame).install();
	Agent::new("lucario").on_line(Main, all_frame).install();
	Agent::new("robot").on_line(Main, all_frame).install();
	Agent::new("toonlink").on_line(Main, all_frame).install();
	Agent::new("wolf").on_line(Main, all_frame).install();
	Agent::new("murabito").on_line(Main, all_frame).install();
	Agent::new("rockman").on_line(Main, all_frame).install();
	Agent::new("wiifit").on_line(Main, all_frame).install();
	Agent::new("rosetta").on_line(Main, all_frame).install();
	Agent::new("littlemac").on_line(Main, all_frame).install();
	Agent::new("gekkouga").on_line(Main, all_frame).install();
	Agent::new("miifighter").on_line(Main, all_frame).install();
	Agent::new("miiswordsman").on_line(Main, all_frame).install();
	Agent::new("miigunner").on_line(Main, all_frame).install();
	Agent::new("palutena").on_line(Main, all_frame).install();
	Agent::new("pacman").on_line(Main, all_frame).install();
	Agent::new("reflet").on_line(Main, all_frame).install();
	Agent::new("shulk").on_line(Main, all_frame).install();
	Agent::new("koopajr").on_line(Main, all_frame).install();
	Agent::new("duckhunt").on_line(Main, all_frame).install();
	Agent::new("ryu").on_line(Main, all_frame).install();
	Agent::new("ken").on_line(Main, all_frame).install();
	Agent::new("cloud").on_line(Main, all_frame).install();
	Agent::new("kamui").on_line(Main, all_frame).install();
	Agent::new("bayonetta").on_line(Main, all_frame).install();
	Agent::new("inkling").on_line(Main, all_frame).install();
	Agent::new("ridley").on_line(Main, all_frame).install();
	Agent::new("simon").on_line(Main, all_frame).install();
	Agent::new("richter").on_line(Main, all_frame).install();
	Agent::new("krool").on_line(Main, all_frame).install();
	Agent::new("shizue").on_line(Main, all_frame).install();
	Agent::new("gaogaen").on_line(Main, all_frame).install();
	Agent::new("packun").on_line(Main, all_frame).install();
	Agent::new("jack").on_line(Main, all_frame).install();
	Agent::new("brave").on_line(Main, all_frame).install();
	Agent::new("buddy").on_line(Main, all_frame).install();
	Agent::new("dolly").on_line(Main, all_frame).install();
	Agent::new("master").on_line(Main, all_frame).install();
	Agent::new("tantan").on_line(Main, all_frame).install();
	Agent::new("pickel").on_line(Main, all_frame).install();
	Agent::new("edge").on_line(Main, all_frame).install();
	Agent::new("elight").on_line(Main, all_frame).install();
	Agent::new("eflame").on_line(Main, all_frame).install();
	Agent::new("demon").on_line(Main, all_frame).install();
	Agent::new("trail").on_line(Main, all_frame).install();
	Agent::new("koopag").on_line(Main, all_frame).install();
}