...
unsafe extern "C" fn ssbexo_ness_shield_special_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_bullet"), Hash40::new("handr"), 0, 0, 0, 0, 0, 0, 0.3, true);
        EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_bullet"), Hash40::new("handl"), 0, 0, 0, 0, 0, 0, 0.3, true);
    }
    frame(agent.lua_state_agent, 16.0);
    for _ in 0..13 {
        if is_excute(agent) {
            EFFECT_OFF_KIND(agent, Hash40::new("ness_pkfl_bullet"), true, true);
            EFFECT_OFF_KIND(agent, Hash40::new("ness_pkfl_hold"), true, true);
            EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_bullet"), Hash40::new("handr"), 0, 0, 0, 0, 0, 0, 0.6, true);
            EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_bullet"), Hash40::new("handl"), 0, 0, 0, 0, 0, 0, 0.6, true);
            EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_hold"), Hash40::new("top"), 0, 9, 0, 0, 0, 0, 1, true);
    ...
    if is_excute(agent) {
        EFFECT_OFF_KIND(agent, Hash40::new("ness_pkfl_bullet"), true, true);
        EFFECT_OFF_KIND(agent, Hash40::new("ness_pkfl_hold"), true, true);
        EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_bullet"), Hash40::new("handr"), 0, 0, 0, 0, 0, 0, 0.8, true);
        EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_bullet"), Hash40::new("handl"), 0, 0, 0, 0, 0, 0, 0.8, true);
        EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_hold"), Hash40::new("top"), 0, 9, 0, 0, 0, 0, 0.9, true);
    ...
    if is_excute(agent) {
        ...
        EFFECT_OFF_KIND(agent, Hash40::new("ness_pkfl_bullet"), false, false);
    }
}
...
unsafe extern "C" fn ssbexo_ness_shield_special_sound(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        PLAY_SE(agent, Hash40::new("se_ness_special_n05"));
    }
    frame(agent.lua_state_agent, 16.0);
    if is_excute(agent) {
        PLAY_STATUS(agent, Hash40::new("se_ness_special_n02"));
    }
    ...
    if is_excute(agent) {
        PLAY_SE(agent, Hash40::new("vc_ness_attack05"));
        PLAY_SE(agent, Hash40::new("se_ness_special_n04_ll"));
    }
}
...
unsafe extern "C" fn ssbexo_ness_shield_special_burst_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("top"), 12.0, 361, 80, 0, 40, 12.0, 0.0, 6.0, 0.0, None, None, None, 1.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_magic"), *ATTACK_SOUND_LEVEL_LL, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_PSI);
    }
    frame(agent.lua_state_agent, 9.0);
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_ness_shield_special_burst_effect(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 5.0);
    if is_excute(agent) {
        EFFECT_FLW_POS(agent, Hash40::new("ness_pkfl_bomb_max"), Hash40::new("waist"), 0, 0, 0, 0, 0, 0, 1.5, true);
        EFFECT_FOLLOW(agent, Hash40::new("ness_pkfl_bullet_ed"), Hash40::new("waist"), 0, 0, 0, 0, 0, 0, 1.5, true);
    }
    ...
    if float_count > 90.0 {
        if WorkModule::is_flag(agent.module_accessor, *FIGHTER_NESS_INSTANCE_WORK_ID_FLAG_OFFENSE_UP) {
            if offense_up_hashes == Hash40::new("collision_attr_normal_poison") {
                if is_excute(agent) {
                    ATTACK(agent, 0, 0, Hash40::new("top"), 1.0, 70, 65, 0, 50, 10.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, true, true, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, offense_up_hashes, *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_PSI);
...
unsafe extern "C" fn ssbexo_ness_pkfire_grounded_pillar_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("top"), 1.0, 68, 30, 0, 10, 6.5, 0.0, 3.1, 2.0, None, None, None, 1.0, 1.5, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, true, true, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_FLOOR, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_PSI);
        ATTACK(agent, 1, 0, Hash40::new("top"), 1.0, 68, 30, 0, 10, 4.5, 0.0, 9.6, 2.0, None, None, None, 1.0, 1.5, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, true, true, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_FLOOR, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_PSI);
...
unsafe extern "C" fn ssbexo_ness_pkfire_aerial_pillar_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("top"), 1.0, 58, 45, 0, 16, 6.5, 0.0, 3.1, 2.0, None, None, None, 1.0, 1.5, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, true, true, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_FLOOR, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_PSI);
        ATTACK(agent, 1, 0, Hash40::new("top"), 1.0, 58, 45, 0, 16, 4.5, 0.0, 9.6, 2.0, None, None, None, 1.0, 1.5, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, true, true, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_NO_FLOOR, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_fire"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_PSI);
        AREA_WIND_2ND_RAD_arg9(agent, 0, 1, 0.05, 200, 0.6, 0, 10, 20, 60);
    }
}
...
pub fn install() {
    ...
    .effect_acmd("effect_specialguard", ssbexo_ness_shield_special_effect, Low)
    .sound_acmd("sound_specialguard", ssbexo_ness_shield_special_sound, Low)
    .expression_acmd("expression_specialguard", ssbexo_ness_shield_special_expression, Low)
    .game_acmd("game_specialguardburst", ssbexo_ness_shield_special_burst_acmd, Low)
    .effect_acmd("effect_specialguardburst", ssbexo_ness_shield_special_burst_effect, Low)
    .sound_acmd("sound_specialguardburst", ssbexo_ness_shield_special_burst_sound, Low)
    .expression_acmd("expression_specialguardburst", ssbexo_ness_shield_special_burst_expression, Low)
    .install()
    ;
    Agent::new("ness_pkflash")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_bang", ssbexo_ness_pkflash_bang_acmd, Low)
    .install()
    ;
    Agent::new("ness_pkfire")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_pillar", ssbexo_ness_pkfire_grounded_pillar_acmd, Low)
    .game_acmd("game_pillarair", ssbexo_ness_pkfire_aerial_pillar_acmd, Low)
    .install()
    ;
}