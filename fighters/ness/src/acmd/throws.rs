...
unsafe extern "C" fn ssbexo_ness_grab_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        CATCH(agent, 0, Hash40::new("top"), 4.0, 0.0, 5.2, 4.0, Some(0.0), Some(5.2), Some(12.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
...
unsafe extern "C" fn ssbexo_ness_grab_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("ness_psimagnet_hit"), Hash40::new("trans"), 0, 5.2, 8.0, 0, 0, 0, 0.85, false);
    }
}
...
unsafe extern "C" fn ssbexo_ness_dash_grab_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        FT_MOTION_RATE(agent, 1.0);
        CATCH(agent, 0, Hash40::new("top"), 3.2, 0.0, 5.2, 4.0, Some(0.0), Some(5.2), Some(15.6), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
    game_CaptureCutCommon(agent);
    wait(agent.lua_state_agent, 2.0);
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_ness_dash_grab_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("ness_psimagnet_hit"), Hash40::new("trans"), 0, 5.2, 9.0, 0, 0, 0, 0.85, false);
    }
}
...
unsafe extern "C" fn ssbexo_ness_pivot_grab_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        FT_MOTION_RATE(agent, 1.0);
        CATCH(agent, 0, Hash40::new("top"), 4.0, 0.0, 5.2, -4.0, Some(0.0), Some(5.2), Some(-20.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
    game_CaptureCutCommon(agent);
    wait(agent.lua_state_agent, 2.0);
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_ness_pivot_grab_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("ness_psimagnet_hit"), Hash40::new("trans"), 0, 5.2, -12.0, 0, 0, 0, 0.85, false);
    }
}
...
unsafe extern "C" fn ssbexo_ness_up_throw_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 12.0, 90, 40, 0, 30, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
...
unsafe extern "C" fn ssbexo_ness_down_throw_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 4.0, 270, 80, 0, 70, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, 0, 3.0, 361, 100, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
    }
    frame(agent.lua_state_agent, 6.0);
    for _ in 0..3 {
...
pub fn install() {
    ...
    .game_acmd("game_catch", ssbexo_ness_grab_acmd, Low)
    .effect_acmd("effect_catch", ssbexo_ness_grab_effect, Low)
    .game_acmd("game_catchdash", ssbexo_ness_dash_grab_acmd, Low)
    .effect_acmd("effect_catchdash", ssbexo_ness_dash_grab_effect, Low)
    .game_acmd("game_catchturn", ssbexo_ness_pivot_grab_acmd, Low)
    .effect_acmd("effect_catchturn", ssbexo_ness_pivot_grab_effect, Low)
    .game_acmd("game_catchturn", ssbexo_ness_pivot_grab_acmd, Low)
    .game_acmd("game_throwhi", ssbexo_ness_up_throw_acmd, Low)
    .game_acmd("game_throwlw", ssbexo_ness_down_throw_acmd, Low)
    .install()
    ;
}