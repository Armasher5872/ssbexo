...
pub fn install() {
    ...
    .game_acmd("game_appeallwl", ssbexo_younglink_down_taunt_acmd, Low)
    .game_acmd("game_appeallwr", ssbexo_younglink_down_taunt_acmd, Low)
    .expression_acmd("expression_appeallwl", ssbexo_younglink_down_taunt_expression, Low)
    .expression_acmd("expression_appeallwr", ssbexo_younglink_down_taunt_expression, Low)
    .install()
    ;
}