...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_younglink_forward_tilt_acmd, Low)
    .acmd("effect_attacks3", ssbexo_younglink_forward_tilt_effect, Low)
    .acmd("sound_attacks3", ssbexo_younglink_forward_tilt_sound, Low)
    .acmd("expression_attacks3", ssbexo_younglink_forward_tilt_expression, Low)
    .acmd("game_attacklw3", ssbexo_younglink_down_tilt_acmd, Low)
    .acmd("effect_attacklw3", ssbexo_younglink_down_tilt_effect, Low)
    .acmd("sound_attacklw3", ssbexo_younglink_down_tilt_sound, Low)
    .acmd("expression_attacklw3", ssbexo_younglink_down_tilt_expression, Low)
    .install()
    ;
}