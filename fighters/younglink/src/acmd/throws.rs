...
pub fn install() {
    ...
    .game_acmd("game_catch", ssbexo_younglink_grab_acmd, Low)
    .game_acmd("game_catchdash", ssbexo_younglink_dash_grab_acmd, Low)
    .game_acmd("game_catchturn", ssbexo_younglink_pivot_grab_acmd, Low)
    .install()
    ;
}