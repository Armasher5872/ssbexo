...
unsafe extern "C" fn ssbexo_purin_up_smash_expression(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 11.0);
    sv_animcmd::execute(lua_state, 11.0);
    if WorkModule::is_flag(boma, *FIGHTER_STATUS_ATTACK_FLAG_SMASH_SMASH_HOLD_TO_ATTACK) {
        if is_excute(agent) {
            slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE, *SLOPE_STATUS_LR);
        }
...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_purin_forward_smash_acmd, Low)
    .acmd("effect_attacks4", ssbexo_purin_forward_smash_effect, Low)
    .acmd("sound_attacks4", ssbexo_purin_forward_smash_sound, Low)
    .acmd("expression_attacks4", ssbexo_purin_forward_smash_expression, Low)
    .acmd("game_attackhi4", ssbexo_purin_up_smash_acmd, Low)
    .acmd("effect_attackhi4", ssbexo_purin_up_smash_effect, Low)
    .acmd("sound_attackhi4", ssbexo_purin_up_smash_sound, Low)
    .acmd("expression_attackhi4", ssbexo_purin_up_smash_expression, Low)
    .acmd("game_attacklw4", ssbexo_purin_down_smash_acmd, Low)
    .acmd("effect_attacklw4", ssbexo_purin_down_smash_effect, Low)
    .acmd("sound_attacklw4", ssbexo_purin_down_smash_sound, Low)
    .acmd("expression_attacklw4", ssbexo_purin_down_smash_expression, Low)
    .install()
    ;
}