...
pub fn install() {
    ...
    .game_acmd("game_catch", ssbexo_purin_grab_acmd, Low)
    .game_acmd("game_catchdash", ssbexo_purin_dash_grab_acmd, Low)
    .game_acmd("game_catchturn", ssbexo_purin_pivot_grab_acmd, Low)
    .game_acmd("game_throwlw", ssbexo_purin_down_throw_acmd, Low)
    .install()
    ;
}