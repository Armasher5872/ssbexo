...
unsafe extern "C" fn ssbexo_purin_uair_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("bust"), 1.5, 367, 110, 40, 0, 8.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_magic"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_BODY);
    }
    frame(agent.lua_state_agent, 10.0);
    if is_excute(agent) {
        AttackModule::clear_all(agent.module_accessor);
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("bust"), 5.0, 85, 110, 0, 70, 10.0, 0.0, 5.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_magic"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_BODY);
    }
...
unsafe extern "C" fn ssbexo_purin_uair_effect(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 23.0);
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("poke_meloetta_bullet"), Hash40::new("top"), 0.0, 12.0, 1.0, 0, 0, 0, 1.6, true);
    }
    frame(agent.lua_state_agent, 26.0);
    if is_excute(agent) {
...
pub fn install() {
    ...
    .game_acmd("game_attackairhi", ssbexo_purin_uair_acmd, Low)
    .effect_acmd("effect_attackairhi", ssbexo_purin_uair_effect, Low)
    .sound_acmd("sound_attackairhi", ssbexo_purin_uair_sound, Low)
    .expression_acmd("expression_attackairhi", ssbexo_purin_uair_expression, Low)
    .install()
    ;
}