...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_purin_nair_acmd, Low)
    .acmd("effect_attackairn", ssbexo_purin_nair_effect, Low)
    .acmd("sound_attackairn", ssbexo_purin_nair_sound, Low)
    .acmd("expression_attackairn", ssbexo_purin_nair_expression, Low)
    .acmd("game_attackairb", ssbexo_purin_bair_acmd, Low)
    .install()
    ;
}