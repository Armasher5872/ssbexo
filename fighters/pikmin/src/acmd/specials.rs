...
pub fn install() {
    ...
    .game_acmd("game_specialnstart", ssbexo_pikmin_neutral_special_acmd, Low)
    .effect_acmd("effect_specialnstart", ssbexo_pikmin_neutral_special_effect, Low)
    .sound_acmd("sound_specialnstart", ssbexo_pikmin_neutral_special_sound, Low)
    .expression_acmd("expression_specialnstart", ssbexo_pikmin_neutral_special_expression, Low)
    .sound_acmd("sound_specialnfailure", ssbexo_pikmin_neutral_special_failure_sound, Low)
    .expression_acmd("expression_specialnfailure", ssbexo_pikmin_neutral_special_failure_expression, Low)
    .install()
    ;
}