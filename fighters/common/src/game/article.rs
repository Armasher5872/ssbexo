...
pub fn install() {
    ...
    set_kirby_inhale_behavior(*FIGHTER_DONKEY_GENERATE_ARTICLE_BARREL_CANNON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_DELETE);
    set_villager_pocket_behavior(*FIGHTER_DONKEY_GENERATE_ARTICLE_BARREL_CANNON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_MISFIRE);
    set_rosetta_pull_behavior(*FIGHTER_DONKEY_GENERATE_ARTICLE_BARREL_CANNON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_DELETE);
    ...
    set_kirby_inhale_behavior(*FIGHTER_LUCARIO_GENERATE_ARTICLE_BONE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_DELETE);
    set_villager_pocket_behavior(*FIGHTER_LUCARIO_GENERATE_ARTICLE_BONE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_MISFIRE);
    set_rosetta_pull_behavior(*FIGHTER_LUCARIO_GENERATE_ARTICLE_BONE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_DELETE);
