...
pub fn install() {
    unsafe {
        ...
        set_kirby_inhale_behavior(FIGHTER_DONKEY_GENERATE_ARTICLE_BARREL_CANNON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_DONKEY_GENERATE_ARTICLE_BARREL_CANNON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_DONKEY_GENERATE_ARTICLE_BARREL_CANNON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_DELETE);
        set_kirby_inhale_behavior(FIGHTER_PIKACHU_GENERATE_ARTICLE_TAIL, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_PIKACHU_GENERATE_ARTICLE_TAIL, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_PIKACHU_GENERATE_ARTICLE_TAIL, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_DELETE);
        ...
        set_kirby_inhale_behavior(FIGHTER_METAKNIGHT_GENERATE_ARTICLE_BEAM, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_METAKNIGHT_GENERATE_ARTICLE_BEAM, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_METAKNIGHT_GENERATE_ARTICLE_BEAM, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_KOOPAJR_CANNONBALL, POCKET_BEHAVIOR_DELETE);
        set_kirby_inhale_behavior(FIGHTER_WARIO_GENERATE_ARTICLE_KAMIKAZE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_WARIO_GENERATE_ARTICLE_KAMIKAZE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_WARIO_GENERATE_ARTICLE_KAMIKAZE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_DELETE);
        set_kirby_inhale_behavior(FIGHTER_WARIO_GENERATE_ARTICLE_CHAIR, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_WARIO_GENERATE_ARTICLE_CHAIR, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_WARIO_GENERATE_ARTICLE_CHAIR, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_DELETE);
        ...
        set_kirby_inhale_behavior(FIGHTER_LUCARIO_GENERATE_ARTICLE_BONE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_LUCARIO_GENERATE_ARTICLE_BONE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_LUCARIO_GENERATE_ARTICLE_BONE, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_GANON_SWORD, POCKET_BEHAVIOR_DELETE);
        ...
        set_kirby_inhale_behavior(FIGHTER_EDGE_GENERATE_ARTICLE_ZANSHIN_SHOT, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LINK_SWORD_BEAM, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_EDGE_GENERATE_ARTICLE_ZANSHIN_SHOT, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LINK_SWORD_BEAM, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_EDGE_GENERATE_ARTICLE_ZANSHIN_SHOT, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), *WEAPON_KIND_LINK_SWORD_BEAM, POCKET_BEHAVIOR_DELETE);
