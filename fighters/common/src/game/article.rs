...
pub fn install() {
    unsafe {
        ...
        set_kirby_inhale_behavior(FIGHTER_ARMSTRONG_GENERATE_ARTICLE_FIREPILLAR, vec![8, 9, 10, 11, 12, 13, 14, 15].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_DELETE);
        set_villager_pocket_behavior(FIGHTER_ARMSTRONG_GENERATE_ARTICLE_FIREPILLAR, vec![8, 9, 10, 11, 12, 13, 14, 15].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_MISFIRE);
        set_rosetta_pull_behavior(FIGHTER_ARMSTRONG_GENERATE_ARTICLE_FIREPILLAR, vec![8, 9, 10, 11, 12, 13, 14, 15].clone(), *WEAPON_KIND_LUIGI_FIREBALL, POCKET_BEHAVIOR_DELETE);
    }
