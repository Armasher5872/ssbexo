...
pub fn install() {
    let _ = skyline::patching::Patch::in_text(0x6bd448).nop(); //Changes the hitstop buffer handling of cmd_cat 1/2/3 to that of cmd_cat4
    let _ = skyline::patching::Patch::in_text(0x6bd4a0).data(0xF10002DFu32); //Changes the hitstop buffer handling of cmd_cat 1/2/3 to that of cmd_cat4
