...
unsafe extern "C" fn attack_mtrans_post_process(fighter: &mut L2CFighterCommon) {
    ...
    let attack_11_motion = WorkModule::get_int64(boma, *FIGHTER_STATUS_ATTACK_WORK_INT_ATTACK11_MOTION);
    ...
    if count != 1 {
        ...
        MotionModule::change_motion(boma, Hash40::new_raw(attack_11_motion as u64), 0.0, 1.0, false, 0.0, false, false);
