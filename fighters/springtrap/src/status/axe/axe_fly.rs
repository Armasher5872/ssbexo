...
unsafe extern "C" fn springtrap_axe_fly_init_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    ...
    let speed_x_min = WorkModule::get_param_float(boma, hash40("param_ironballcloned"), hash40("speed_x_min"));
    let speed_x_max = WorkModule::get_param_float(boma, hash40("param_ironballcloned"), hash40("speed_x_max"));
    let speed_y_min = WorkModule::get_param_float(boma, hash40("param_ironballcloned"), hash40("speed_y_min"));
    let speed_y_max = WorkModule::get_param_float(boma, hash40("param_ironballcloned"), hash40("speed_y_max"));
