...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_simon_nair_acmd, Low)
    .acmd("game_attackairf", ssbexo_simon_fair_acmd, Low)
    .acmd("game_attackairfhi", ssbexo_simon_fair_hi_acmd, Low)
    .acmd("game_attackairflw", ssbexo_simon_fair_lw_acmd, Low)
    .acmd("game_attackairb", ssbexo_simon_bair_acmd, Low)
    .acmd("game_attackairbhi", ssbexo_simon_bair_hi_acmd, Low)
    .acmd("game_attackairblw", ssbexo_simon_bair_lw_acmd, Low)
    .acmd("game_attackairhi", ssbexo_simon_uair_acmd, Low)
    .acmd("game_attackairlw", ssbexo_simon_dair_acmd, Low)
    .acmd("effect_attackairlw", ssbexo_simon_dair_effect, Low)
    .acmd("sound_attackairlw", ssbexo_simon_dair_sound, Low)
    .acmd("expression_attackairlw", ssbexo_simon_dair_expression, Low)
    .acmd("effect_landingairlw", ssbexo_simon_dair_landing_effect, Low)
    .acmd("sound_landingairlw", ssbexo_simon_dair_landing_sound, Low)
    .acmd("expression_landingairlw", ssbexo_simon_dair_landing_expression, Low)
    .install()
    ;
    Agent::new("simon_whip")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_attackairlw", ssbexo_simon_whip_dair_acmd, Low)
    .acmd("effect_attackairlw", ssbexo_simon_whip_dair_effect, Low)
    .acmd("game_landingairlw", ssbexo_simon_whip_dair_landing_acmd, Low)
    .install()
    ;
}