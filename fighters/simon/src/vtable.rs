...
#[skyline::hook(offset = get_agent_virtual_function(*FIGHTER_KIND_SIMON, 4, false, false))]
...
#[skyline::hook(offset = get_agent_virtual_function(*FIGHTER_KIND_SIMON, 7, false, false))]
