...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_plizardon_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_plizardon_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_plizardon_pivot_grab_acmd, Low)
    .install()
    ;
}