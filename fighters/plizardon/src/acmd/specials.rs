...
pub fn install() {
    ...
    .game_acmd("game_move", ssbexo_plizardon_flamethrower_move_acmd, Low)
    .install()
    ;
    Agent::new("plizardon_explosion")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_start", ssbexo_plizardon_explosion_start_acmd, Low)
    .install()
    ;
}