...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_dedede_forward_smash_acmd, Low)
    .acmd("game_attackhi4", ssbexo_dedede_up_smash_acmd, Low)
    .acmd("game_attacklw4", ssbexo_dedede_down_smash_acmd, Low)
    .install()
    ;
}