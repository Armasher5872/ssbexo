...
pub fn install() {
    ...
    .acmd("game_attack11", ssbexo_jack_jab_1_acmd, Low)
    .acmd("game_attack12", ssbexo_jack_jab_2_acmd, Low)
    .acmd("game_attack13", ssbexo_jack_jab_3_acmd, Low)
    .acmd("game_attackdash", ssbexo_jack_dash_attack_acmd, Low)
    .install()
    ;
}