...
unsafe extern "C" fn sonic_attack_s3_end_status(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    ...
    .status(End, *FIGHTER_STATUS_KIND_ATTACK_S3, sonic_attack_s3_end_status)
    .install()
    ;
}