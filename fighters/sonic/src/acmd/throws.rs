...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_sonic_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_sonic_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_sonic_pivot_grab_acmd, Low)
    .acmd("game_throwb", ssbexo_sonic_back_throw_acmd, Low)
    .acmd("effect_throwb", ssbexo_sonic_back_throw_effect, Low)
    .acmd("sound_throwb", ssbexo_sonic_back_throw_sound, Low)
    .acmd("expression_throwb", ssbexo_sonic_back_throw_expression, Low)
    .install()
    ;
}