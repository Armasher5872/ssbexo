...
unsafe extern "C" fn ssbexo_sonic_side_special_rush_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        AttackModule::set_add_reaction_frame_revised(boma, 7, 12.0, false);
        AttackModule::set_add_reaction_frame_revised(boma, 6, 12.0, false);
    }
    frame(lua_state, 9.0);
    if is_excute(agent) {
...
pub fn install() {
    ...
    .acmd("game_specialsrush", ssbexo_sonic_side_special_rush_acmd, Low)
    .acmd("effect_specialsrush", ssbexo_sonic_side_special_rush_effect, Low)
    .acmd("sound_specialsrush", ssbexo_sonic_side_special_rush_sound, Low)
    .acmd("expression_specialsrush", ssbexo_sonic_side_special_rush_expression, Low)
    .install()
    ;
}