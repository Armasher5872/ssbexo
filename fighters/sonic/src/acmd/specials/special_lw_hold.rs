...
pub fn install() {
    ...
    .acmd("game_speciallwhold", ssbexo_sonic_down_special_hold_acmd, Low)
    .acmd("game_specialairlwhold", ssbexo_sonic_down_special_hold_acmd, Low)
    .acmd("game_speciallwholdchargelw", ssbexo_sonic_down_special_hold_acmd, Low)
    .acmd("game_speciallwholdchargemiddle", ssbexo_sonic_down_special_hold_acmd, Low)
    .acmd("game_speciallwholdchargehi", ssbexo_sonic_down_special_hold_acmd, Low)
    .install()
    ;
}