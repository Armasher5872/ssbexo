...
unsafe extern "C" fn ssbexo_sonic_homing_attack_search_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        SEARCH(agent, 0, 0, Hash40::new("hip"), 45.0, 0.0, 0.0, 0.0, None, None, None, *COLLISION_KIND_MASK_HIT, *HIT_STATUS_MASK_NORMAL, 1, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_FIEB, *COLLISION_PART_MASK_BODY_HEAD, false);
    }
}
...
unsafe extern "C" fn ssbexo_sonic_boost_loop_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        ATTACK(agent, 2, 0, Hash40::new("waist"), 0.0, 30, 90, 40, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 0.0, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, true, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_BODY);
        ATTACK(agent, 3, 0, Hash40::new("hip"), 0.0, 30, 90, 40, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 0.0, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, true, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_BODY);
    }
}
...
unsafe extern "C" fn ssbexo_sonic_boost_loop_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("sys_speedbooster"), Hash40::new("top"), 0, 6, 0, 0, 0, 0, 0.85, false);
...
unsafe extern "C" fn ssbexo_sonic_boost_eagle_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 2, 0, Hash40::new("footr"), 12.0, 361, 75, 0, 60, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.2, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ...
        ATTACK(agent, 0, 0, Hash40::new("legr"), 10.0, 361, 75, 0, 60, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
    frame(agent.lua_state_agent, 14.0);
    if is_excute(agent) {
        ATTACK(agent, 2, 0, Hash40::new("footr"), 12.0, 285, 89, 0, 10, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.2, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 1, 0, Hash40::new("kneer"), 11.0, 285, 89, 0, 10, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 0, 0, Hash40::new("legr"), 10.0, 285, 89, 0, 10, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe extern "C" fn ssbexo_sonic_boost_adventure_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 2, 0, Hash40::new("footr"), 10.0, 80, 90, 0, 55, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.2, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 1, 0, Hash40::new("kneer"), 10.0, 80, 90, 0, 55, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 0, 0, Hash40::new("legr"), 10.0, 80, 90, 0, 55, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe extern "C" fn ssbexo_sonic_boost_adventure_effect(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 8.0);
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("sys_attack_arc_d"), Hash40::new("top"), 0, 11, 0, 0, 50, 90, 0.8, true);
        LAST_EFFECT_SET_COLOR(agent, 1.0, 0.05, 0.07);
...
unsafe extern "C" fn ssbexo_sonic_boost_adventure_sound(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 7.0);
    if is_excute(agent) {
        PLAY_SEQUENCE(agent, Hash40::new("vc_sonic_attack06"));
    }
    frame(agent.lua_state_agent, 8.0);
    if is_excute(agent) {
        PLAY_SE(agent, Hash40::new("se_sonic_swing_l"));
...
unsafe extern "C" fn ssbexo_sonic_boost_drop_acmd(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 12.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("sphere"), 12.0, 70, 50, 0, 70, 5.0, 0.0, 0.0, 0.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_BODY);
    }
...
unsafe extern "C" fn ssbexo_sonic_boost_drop_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        EffectModule::enable_sync_init_pos_last(agent.module_accessor);
        EFFECT_FOLLOW(agent, Hash40::new("sys_machstamp"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 0.8, true);
    }
    frame(agent.lua_state_agent, 53.0);
    if is_excute(agent) {
        EFFECT_OFF_KIND(agent, Hash40::new("sonic_spintrace_max"), true, true);
        EFFECT_OFF_KIND(agent, Hash40::new("sonic_spinblur_max"), true, true);
        EFFECT_OFF_KIND(agent, Hash40::new("sys_machstamp"), true, true);
    }
}
...
unsafe extern "C" fn ssbexo_sonic_boost_drop_sound(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        PLAY_STATUS(agent, Hash40::new("se_sonic_rounddash"));
    }
}
...
unsafe extern "C" fn ssbexo_sonic_grounded_spin_dash_jump_acmd(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 3.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("hip"), 6.0, 80, 60, 0, 80, 4.0, 0.0, 1.5, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
...
pub fn install() {
    ...
    .game_acmd("game_specialnhomingstart", ssbexo_sonic_homing_attack_search_acmd, Low)
    .game_acmd("game_specialnhit", ssbexo_sonic_homing_attack_hit_acmd, Low)
    .effect_acmd("effect_specialsstart", ssbexo_sonic_grounded_boost_start_effect, Low)
    .sound_acmd("sound_specialsstart", ssbexo_sonic_grounded_boost_start_sound, Low)
    .expression_acmd("expression_specialsstart", ssbexo_sonic_grounded_boost_start_expression, Low)
    .expression_acmd("expression_specialairsstart", ssbexo_sonic_aerial_boost_start_expression, Low)
    .game_acmd("game_specialsloop", ssbexo_sonic_boost_loop_acmd, Low)
    .game_acmd("game_specialairsloop", ssbexo_sonic_boost_loop_acmd, Low)
    .effect_acmd("effect_specialsloop", ssbexo_sonic_boost_loop_effect, Low)
    .effect_acmd("effect_specialairsloop", ssbexo_sonic_boost_loop_effect, Low)
    .sound_acmd("sound_specialsloop", ssbexo_sonic_boost_loop_sound, Low)
    .sound_acmd("sound_specialairsloop", ssbexo_sonic_boost_loop_sound, Low)
    .expression_acmd("expression_specialsloop", ssbexo_sonic_boost_loop_expression, Low)
    .expression_acmd("expression_specialairsloop", ssbexo_sonic_boost_loop_expression, Low)
    .game_acmd("game_specialseagle", ssbexo_sonic_boost_eagle_acmd, Low)
    .effect_acmd("effect_specialseagle", ssbexo_sonic_boost_eagle_effect, Low)
    .sound_acmd("sound_specialseagle", ssbexo_sonic_boost_eagle_sound, Low)
    .expression_acmd("expression_specialseagle", ssbexo_sonic_boost_eagle_expression, Low)
    .game_acmd("game_specialsadventure", ssbexo_sonic_boost_adventure_acmd, Low)
    .effect_acmd("effect_specialsadventure", ssbexo_sonic_boost_adventure_effect, Low)
    .sound_acmd("sound_specialsadventure", ssbexo_sonic_boost_adventure_sound, Low)
    .expression_acmd("expression_specialsadventure", ssbexo_sonic_boost_adventure_expression, Low)
    .game_acmd("game_specialsdrop", ssbexo_sonic_boost_drop_acmd, Low)
    .effect_acmd("effect_specialsdrop", ssbexo_sonic_boost_drop_effect, Low)
    .sound_acmd("sound_specialsdrop", ssbexo_sonic_boost_drop_sound, Low)
    .expression_acmd("expression_specialsdrop", ssbexo_sonic_boost_drop_expression, Low)
    .expression_acmd("expression_specialsbounce", ssbexo_sonic_boost_bounce_expression, Low)
    .game_acmd("0x195dc47911", ssbexo_sonic_grounded_spin_dash_jump_acmd, Low)
    .install()
    ;
}