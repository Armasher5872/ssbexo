...
pub fn install() {
    ...
    .acmd("game_attack11", ssbexo_diddy_jab_1_acmd, Low)
    .acmd("game_attack12", ssbexo_diddy_jab_2_acmd, Low)
    .acmd("game_attack13", ssbexo_diddy_jab_3_acmd, Low)
    .acmd("game_attackdash", ssbexo_diddy_dash_attack_acmd, Low)
    .acmd("sound_attackdash", ssbexo_diddy_dash_attack_sound, Low)
    .acmd("expression_attackdash", ssbexo_diddy_dash_attack_expression, Low)
    .acmd("game_attackairdash", ssbexo_diddy_aerial_dash_attack_acmd, Low)
    .acmd("effect_attackairdash", ssbexo_diddy_aerial_dash_attack_effect, Low)
    .acmd("sound_attackairdash", ssbexo_diddy_aerial_dash_attack_sound, Low)
    .acmd("expression_attackairdash", ssbexo_diddy_aerial_dash_attack_expression, Low)
    .install()
    ;
}