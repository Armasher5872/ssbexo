...
unsafe extern "C" fn link_special_hi_glide_start_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    let boma = fighter.module_accessor;
    WorkModule::sub_int(boma, 30, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_STAMINA);
    MotionModule::change_motion(boma, Hash40::new("special_hi_glide_start"), 0.0, 1.0, false, 0.0, false, false);
    ...
    ArticleModule::change_motion(boma, *FIGHTER_LINK_GENERATE_ARTICLE_PARASAIL, Hash40::new("special_hi_glide_start"), false, -1.0);
