...
unsafe extern "C" fn link_special_hi_launch_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    let e4;
    if lr < 0.0 {
        e1 = EffectModule::req_on_joint(boma, Hash40::new("link_revali_gale_wind"), Hash40::new("top"), &Vector3f{x: 0.0, y: 12.0, z: 0.0}, &Vector3f{x: 0.0, y: -90.0, z: 270.0}, 2.0, &Vector3f::zero(), &Vector3f::zero(), false, 0, 0, 0);
        e2 = EffectModule::req_on_joint(boma, Hash40::new("link_revali_gale_wind"), Hash40::new("top"), &Vector3f{x: 0.0, y: 24.0, z: 0.0}, &Vector3f{x: 0.0, y: -90.0, z: 270.0}, 2.0, &Vector3f::zero(), &Vector3f::zero(), false, 0, 0, 0);
        e3 = EffectModule::req_on_joint(boma, Hash40::new("link_revali_gale_wind"), Hash40::new("top"), &Vector3f{x: 0.0, y: 36.0, z: 0.0}, &Vector3f{x: 0.0, y: -90.0, z: 270.0}, 2.0, &Vector3f::zero(), &Vector3f::zero(), false, 0, 0, 0);
        e4 = EffectModule::req_on_joint(boma, Hash40::new("link_revali_gale_wind"), Hash40::new("top"), &Vector3f{x: 0.0, y: 48.0, z: 0.0}, &Vector3f{x: 0.0, y: -90.0, z: 270.0}, 2.0, &Vector3f::zero(), &Vector3f::zero(), false, 0, 0, 0);
    }
    else {
        e1 = EffectModule::req_on_joint(boma, Hash40::new("link_revali_gale_wind"), Hash40::new("top"), &Vector3f{x: 0.0, y: 12.0, z: 0.0}, &Vector3f{x: 0.0, y: 90.0, z: 270.0}, 2.0, &Vector3f::zero(), &Vector3f::zero(), false, 0, 0, 0);
        e2 = EffectModule::req_on_joint(boma, Hash40::new("link_revali_gale_wind"), Hash40::new("top"), &Vector3f{x: 0.0, y: 24.0, z: 0.0}, &Vector3f{x: 0.0, y: 90.0, z: 270.0}, 2.0, &Vector3f::zero(), &Vector3f::zero(), false, 0, 0, 0);
    ...
    WorkModule::set_int(boma, e1 as i32, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_1);
    WorkModule::set_int(boma, e2 as i32, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_2);
    WorkModule::set_int(boma, e3 as i32, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_3);
    WorkModule::set_int(boma, e4 as i32, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_4);
...
unsafe extern "C" fn link_special_hi_launch_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    let e2 = WorkModule::get_int(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_2);
    let e3 = WorkModule::get_int(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_3);
    let e4 = WorkModule::get_int(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_4);
    ...
    if WorkModule::is_flag(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_JUMP) {
    ...
    if current_frame >= 35.0 {
        EffectModule::set_alpha(boma, e1 as u32, 1.0-((current_frame-34.0)/15.0));
        EffectModule::set_alpha(boma, e2 as u32, 1.0-((current_frame-34.0)/15.0));
        EffectModule::set_alpha(boma, e3 as u32, 1.0-((current_frame-34.0)/15.0));
        EffectModule::set_alpha(boma, e4 as u32, 1.0-((current_frame-34.0)/15.0));
    }
...
unsafe extern "C" fn link_special_hi_launch_end_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    EffectModule::kill(boma, WorkModule::get_int(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_1) as u32, true, true);
    EffectModule::kill(boma, WorkModule::get_int(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_2) as u32, true, true);
    EffectModule::kill(boma, WorkModule::get_int(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_3) as u32, true, true);
    EffectModule::kill(boma, WorkModule::get_int(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_INT_SPECIAL_HI_EFFECT_ID_4) as u32, true, true);
    ...
    WorkModule::on_flag(boma, *FIGHTER_LINK_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_NO_GAIN);
    0.into()
}
