...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_link_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_link_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_link_pivot_grab_acmd, Low)
    .acmd("game_throwb", ssbexo_link_back_throw_acmd, Low)
    .acmd("effect_throwb", ssbexo_link_back_throw_effect, Low)
    .acmd("sound_throwb", ssbexo_link_back_throw_sound, Low)
    .acmd("expression_throwb", ssbexo_link_back_throw_expression, Low)
    .acmd("game_throwhi", ssbexo_link_up_throw_acmd, Low)
    .acmd("effect_throwhi", ssbexo_link_up_throw_effect, Low)
    .acmd("sound_throwhi", ssbexo_link_up_throw_sound, Low)
    .acmd("expression_throwhi", ssbexo_link_up_throw_expression, Low)
    .install()
    ;
}