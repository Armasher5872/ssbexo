...
pub fn install() {
    ...
    .acmd("game_specialhi", ssbexo_link_grounded_special_hi_acmd, Low)
    .acmd("game_specialairhi", ssbexo_link_aerial_special_hi_acmd, Low)
    .acmd("effect_specialhi", ssbexo_link_special_hi_effect, Low)
    .acmd("effect_specialairhi", ssbexo_link_special_hi_effect, Low)
    .acmd("sound_specialhi", ssbexo_link_special_hi_sound, Low)
    .acmd("sound_specialairhi", ssbexo_link_special_hi_sound, Low)
    .acmd("expression_specialhi", ssbexo_link_special_hi_expression, Low)
    .acmd("expression_specialairhi", ssbexo_link_special_hi_expression, Low)
    .install()
    ;
}