...
unsafe extern "C" fn krool_special_lw_launch_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if !StatusModule::is_changing(boma) {
        ...
        && prev_situation_kind == *SITUATION_KIND_GROUND {
            GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_AIR));
            KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_FALL);
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_lw_launch"), -1.0, 1.0, 0.0, false, false);
        }
    }
    ...
    if WorkModule::is_flag(boma, *FIGHTER_KROOL_INSTANCE_WORK_ID_FLAG_SPECIAL_LW_JUMP) {
        ...
        WorkModule::set_int(boma, degrees as i32, *FIGHTER_KROOL_INSTANCE_WORK_ID_INT_SPECIAL_LW_ANGLE);
        MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_lw_launch"), -1.0, 1.0, 0.0, false, false);
