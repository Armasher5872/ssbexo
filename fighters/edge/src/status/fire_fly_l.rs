...
unsafe extern "C" fn edge_fire_l_fly_main_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    ...
    let life = WorkModule::get_param_int(boma, hash40("param_fire"), hash40("life_l"));
    let speed_x_l = WorkModule::get_param_float(boma, hash40("param_fire"), hash40("speed_x_l"));
    let accel_x_l = WorkModule::get_param_float(boma, hash40("param_fire"), hash40("accel_x_l"));
    let max_speed_x_l = WorkModule::get_param_float(boma, hash40("param_fire"), hash40("max_speed_x_l"));
    let angle: f32 = 20.0;
