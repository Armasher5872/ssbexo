...
unsafe extern "C" fn edge_fire_s_fly_main_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    ...
    let life = WorkModule::get_param_int(boma, hash40("param_fire"), hash40("life_s"));
    let speed_x_s = WorkModule::get_param_float(boma, hash40("param_fire"), hash40("speed_x_s"));
    let accel_x_s = WorkModule::get_param_float(boma, hash40("param_fire"), hash40("accel_x_s"));
    let max_speed_x_s = WorkModule::get_param_float(boma, hash40("param_fire"), hash40("max_speed_x_s"));
    let angle: f32 = 20.0;
    ...
    MotionModule::change_motion(boma, Hash40::new("special_n1"), 0.0, 1.0, false, 0.0, false, false);
