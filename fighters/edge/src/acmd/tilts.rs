...
unsafe extern "C" fn ssbexo_edge_up_tilt_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        AttackModule::set_vec_target_pos(boma, 0, Hash40::new("top"), &Vector2f{x: 2.0, y: 35.0}, 5, false);
    }
...
unsafe extern "C" fn ssbexo_edge_down_tilt_acmd(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 9.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("top"), 8.0, 85, 60, 0, 84, 2.0, 0.0, 1.5, 13.0, Some(0.0), Some(1.5), Some(2.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
...
pub fn install() {
    ...
    .game_acmd("game_attackhi3", ssbexo_edge_up_tilt_acmd, Low)
    .game_acmd("game_attacklw3", ssbexo_edge_down_tilt_acmd, Low)
    .install()
    ;
}