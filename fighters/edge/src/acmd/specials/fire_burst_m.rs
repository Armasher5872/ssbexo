...
//Megaflare Burst ACMD
unsafe extern "C" fn ssbexo_edge_megaflare_burst_acmd(agent: &mut L2CAgentBase) {
...
pub fn install() {
    ...
    .acmd("game_burstm", ssbexo_edge_megaflare_burst_acmd, Low)
    .install()
    ;
}