...
unsafe extern "C" fn ssbexo_peach_aerial_down_special_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        CATCH(agent, 0, Hash40::new("haver"), 6.0, 0.0, 0.0, 0.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
...
unsafe extern "C" fn ssbexo_peach_aerial_down_special_throw_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 8.0, 0, 65, 0, 40, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
...
unsafe extern "C" fn ssbexo_peach_aerial_down_special_throw_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        EFFECT_FLW_POS(agent, Hash40::new("peach_levitation"), Hash40::new("toer"), 1, 0, 0, 0, 0, 0, 1, true);
    }
    ...
    if is_excute(agent) {
        ...
        LAST_EFFECT_SET_COLOR(agent, 1, 0.85, 0.9);
    }
}
...
unsafe extern "C" fn ssbexo_peach_aerial_down_special_throw_sound(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        PLAY_STATUS(agent, Hash40::new("se_peach_jump04"));
    }
...
pub fn install() {
    ...
    .game_acmd("game_specialhiopen", ssbexo_peach_up_special_open_acmd, Low)
    .game_acmd("game_speciallw", ssbexo_peach_grounded_down_special_acmd, Low)
    .game_acmd("game_specialairlw", ssbexo_peach_aerial_down_special_acmd, Low)
    .effect_acmd("effect_specialairlw", ssbexo_peach_aerial_down_special_effect, Low)
    .sound_acmd("sound_specialairlw", ssbexo_peach_aerial_down_special_sound, Low)
    .expression_acmd("expression_specialairlw", ssbexo_peach_aerial_down_special_expression, Low)
    .game_acmd("game_specialairlwthrow", ssbexo_peach_aerial_down_special_throw_acmd, Low)
    .effect_acmd("effect_specialairlwthrow", ssbexo_peach_aerial_down_special_throw_effect, Low)
    .sound_acmd("sound_specialairlwthrow", ssbexo_peach_aerial_down_special_throw_sound, Low)
    .expression_acmd("expression_specialairlwthrow", ssbexo_peach_aerial_down_special_throw_expression, Low)
    .install()
    ;
}