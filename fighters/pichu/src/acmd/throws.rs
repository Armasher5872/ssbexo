...
pub fn install() {
    ...
    .game_acmd("game_catch", ssbexo_pichu_grab_acmd, Low)
    .game_acmd("game_catchdash", ssbexo_pichu_dash_grab_acmd, Low)
    .game_acmd("game_catchturn", ssbexo_pichu_pivot_grab_acmd, Low)
    .install()
    ;
}