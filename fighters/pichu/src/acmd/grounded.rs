...
pub fn install() {
    ...
    .effect_acmd("effect_attackdash", ssbexo_pichu_dash_attack_effect, Low)
    .sound_acmd("sound_attackdash", ssbexo_pichu_dash_attack_sound, Low)
    .expression_acmd("expression_attackdash", ssbexo_pichu_dash_attack_expression, Low)
    .install()
    ;
}