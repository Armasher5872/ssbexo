...
pub fn install() {
    ...
    .status(Pre, *WEAPON_LUIGI_OBAKYUMU_STATUS_KIND_SPECIAL_LW_THROW, luigi_obakyumu_special_lw_catch_pull_pre_status)
    .status(Main, *WEAPON_LUIGI_OBAKYUMU_STATUS_KIND_SPECIAL_LW_THROW, luigi_obakyumu_special_lw_catch_pull_main_status)
    .status(End, *WEAPON_LUIGI_OBAKYUMU_STATUS_KIND_SPECIAL_LW_THROW, luigi_obakyumu_special_lw_catch_pull_end_status)
    .install()
    ;
}