...
unsafe extern "C" fn luigi_special_lw_catch_wait_init_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if situation_kind == *SITUATION_KIND_GROUND {
        ...
        sv_kinetic_energy!(set_stable_speed, fighter, *FIGHTER_KINETIC_ENERGY_ID_STOP, air_speed_x_stable*0.5);
        sv_kinetic_energy!(set_limit_speed, fighter, *FIGHTER_KINETIC_ENERGY_ID_STOP, air_speed_x_stable*0.5);
    }
...
unsafe extern "C" fn luigi_special_lw_catch_wait_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    ArticleModule::change_status(fighter.module_accessor, *FIGHTER_LUIGI_GENERATE_ARTICLE_OBAKYUMU, *WEAPON_LUIGI_OBAKYUMU_STATUS_KIND_SPECIAL_LW_CATCH_WAIT, ArticleOperationTarget(0));
    ItemModule::set_have_item_visibility(fighter.module_accessor, false, 0);
    MotionModule::change_motion(fighter.module_accessor, Hash40::new("special_lw_catch_wait"), 0.0, 1.0, false, 0.0, false, false);
