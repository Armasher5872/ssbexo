...
unsafe extern "C" fn luigi_obakyumu_special_lw_end_main_status(weapon: &mut L2CWeaponCommon) -> L2CValue {
    ...
    if owner_lr == -1.0 {
        MotionModule::change_motion(weapon.module_accessor, Hash40::new("special_lw_end_l"), 0.0, 1.0, false, 0.0, false, false);
        MotionModule::set_flip(weapon.module_accessor, false, true, true);
    }
    else {
        MotionModule::change_motion(weapon.module_accessor, Hash40::new("special_lw_end"), 0.0, 1.0, false, 0.0, false, false);
    }
