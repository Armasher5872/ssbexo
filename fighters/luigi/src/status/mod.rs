...
mod catch_wait;
mod catch;
mod obakyumu_special_lw_catch_jump;
mod obakyumu_special_lw_catch_pull;
mod obakyumu_special_lw_catch_turn;
mod obakyumu_special_lw_catch_wait;
mod obakyumu_special_lw_catch_walk;
...
pub fn install() {
    ...
    obakyumu_special_lw_catch_jump::install();
    obakyumu_special_lw_catch_pull::install();
    obakyumu_special_lw_catch_turn::install();
    obakyumu_special_lw_catch_wait::install();
    obakyumu_special_lw_catch_walk::install();
