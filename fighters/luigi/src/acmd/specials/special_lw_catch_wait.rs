...
pub fn install() {
    ...
    .acmd("game_speciallwcatchwait", ssbexo_luigi_down_special_catch_wait_acmd, Low)
    .acmd("effect_speciallwcatchwait", ssbexo_luigi_down_special_catch_wait_effect, Low)
    .acmd("sound_speciallwcatchwait", ssbexo_luigi_down_special_catch_wait_sound, Low)
    .acmd("expression_speciallwcatchwait", ssbexo_luigi_down_special_catch_wait_expression, Low)
    .install()
    ;
}