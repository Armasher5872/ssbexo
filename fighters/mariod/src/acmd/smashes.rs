...
pub fn install() {
    ...
    .game_acmd("game_attacks4", ssbexo_mariod_forward_smash_acmd, Low)
    .game_acmd("game_attacks4hi", ssbexo_mariod_forward_smash_hi_acmd, Low)
    .game_acmd("game_attacks4lw", ssbexo_mariod_forward_smash_lw_acmd, Low)
    .sound_acmd("sound_attacks4", ssbexo_mariod_forward_smash_sound, Low)
    .sound_acmd("sound_attacks4hi", ssbexo_mariod_forward_smash_sound, Low)
    .sound_acmd("sound_attacks4lw", ssbexo_mariod_forward_smash_sound, Low)
    .game_acmd("game_attackhi4", ssbexo_mariod_up_smash_acmd, Low)
    .effect_acmd("effect_attackhi4", ssbexo_mariod_up_smash_effect, Low)
    .sound_acmd("sound_attackhi4", ssbexo_mariod_up_smash_sound, Low)
    .effect_acmd("effect_attacklw4charge", ssbexo_mariod_down_smash_charge_effect, Low)
    .game_acmd("game_attacklw4", ssbexo_mariod_down_smash_acmd, Low)
    .effect_acmd("effect_attacklw4", ssbexo_mariod_down_smash_effect, Low)
    .sound_acmd("sound_attacklw4", ssbexo_mariod_down_smash_sound, Low)
    .expression_acmd("expression_attacklw4", ssbexo_mariod_down_smash_expression, Low)
    .install()
    ;
}