...
pub fn install() {
    ...
    .acmd("game_attacknearw", ssbexo_ryu_close_forward_tilt_acmd, Low)
    .acmd("effect_attacknearw", ssbexo_ryu_close_forward_tilt_effect, Low)
    .acmd("game_attacks3s", ssbexo_ryu_heavy_forward_tilt_acmd, Low)
    .acmd("game_attacklw3s", ssbexo_ryu_heavy_down_tilt_acmd, Low)
    .install()
    ;
}