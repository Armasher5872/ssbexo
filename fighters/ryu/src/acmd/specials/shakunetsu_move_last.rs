...
pub fn install() {
    ...
    .acmd("game_movespwlast", ssbexo_ryu_hadoken_special_move_last_acmd, Low)
    .acmd("game_movespmlast", ssbexo_ryu_hadoken_special_move_last_acmd, Low)
    .acmd("game_movespslast", ssbexo_ryu_hadoken_special_move_last_acmd, Low)
    .install()
    ;
}