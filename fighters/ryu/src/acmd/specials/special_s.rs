...
pub fn install() {
    ...
    .acmd("game_specialsstart", ssbexo_ryu_tatsumaki_start_acmd, Low)
    .acmd("game_specialairsstart", ssbexo_ryu_tatsumaki_start_acmd, Low)
    .acmd("game_specials", ssbexo_ryu_tatsumaki_loop_acmd, Low)
    .acmd("game_specialairs", ssbexo_ryu_tatsumaki_loop_acmd, Low)
    .acmd("game_specialsend", ssbexo_ryu_tatsumaki_end_acmd, Low)
    .acmd("game_specialairsend", ssbexo_ryu_tatsumaki_end_acmd, Low)
    .install()
    ;
}