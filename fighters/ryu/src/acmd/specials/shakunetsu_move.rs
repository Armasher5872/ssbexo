...
pub fn install() {
    ...
    .acmd("game_movespw", ssbexo_ryu_hadoken_special_move_w_acmd, Low)
    .acmd("game_movespm", ssbexo_ryu_hadoken_special_move_m_acmd, Low)
    .acmd("game_movesps", ssbexo_ryu_hadoken_special_move_s_acmd, Low)
    .install()
    ;
}