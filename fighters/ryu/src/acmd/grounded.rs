...
pub fn install() {
    ...
    .game_acmd("game_attack11nears", ssbexo_ryu_close_jab_heavy_acmd, Low)
    .effect_acmd("effect_attack11nears", ssbexo_ryu_close_jab_heavy_effect, Low)
    .sound_acmd("sound_attack11nears", ssbexo_ryu_close_jab_heavy_sound, Low)
    .expression_acmd("expression_attack11nears", ssbexo_ryu_close_jab_heavy_expression, Low)
    .game_acmd("game_attackdash", ssbexo_ryu_dash_attack_acmd, Low)
    .effect_acmd("effect_attackdash", ssbexo_ryu_dash_attack_effect, Low)
    .sound_acmd("sound_attackdash", ssbexo_ryu_dash_attack_sound, Low)
    .expression_acmd("expression_attackdash", ssbexo_ryu_dash_attack_expression, Low)
    .install()
    ;
}