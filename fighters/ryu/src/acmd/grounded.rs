...
unsafe extern "C" fn ssbexo_ryu_close_jab_heavy_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("top"), 6.0, 361, 92, 0, 30, 4.0, 0.0, 10.0, 4.4, Some(0.0), Some(15.2), Some(11.0), 1.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_RYU_KICK, *ATTACK_REGION_KICK);
        AttackModule::set_attack_height_all(boma, AttackHeight(*ATTACK_HEIGHT_HIGH), false);
    }
    frame(lua_state, 17.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("top"), 6.0, 361, 92, 0, 30, 4.0, 0.0, 10.0, 4.4, Some(0.0), Some(10.0), Some(11.0), 1.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_RYU_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe extern "C" fn ssbexo_ryu_close_jab_heavy_effect(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 16.0);
    if is_excute(agent) {
        EFFECT_FOLLOW_FLIP_ALPHA(agent, Hash40::new("ryu_attack_arc2"), Hash40::new("ryu_attack_arc2"), Hash40::new("top"), 0, 12, 5.5, 7, -30, -100, 0.9, true, *EF_FLIP_YZ, 0.5);
...
pub fn install() {
    ...
    .acmd("game_attack11nears", ssbexo_ryu_close_jab_heavy_acmd, Low)
    .acmd("effect_attack11nears", ssbexo_ryu_close_jab_heavy_effect, Low)
    .acmd("sound_attack11nears", ssbexo_ryu_close_jab_heavy_sound, Low)
    .acmd("expression_attack11nears", ssbexo_ryu_close_jab_heavy_expression, Low)
    .acmd("game_attackdash", ssbexo_ryu_dash_attack_acmd, Low)
    .acmd("effect_attackdash", ssbexo_ryu_dash_attack_effect, Low)
    .acmd("sound_attackdash", ssbexo_ryu_dash_attack_sound, Low)
    .acmd("expression_attackdash", ssbexo_ryu_dash_attack_expression, Low)
    .install()
    ;
}