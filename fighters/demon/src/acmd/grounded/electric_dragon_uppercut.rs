...
//Electric Dragon Uppercut ACMD
unsafe extern "C" fn ssbexo_demon_electric_dragon_uppercut_acmd(agent: &mut L2CAgentBase) {
...
//Electric Dragon Uppercut Effect
unsafe extern "C" fn ssbexo_demon_electric_dragon_uppercut_effect(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    if is_excute(agent) {
...
//Electric Dragon Uppercut Sound
unsafe extern "C" fn ssbexo_demon_electric_dragon_uppercut_sound(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    frame(lua_state, 2.0);
    if is_excute(agent) {
...
//Electric Dragon Uppercut Expression
unsafe extern "C" fn ssbexo_demon_electric_dragon_uppercut_expression(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    if is_excute(agent) {
...
pub fn install() {
    ...
    .acmd("game_attackstep2lelec", ssbexo_demon_electric_dragon_uppercut_acmd, Low)
    .acmd("effect_attackstep2lelec", ssbexo_demon_electric_dragon_uppercut_effect, Low)
    .acmd("sound_attackstep2lelec", ssbexo_demon_electric_dragon_uppercut_sound, Low)
    .acmd("expression_attackstep2lelec", ssbexo_demon_electric_dragon_uppercut_expression, Low)
    .install()
    ;
}