...
//Demons Wrath ACMD
unsafe extern "C" fn ssbexo_demon_demons_wrath_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 1, 0, Hash40::new("top"), 3.0, 361, 5, 0, 20, 3.0, 0.0, 9.0, 5.0, None, None, None, 0.2, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_DEMON_KICK, *ATTACK_REGION_KICK);
...
//Demons Wrath Effect
unsafe extern "C" fn ssbexo_demon_demons_wrath_effect(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
...
//Demons Wrath Sound
unsafe extern "C" fn ssbexo_demon_demons_wrath_sound(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
...
//Demons Wrath Expression
unsafe extern "C" fn ssbexo_demon_demons_wrath_expression(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    if is_excute(agent) {
...
pub fn install() {
    ...
    .acmd("game_attackstand51", ssbexo_demon_demons_wrath_acmd, Low)
    .acmd("effect_attackstand51", ssbexo_demon_demons_wrath_effect, Low)
    .acmd("sound_attackstand51", ssbexo_demon_demons_wrath_sound, Low)
    .acmd("expression_attackstand51", ssbexo_demon_demons_wrath_expression, Low)
    .install()
    ;
}