...
//Grounded Side Special Hit ACMD
unsafe extern "C" fn ssbexo_demon_grounded_side_special_hit_acmd(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    if !WorkModule::is_flag(boma, *FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_DEVIL_FORM_ACTIVE) {
        FighterSpecializer_Demon::set_devil(boma, true, 1.0);
...
unsafe extern "C" fn ssbexo_demon_grounded_side_special_end_acmd(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    if !WorkModule::is_flag(boma, *FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_DEVIL_FORM_ACTIVE) {
        FighterSpecializer_Demon::set_devil(boma, true, 1.0);
...
//Grounded Side Special Landing ACMD
unsafe extern "C" fn ssbexo_demon_grounded_side_special_landing_acmd(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    if !WorkModule::is_flag(boma, *FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_DEVIL_FORM_ACTIVE) {
        FighterSpecializer_Demon::set_devil(boma, true, 3.0);
...
//Aerial Side Special Hit ACMD
unsafe extern "C" fn ssbexo_demon_aerial_side_special_hit_acmd(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    if !WorkModule::is_flag(boma, *FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_DEVIL_FORM_ACTIVE) {
        FighterSpecializer_Demon::set_devil(boma, true, 1.0);
...
unsafe extern "C" fn ssbexo_demon_aerial_side_special_end_acmd(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    if !WorkModule::is_flag(boma, *FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_DEVIL_FORM_ACTIVE) {
        FighterSpecializer_Demon::set_devil(boma, true, 1.0);
...
pub fn install() {
    ...
    .acmd("game_specials", ssbexo_demon_grounded_side_special_acmd, Low)
    .acmd("game_specialshit", ssbexo_demon_grounded_side_special_hit_acmd, Low)
    .acmd("game_specialsend", ssbexo_demon_grounded_side_special_end_acmd, Low)
    .acmd("game_specialslanding", ssbexo_demon_grounded_side_special_landing_acmd, Low)
    .acmd("game_specialairs", ssbexo_demon_aerial_side_special_acmd, Low)
    .acmd("game_specialairshit", ssbexo_demon_aerial_side_special_hit_acmd, Low)
    .acmd("game_specialairsend", ssbexo_demon_aerial_side_special_end_acmd, Low)
    .install()
    ;
}