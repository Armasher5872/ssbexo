...
//I'm not gonna sugarcoat it Pre Status
unsafe extern "C" fn demon_attack_step_2f_pre_status(fighter: &mut L2CFighterCommon) -> L2CValue {
...
//I'm not gonna sugarcoat it Main Status
unsafe extern "C" fn demon_attack_step_2f_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    let boma = fighter.module_accessor;
    MotionModule::change_motion(boma, Hash40::new("attack_step_2f"), 0.0, 1.0, false, 0.0, false, false);
    ...
    fighter.sub_shift_status_main(L2CValue::Ptr(demon_attack_step_2f_main_loop as *const () as _))
}

unsafe extern "C" fn demon_attack_step_2f_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    ...
    .status(Pre, *FIGHTER_DEMON_STATUS_KIND_ATTACK_STEP_2F, demon_attack_step_2f_pre_status)
    .status(Main, *FIGHTER_DEMON_STATUS_KIND_ATTACK_STEP_2F, demon_attack_step_2f_main_status)
    .install()
    ;
}