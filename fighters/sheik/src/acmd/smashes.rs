...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_sheik_forward_smash_acmd, Low)
    .acmd("game_attackhi4", ssbexo_sheik_up_smash_acmd, Low)
    .acmd("game_attacklw4", ssbexo_sheik_down_smash_acmd, Low)
    .install()
    ;
}