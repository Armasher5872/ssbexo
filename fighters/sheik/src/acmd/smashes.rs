...
unsafe extern "C" fn ssbexo_sheik_up_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        if needle_count == 6 {
            ATTACK(agent, 0, 0, Hash40::new("armr"), 17.0, 93, 88, 0, 52, 6.1, 2.9, 0.0, 0.0, None, None, None, 1.3, 1.5, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_PUNCH);
        }
        else {
...
unsafe extern "C" fn ssbexo_sheik_down_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 3, 0, Hash40::new("top"), 4.0, 0, 100, 35, 0, 4.0, 0.0, 2.5, -7.0, Some(0.0), Some(2.5), Some(7.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
    wait(agent.lua_state_agent, 2.0);
    if is_excute(agent) {
        AttackModule::clear_all(agent.module_accessor);
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 2, 0, Hash40::new("top"), 4.0, 43, 165, 0, 35, 4.5, 0.0, 2.5, -7.0, Some(0.0), Some(2.5), Some(7.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
    wait(agent.lua_state_agent, 2.0);
    if is_excute(agent) {
        AttackModule::clear_all(agent.module_accessor);
...
pub fn install() {
    ...
    .game_acmd("game_attacks4", ssbexo_sheik_forward_smash_acmd, Low)
    .game_acmd("game_attackhi4", ssbexo_sheik_up_smash_acmd, Low)
    .game_acmd("game_attacklw4", ssbexo_sheik_down_smash_acmd, Low)
    .install()
    ;
}