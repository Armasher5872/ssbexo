...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_sheik_forward_tilt_acmd, Low)
    .acmd("game_attackhi3", ssbexo_sheik_up_tilt_acmd, Low)
    .acmd("game_attacklw3", ssbexo_sheik_down_tilt_acmd, Low)
    .install()
    ;
}