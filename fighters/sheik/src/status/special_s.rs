            ...
            if current_frame < 37.0 {
                if WorkModule::get_int(opponent_boma, *FIGHTER_INSTANCE_WORK_ID_INT_INVALID_CAPTURE_FRAME) <= 0 {
                    ...
                    if !LinkModule::is_link(opponent_boma, *LINK_NO_CAPTURE) {
                        ...
                        LinkModule::set_model_constraint_pos_ort(opponent_boma, *LINK_NO_CAPTURE, Hash40::new("trans"), Hash40::new("throw"), (*CONSTRAINT_FLAG_ORIENTATION | *CONSTRAINT_FLAG_POSITION | *CONSTRAINT_FLAG_OFFSET_TRANSLATE) as u32, true);
