...
pub fn install() {
    ...
    .acmd("game_specialsdrivepartial", ssbexo_pickel_trolley_special_s_drive_partial_acmd, Low)
    .acmd("game_specialsdriveemptypartial", ssbexo_pickel_trolley_special_s_drive_empty_partial_acmd, Low)
    .install()
    ;
}