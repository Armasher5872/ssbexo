...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_pickel_forward_tilt_acmd, Low)
    .acmd("game_attackhi3", ssbexo_pickel_up_tilt_acmd, Low)
    .install()
    ;
}