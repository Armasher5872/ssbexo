...
unsafe extern "C" fn ssbexo_lucario_high_jump_kick_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("legl"), 6.0, 300, 120, 0, 60, 3.5, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 1, 0, Hash40::new("kneel"), 6.0, 300, 120, 0, 60, 3.5, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 2, 0, Hash40::new("toel"), 6.0, 300, 120, 0, 60, 5.0, 1.0, 1.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
}
...
unsafe extern "C" fn ssbexo_lucario_high_jump_kick_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        EFFECT_FOLLOW(agent, Hash40::new("lucario_kagebunshin_appear"), Hash40::new("top"), 0, 7.3, -2.5, 20, 0, 0, 1, true);
    }
    frame(agent.lua_state_agent, 1.0);
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_lucario_high_jump_kick_landing_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        LAST_EFFECT_SET_RATE(agent, 1.2);
        EFFECT(agent, Hash40::new("sys_bomb_b"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 1.5, 0, 0, 0, 0, 0, 0, true);
...
unsafe extern "C" fn ssbexo_lucario_dashing_force_palm_acmd(agent: &mut L2CAgentBase) {
    ...
    if IS_GENERATABLE_ARTICLE(agent, *FIGHTER_LUCARIO_GENERATE_ARTICLE_QIGONG) {
        if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_lucario_aerial_dashing_force_palm_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        EFFECT_FLW_POS(agent, Hash40::new("lucario_hakkei"), Hash40::new("top"), -2.7, 10, -2.5, 0, 0, 0, 1, true);
        EffectModule::enable_sync_init_pos_last(agent.module_accessor);
    }
    frame(agent.lua_state_agent, 4.0);
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_lucario_power_up_punch_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("shoulderr"), 12.0, 1, 55, 95, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_LUCARIO, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 1, 0, Hash40::new("armr"), 12.0, 1, 55, 95, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_LUCARIO, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 2, 0, Hash40::new("handr"), 12.0, 1, 55, 95, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 8, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_LUCARIO, *ATTACK_REGION_PUNCH);
    }
...
unsafe extern "C" fn ssbexo_lucario_power_up_punch_effect(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 17.0);
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("lucario_hakkei_far"), Hash40::new("handr"), 0, 0, 1, 180, 0, 0, 0.8, true);
    }
}
...
unsafe extern "C" fn ssbexo_lucario_grounded_side_special_acmd(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 21.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("haver"), 6.0, 367, 80, 60, 0, 5.0, 0.0, -8.0, 0.0, Some(0.0), Some(15.0), Some(0.0), 0.6, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_LUCARIO, *ATTACK_REGION_SWORD);
    }
...
unsafe extern "C" fn ssbexo_lucario_aerial_side_special_acmd(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 21.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("haver"), 6.0, 367, 80, 60, 0, 5.0, 0.0, -8.0, 0.0, Some(0.0), Some(15.0), Some(0.0), 0.6, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_LUCARIO, *ATTACK_REGION_SWORD);
    }
    frame(agent.lua_state_agent, 25.0);
    if is_excute(agent) {
        AttackModule::clear_all(agent.module_accessor);
...
unsafe extern "C" fn ssbexo_lucario_side_special_sound(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 5.0);
    if is_excute(agent) {
        PLAY_SE(agent, Hash40::new("se_lucario_jump01"));
    }
...
unsafe extern "C" fn ssbexo_lucario_grounded_side_special_hi_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("haver"), 10.0, 85, 120, 0, 55, 5.0, 0.0, -8.0, 0.0, Some(0.0), Some(15.0), Some(0.0), 1.2, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_LUCARIO, *ATTACK_REGION_SWORD);
    }
    frame(agent.lua_state_agent, 21.0);
    if is_excute(agent) {
        AttackModule::clear_all(agent.module_accessor);
...
unsafe extern "C" fn ssbexo_lucario_grounded_side_special_lw_acmd(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 13.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("haver"), 10.0, 300, 40, 160, 0, 5.0, 0.0, -8.0, 0.0, Some(0.0), Some(15.0), Some(0.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_aura"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_LUCARIO, *ATTACK_REGION_SWORD);
        AttackModule::set_add_reaction_frame_revised(agent.module_accessor, 0, 30.0, false);
        ATK_SET_SHIELD_SETOFF_MUL(agent, 0, 3.5);
    }
    frame(agent.lua_state_agent, 21.0);
    if is_excute(agent) {
        AttackModule::clear_all(agent.module_accessor);
...
pub fn install() {
    ...
    .game_acmd("game_highjumpkickstart", ssbexo_lucario_high_jump_kick_start_acmd, Low)
    .effect_acmd("effect_highjumpkickstart", ssbexo_lucario_high_jump_kick_start_effect, Low)
    .sound_acmd("sound_highjumpkickstart", ssbexo_lucario_high_jump_kick_start_sound, Low)
    .expression_acmd("expression_highjumpkickstart", ssbexo_lucario_high_jump_kick_start_expression, Low)
    .game_acmd("game_highjumpkick", ssbexo_lucario_high_jump_kick_acmd, Low)
    .effect_acmd("effect_highjumpkick", ssbexo_lucario_high_jump_kick_effect, Low)
    .sound_acmd("sound_highjumpkick", ssbexo_lucario_high_jump_kick_sound, Low)
    .expression_acmd("expression_highjumpkick", ssbexo_lucario_high_jump_kick_expression, Low)
    .game_acmd("game_highjumpkicklanding", ssbexo_lucario_high_jump_kick_landing_acmd, Low)
    .effect_acmd("effect_highjumpkicklanding", ssbexo_lucario_high_jump_kick_landing_effect, Low)
    .sound_acmd("sound_highjumpkicklanding", ssbexo_lucario_high_jump_kick_landing_sound, Low)
    .expression_acmd("expression_highjumpkicklanding", ssbexo_lucario_high_jump_kick_landing_expression, Low)
    .game_acmd("game_dashingforcepalm", ssbexo_lucario_dashing_force_palm_acmd, Low)
    .game_acmd("game_dashingforcepalmair", ssbexo_lucario_dashing_force_palm_acmd, Low)
    .effect_acmd("effect_dashingforcepalm", ssbexo_lucario_grounded_dashing_force_palm_effect, Low)
    .effect_acmd("effect_dashingforcepalmair", ssbexo_lucario_aerial_dashing_force_palm_effect, Low)
    .sound_acmd("sound_dashingforcepalm", ssbexo_lucario_dashing_force_palm_sound, Low)
    .sound_acmd("sound_dashingforcepalmair", ssbexo_lucario_dashing_force_palm_sound, Low)
    .expression_acmd("expression_dashingforcepalm", ssbexo_lucario_dashing_force_palm_expression, Low)
    .expression_acmd("expression_dashingforcepalmair", ssbexo_lucario_dashing_force_palm_expression, Low)
    .game_acmd("game_poweruppunch", ssbexo_lucario_power_up_punch_acmd, Low)
    .effect_acmd("effect_poweruppunch", ssbexo_lucario_power_up_punch_effect, Low)
    .sound_acmd("sound_poweruppunch", ssbexo_lucario_power_up_punch_sound, Low)
    .expression_acmd("expression_poweruppunch", ssbexo_lucario_power_up_punch_expression, Low)
    .game_acmd("game_specials", ssbexo_lucario_grounded_side_special_acmd, Low)
    .game_acmd("game_specialairs", ssbexo_lucario_aerial_side_special_acmd, Low)
    .effect_acmd("effect_specials", ssbexo_lucario_grounded_side_special_effect, Low)
    .effect_acmd("effect_specialairs", ssbexo_lucario_aerial_side_special_effect, Low)
    .sound_acmd("sound_specials", ssbexo_lucario_side_special_sound, Low)
    .sound_acmd("sound_specialairs", ssbexo_lucario_side_special_sound, Low)
    .expression_acmd("expression_specials", ssbexo_lucario_grounded_side_special_expression, Low)
    .expression_acmd("expression_specialairs", ssbexo_lucario_aerial_side_special_expression, Low)
    .game_acmd("game_specialshi", ssbexo_lucario_grounded_side_special_hi_acmd, Low)
    .game_acmd("game_specialairshi", ssbexo_lucario_aerial_side_special_hi_acmd, Low)
    .effect_acmd("effect_specialshi", ssbexo_lucario_grounded_side_special_hi_effect, Low)
    .effect_acmd("effect_specialairshi", ssbexo_lucario_aerial_side_special_hi_effect, Low)
    .sound_acmd("sound_specialshi", ssbexo_lucario_side_special_hi_sound, Low)
    .sound_acmd("sound_specialairshi", ssbexo_lucario_side_special_hi_sound, Low)
    .expression_acmd("expression_specialshi", ssbexo_lucario_grounded_side_special_hi_expression, Low)
    .expression_acmd("expression_specialairshi", ssbexo_lucario_aerial_side_special_hi_expression, Low)
    .game_acmd("game_specialslw", ssbexo_lucario_grounded_side_special_lw_acmd, Low)
    .game_acmd("game_specialairslw", ssbexo_lucario_aerial_side_special_lw_acmd, Low)
    .effect_acmd("effect_specialslw", ssbexo_lucario_grounded_side_special_lw_effect, Low)
    .effect_acmd("effect_specialairslw", ssbexo_lucario_aerial_side_special_lw_effect, Low)
    .sound_acmd("sound_specialslw", ssbexo_lucario_side_special_lw_sound, Low)
    .sound_acmd("sound_specialairslw", ssbexo_lucario_side_special_lw_sound, Low)
    .expression_acmd("expression_specialslw", ssbexo_lucario_grounded_side_special_lw_expression, Low)
    .expression_acmd("expression_specialairslw", ssbexo_lucario_aerial_side_special_lw_expression, Low)
    .game_acmd("game_speciallw", ssbexo_lucario_down_special_acmd, Low)
    .game_acmd("game_specialairlw", ssbexo_lucario_down_special_acmd, Low)
    .effect_acmd("effect_speciallw", ssbexo_lucario_down_special_effect, Low)
    .effect_acmd("effect_specialairlw", ssbexo_lucario_down_special_effect, Low)
    .sound_acmd("sound_speciallw", ssbexo_lucario_down_special_sound, Low)
    .sound_acmd("sound_specialairlw", ssbexo_lucario_down_special_sound, Low)
    .expression_acmd("expression_speciallw", ssbexo_lucario_down_special_expression, Low)
    .expression_acmd("expression_specialairlw", ssbexo_lucario_down_special_expression, Low)
    .game_acmd("game_megaevolve", ssbexo_lucario_mega_evolve_acmd, Low)
    .game_acmd("game_megaevolveair", ssbexo_lucario_mega_evolve_acmd, Low)
    .effect_acmd("effect_megaevolve", ssbexo_lucario_mega_evolve_effect, Low)
    .effect_acmd("effect_megaevolveair", ssbexo_lucario_mega_evolve_effect, Low)
    .sound_acmd("sound_megaevolve", ssbexo_lucario_mega_evolve_sound, Low)
    .sound_acmd("sound_megaevolveair", ssbexo_lucario_mega_evolve_sound, Low)
    .expression_acmd("expression_megaevolve", ssbexo_lucario_mega_evolve_expression, Low)
    .expression_acmd("expression_megaevolveair", ssbexo_lucario_mega_evolve_expression, Low)
    .install()
    ;
    Agent::new("lucario_qigong")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_shoot", ssbexo_lucario_qigong_shoot_acmd, Low)
    .install()
    ;
}