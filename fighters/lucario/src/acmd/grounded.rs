...
pub fn install() {
    ...
    .acmd("game_appealhir", ssbexo_lucario_up_taunt_acmd, Low)
    .acmd("effect_appealhir", ssbexo_lucario_up_taunt_effect, Low)
    .acmd("sound_appealhir", ssbexo_lucario_up_taunt_sound, Low)
    .acmd("expression_appealhir", ssbexo_lucario_up_taunt_expression, Low)
    .acmd("game_appealhil", ssbexo_lucario_up_taunt_acmd, Low)
    .acmd("effect_appealhil", ssbexo_lucario_up_taunt_effect, Low)
    .acmd("sound_appealhil", ssbexo_lucario_up_taunt_sound, Low)
    .acmd("expression_appealhil", ssbexo_lucario_up_taunt_expression, Low)
    .acmd("game_attackdash", ssbexo_lucario_dash_attack_acmd, Low)
    .install()
    ;
}