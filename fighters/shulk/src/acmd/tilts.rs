...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_shulk_forward_tilt_acmd, Low)
    .acmd("effect_attacks3", ssbexo_shulk_forward_tilt_effect, Low)
    .acmd("sound_attacks3", ssbexo_shulk_forward_tilt_sound, Low)
    .acmd("expression_attacks3", ssbexo_shulk_forward_tilt_expression, Low)
    .install()
    ;
}