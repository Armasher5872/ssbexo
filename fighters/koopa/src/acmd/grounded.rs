...
pub fn install() {
    ...
    .acmd("expression_wait2", ssbexo_koopa_wait_2_expression, Low)
    .acmd("expression_wait3", ssbexo_koopa_wait_3_expression, Low)
    .acmd("effect_appealhil", ssbexo_koopa_up_taunt_effect, Low)
    .acmd("effect_appealhir", ssbexo_koopa_up_taunt_effect, Low)
    .acmd("sound_appealhil", ssbexo_koopa_up_taunt_sound, Low)
    .acmd("sound_appealhir", ssbexo_koopa_up_taunt_sound, Low)
    .acmd("expression_appealhil", ssbexo_koopa_up_taunt_expression, Low)
    .acmd("expression_appealhir", ssbexo_koopa_up_taunt_expression, Low)
    .acmd("game_appealsr", ssbexo_koopa_side_taunt_acmd, Low)
    .acmd("game_appealsl", ssbexo_koopa_side_taunt_acmd, Low)
    .acmd("expression_appealsl", ssbexo_koopa_side_taunt_expression, Low)
    .acmd("expression_appealsr", ssbexo_koopa_side_taunt_expression, Low)
    .acmd("game_attackdash", ssbexo_koopa_dash_attack_acmd, Low)
    .acmd("effect_attackdash", ssbexo_koopa_dash_attack_effect, Low)
    .acmd("sound_attackdash", ssbexo_koopa_dash_attack_sound, Low)
    .acmd("expression_attackdash", ssbexo_koopa_dash_attack_expression, Low)
    .install()
    ;
}