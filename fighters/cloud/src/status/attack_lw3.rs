...
unsafe extern "C" fn cloud_status_attack_lw3_common_param(fighter: &mut L2CFighterCommon, param_2: L2CValue, l2cfightercommonptr: L2CValue, log_infos: L2CValue) {
    ...
    let get_attack_lw3_fb_kind = ControlModule::get_attack_lw3_fb_kind(boma);
    ...
    WorkModule::set_int64(boma, log_infos.get_i64(), *FIGHTER_STATUS_WORK_ID_INT_RESERVE_LOG_ATTACK_KIND);
    if cont {
    ...
    WorkModule::unable_transition_term_group_ex(boma, *FIGHTER_STATUS_TRANSITION_TERM_ID_CONT_SQUAT);
    WorkModule::unable_transition_term_group_ex(boma, *FIGHTER_STATUS_TRANSITION_TERM_ID_CONT_TURN);
...
unsafe extern "C" fn cloud_attack_lw3_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if count == 1 && motion_kind == hash40("punish_attack_lw3") {
        ...
        MotionModule::change_motion(boma, Hash40::new("punish_attack_lw32"), 0.0, 1.0, false, 0.0, false, false);
    }
