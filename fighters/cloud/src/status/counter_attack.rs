...
unsafe extern "C" fn cloud_counter_attack_pre_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    FighterStatusModuleImpl::set_fighter_status_data(boma, false, *FIGHTER_TREADED_KIND_NO_REAC, false, false, false, *FIGHTER_LOG_MASK_FLAG_ACTION_CATEGORY_KEEP as u64, *FIGHTER_STATUS_ATTR_START_TURN as u32, *FIGHTER_POWER_UP_ATTACK_BIT_SPECIAL_LW as u32, 0);
    0.into()
}
...
unsafe extern "C" fn cloud_counter_attack_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    let boma = fighter.module_accessor;
    let lw2_accel_y = WorkModule::get_param_float(boma, hash40("param_special_lw"), hash40("lw2_accel_y"));
    let lw2_speed_max_y = WorkModule::get_param_float(boma, hash40("param_special_lw"), hash40("lw2_speed_max_y"));
...
unsafe extern "C" fn cloud_counter_attack_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if !StatusModule::is_changing(boma) {
        ...
        && prev_situation_kind == *SITUATION_KIND_AIR {
            KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_MOTION);
            GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_GROUND_CLIFF_STOP));
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("punish_counter_attack"), -1.0, 1.0, 0.0, false, false);
        }
        ...
        && prev_situation_kind == *SITUATION_KIND_GROUND {
            ...
            sv_kinetic_energy!(set_accel, fighter, *FIGHTER_KINETIC_ENERGY_ID_GRAVITY, -lw2_accel_y);
            sv_kinetic_energy!(set_stable_speed, fighter, *FIGHTER_KINETIC_ENERGY_ID_GRAVITY, lw2_speed_max_y);
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("punish_aerial_counter_attack"), -1.0, 1.0, 0.0, false, false);
        }
    }
