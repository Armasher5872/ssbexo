...
unsafe extern "C" fn cloud_attack_mtrans_post_process(fighter: &mut L2CFighterCommon) {
    ...
    let punisher_mode = WorkModule::is_flag(boma, *FIGHTER_CLOUD_INSTANCE_WORK_ID_FLAG_PUNISHER_MODE);
    ...
    if count != 1 {
        if count != 2 {
            ...
            MotionModule::change_motion(boma, attack_13_motion, 0.0, 1.0, false, 0.0, false, false);
            ...
            MotionModule::change_motion(boma, attack_12_motion, 0.0, 1.0, false, 0.0, false, false);
            fighter.clear_lua_stack();
            sv_kinetic_energy::set_motion_energy_update_flag(fighter.lua_state_agent);
        ...
        MotionModule::change_motion(boma, attack_11_motion, 0.0, 1.0, false, 0.0, false, false);
