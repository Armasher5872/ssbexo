...
unsafe extern "C" fn cloud_attack_s4_hold_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    let motion = if WorkModule::is_flag(boma, *FIGHTER_CLOUD_INSTANCE_WORK_ID_FLAG_PUNISHER_MODE) {"punish_attack_s4_hold"} else {"attack_s4_hold"};
    ...
    MotionModule::change_motion(boma, Hash40::new(motion), 0.0, s4_hold_frame as f32/ratio, false, 0.0, false, false);
