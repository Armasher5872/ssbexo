...
unsafe extern "C" fn cloud_special_hi_combo_1_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    let boma = fighter.module_accessor;
    MotionModule::change_motion(boma, Hash40::new("special_hi_combo_1"), 0.0, 1.0, false, 0.0, false, false);
...
unsafe extern "C" fn cloud_special_hi_combo_1_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if !StatusModule::is_changing(boma) {
        ...
        && prev_situation_kind == *SITUATION_KIND_GROUND {
            ...
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_hi_combo_1"), -1.0, 1.0, 0.0, false, false);
        }
    }
