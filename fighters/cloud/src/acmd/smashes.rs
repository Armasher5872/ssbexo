...
unsafe extern "C" fn ssbexo_cloud_punisher_forward_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        AttackModule::set_add_reaction_frame_revised(boma, 0, 24.0, false);
        AttackModule::set_add_reaction_frame_revised(boma, 1, 24.0, false);
        AttackModule::set_add_reaction_frame_revised(boma, 2, 24.0, false);
    }
...
unsafe extern "C" fn ssbexo_cloud_punisher_forward_smash_expression(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 13.0);
    sv_animcmd::execute(lua_state, 13.0);
    if is_excute(agent) {
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE, *SLOPE_STATUS_L);
        ItemModule::set_have_item_visibility(boma, false, 0);
    }
...
unsafe extern "C" fn ssbexo_cloud_punisher_up_smash_expression(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 18.0);
    sv_animcmd::execute(lua_state, 18.0);
    if is_excute(agent) {
        AttackModule::set_attack_reference_joint_id(boma, Hash40::new("haver"), AttackDirectionAxis(*ATTACK_DIRECTION_Z), AttackDirectionAxis(*ATTACK_DIRECTION_Y), AttackDirectionAxis(*ATTACK_DIRECTION_X));
        slope!(agent, *MA_MSC_CMD_SLOPE_SLOPE, *SLOPE_STATUS_LR);
        ItemModule::set_have_item_visibility(boma, false, 0);
...
unsafe extern "C" fn ssbexo_cloud_punisher_down_smash_expression(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 12.0);
    sv_animcmd::execute(lua_state, 12.0);
    if is_excute(agent) {
        AttackModule::set_attack_reference_joint_id(boma, Hash40::new("haver"), AttackDirectionAxis(*ATTACK_DIRECTION_Z), AttackDirectionAxis(*ATTACK_DIRECTION_Y), AttackDirectionAxis(*ATTACK_DIRECTION_X));
...
pub fn install() {
    ...
    .acmd("game_punishattacks4charge", ssbexo_cloud_punisher_forward_smash_charge_acmd, Low)
    .acmd("effect_punishattacks4charge", ssbexo_cloud_punisher_forward_smash_charge_effect, Low)
    .acmd("sound_punishattacks4charge", ssbexo_cloud_punisher_forward_smash_charge_sound, Low)
    .acmd("expression_punishattacks4charge", ssbexo_cloud_punisher_forward_smash_charge_expression, Low)
    .acmd("game_punishattacks4", ssbexo_cloud_punisher_forward_smash_acmd, Low)
    .acmd("effect_punishattacks4", ssbexo_cloud_punisher_forward_smash_effect, Low)
    .acmd("sound_punishattacks4", ssbexo_cloud_punisher_forward_smash_sound, Low)
    .acmd("expression_punishattacks4", ssbexo_cloud_punisher_forward_smash_expression, Low)
    .acmd("game_punishattackhi4", ssbexo_cloud_punisher_up_smash_acmd, Low)
    .acmd("effect_punishattackhi4", ssbexo_cloud_punisher_up_smash_effect, Low)
    .acmd("sound_punishattackhi4", ssbexo_cloud_punisher_up_smash_sound, Low)
    .acmd("expression_punishattackhi4", ssbexo_cloud_punisher_up_smash_expression, Low)
    .acmd("game_punishattacklw4charge", ssbexo_cloud_punisher_down_smash_charge_acmd, Low)
    .acmd("effect_punishattacklw4charge", ssbexo_cloud_punisher_down_smash_charge_effect, Low)
    .acmd("sound_punishattacklw4charge", ssbexo_cloud_punisher_down_smash_charge_sound, Low)
    .acmd("expression_punishattacklw4charge", ssbexo_cloud_punisher_down_smash_charge_expression, Low)
    .acmd("game_punishattacklw4", ssbexo_cloud_punisher_down_smash_acmd, Low)
    .acmd("effect_punishattacklw4", ssbexo_cloud_punisher_down_smash_effect, Low)
    .acmd("sound_punishattacklw4", ssbexo_cloud_punisher_down_smash_sound, Low)
    .acmd("expression_punishattacklw4", ssbexo_cloud_punisher_down_smash_expression, Low)
    .install()
    ;
}