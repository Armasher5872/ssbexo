...
unsafe extern "C" fn ssbexo_cloud_punisher_dash_attack_acmd(agent: &mut L2CAgentBase) {
    ...
    if WorkModule::is_flag(boma, *FIGHTER_CLOUD_INSTANCE_WORK_ID_FLAG_CHARGED_ATTACK_DASH) {
...
unsafe extern "C" fn ssbexo_cloud_punisher_dash_attack_expression(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 22.0);
    if is_excute(agent) {
        ControlModule::set_rumble(boma, Hash40::new("rbkind_nohits"), 20, false, *BATTLE_OBJECT_ID_INVALID as u32);
    }
    frame(lua_state, 24.0);
    if is_excute(agent) {
        RUMBLE_HIT(agent, Hash40::new("rbkind_slashs"), 0);
...
pub fn install() {
    ...
    .acmd("game_punishattack11", ssbexo_cloud_punisher_jab_1_acmd, Low)
    .acmd("effect_punishattack11", ssbexo_cloud_punisher_jab_1_effect, Low)
    .acmd("sound_punishattack11", ssbexo_cloud_punisher_jab_1_sound, Low)
    .acmd("expression_punishattack11", ssbexo_cloud_punisher_jab_1_expression, Low)
    .acmd("game_punishattack12", ssbexo_cloud_punisher_jab_2_acmd, Low)
    .acmd("effect_punishattack12", ssbexo_cloud_punisher_jab_2_effect, Low)
    .acmd("sound_punishattack12", ssbexo_cloud_punisher_jab_2_sound, Low)
    .acmd("expression_punishattack12", ssbexo_cloud_punisher_jab_2_expression, Low)
    .acmd("game_punishattack13", ssbexo_cloud_punisher_jab_3_acmd, Low)
    .acmd("effect_punishattack13", ssbexo_cloud_punisher_jab_3_effect, Low)
    .acmd("sound_punishattack13", ssbexo_cloud_punisher_jab_3_sound, Low)
    .acmd("expression_punishattack13", ssbexo_cloud_punisher_jab_3_expression, Low)
    .acmd("game_attackdash", ssbexo_cloud_dash_attack_acmd, Low)
    .acmd("game_punishattackdash", ssbexo_cloud_punisher_dash_attack_acmd, Low)
    .acmd("effect_punishattackdash", ssbexo_cloud_punisher_dash_attack_effect, Low)
    .acmd("sound_punishattackdash", ssbexo_cloud_punisher_dash_attack_sound, Low)
    .acmd("expression_punishattackdash", ssbexo_cloud_punisher_dash_attack_expression, Low)
    .install()
    ;
}