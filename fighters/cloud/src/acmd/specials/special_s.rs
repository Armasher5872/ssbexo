...
unsafe extern "C" fn ssbexo_cloud_grounded_punisher_side_special_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("haver"), 12.0, 38, 100, 0, 28, 5.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CLOUD_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 1, 0, Hash40::new("haver"), 12.0, 38, 100, 0, 28, 5.0, 0.0, 6.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CLOUD_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 2, 0, Hash40::new("haver"), 12.0, 38, 100, 0, 28, 5.0, 0.0, 14.5, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CLOUD_HIT, *ATTACK_REGION_SWORD);
    }
...
pub fn install() {
    ...
    .acmd("game_specials", ssbexo_cloud_grounded_side_special_acmd, Low)
    .acmd("game_specialairs", ssbexo_cloud_aerial_side_special_acmd, Low)
    .acmd("effect_specials", ssbexo_cloud_grounded_side_special_effect, Low)
    .acmd("effect_specialairs", ssbexo_cloud_aerial_side_special_effect, Low)
    .acmd("sound_specials", ssbexo_cloud_grounded_side_special_sound, Low)
    .acmd("sound_specialairs", ssbexo_cloud_aerial_side_special_sound, Low)
    .acmd("expression_specials", ssbexo_cloud_grounded_side_special_expression, Low)
    .acmd("expression_specialairs", ssbexo_cloud_aerial_side_special_expression, Low)
    .acmd("game_punishspecials", ssbexo_cloud_grounded_punisher_side_special_acmd, Low)
    .acmd("game_punishspecialairs", ssbexo_cloud_aerial_punisher_side_special_acmd, Low)
    .acmd("effect_punishspecials", ssbexo_cloud_grounded_punisher_side_special_effect, Low)
    .acmd("effect_punishspecialairs", ssbexo_cloud_aerial_punisher_side_special_effect, Low)
    .acmd("sound_punishspecials", ssbexo_cloud_grounded_punisher_side_special_sound, Low)
    .acmd("sound_punishspecialairs", ssbexo_cloud_aerial_punisher_side_special_sound, Low)
    .acmd("expression_punishspecials", ssbexo_cloud_grounded_punisher_side_special_expression, Low)
    .acmd("expression_punishspecialairs", ssbexo_cloud_aerial_punisher_side_special_expression, Low)
    .install()
    ;
}