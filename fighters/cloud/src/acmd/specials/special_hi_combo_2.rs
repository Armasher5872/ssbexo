...
pub fn install() {
    ...
    .acmd("game_specialhicombo2", ssbexo_cloud_up_special_combo_2_acmd, Low)
    .acmd("effect_specialhicombo2", ssbexo_cloud_up_special_combo_2_effect, Low)
    .acmd("sound_specialhicombo2", ssbexo_cloud_up_special_combo_2_sound, Low)
    .acmd("expression_specialhicombo2", ssbexo_cloud_up_special_combo_2_expression, Low)
    .install()
    ;
}