...
pub fn install() {
    ...
    .acmd("game_specialhicombo2fall", ssbexo_cloud_up_special_combo_2_fall_acmd, Low)
    .acmd("effect_specialhicombo2fall", ssbexo_cloud_up_special_combo_2_fall_effect, Low)
    .acmd("sound_specialhicombo2fall", ssbexo_cloud_up_special_combo_2_fall_sound, Low)
    .acmd("expression_specialhicombo2fall", ssbexo_cloud_up_special_combo_2_fall_expression, Low)
    .install()
    ;
}