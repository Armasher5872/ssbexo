...
unsafe extern "C" fn ssbexo_cloud_grounded_up_special_1_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        WorkModule::on_flag(boma, *FIGHTER_CLOUD_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_DIRECTION_DECIDE);
    }
    frame(lua_state, 4.0);
    if is_excute(agent) {
    ...
    if is_excute(agent) {
        ...
        WorkModule::on_flag(boma, *FIGHTER_CLOUD_INSTANCE_WORK_ID_FLAG_SPECIAL_HI_DIRECTION_CHOSEN);
    }
    frame(lua_state, 12.0);
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("haver"), 3.0, 368, 50, 50, 0, 8.0, 0.0, 6.0, 0.0, Some(0.0), Some(6.0), Some(0.0), 1.0, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CLOUD_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 1, 0, Hash40::new("haver"), 3.0, 368, 50, 50, 0, 8.0, 0.0, 14.5, 0.0, Some(0.0), Some(6.0), Some(0.0), 1.0, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CLOUD_HIT, *ATTACK_REGION_SWORD);
        cloud_set_vec_target_pos(boma, 0, Hash40::new("haver"), Vector2f{x: 11.0, y: 11.0}, 10);
        cloud_set_vec_target_pos(boma, 1, Hash40::new("haver"), Vector2f{x: 11.0, y: 11.0}, 15);
    ...
    if is_excute(agent) {
        let angle = WorkModule::get_int(boma, *FIGHTER_CLOUD_INSTANCE_WORK_ID_INT_SPECIAL_HI_ATTACK_ANGLE) as u64;
        FT_MOTION_RATE(agent, 1.0);
        ATTACK(agent, 0, 0, Hash40::new("haver"), 4.0, angle, 100, 80, 0, 8.0, 0.0, 6.0, 0.0, Some(0.0), Some(6.0), Some(0.0), 1.0, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CLOUD_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 1, 0, Hash40::new("haver"), 4.0, angle, 100, 80, 0, 8.0, 0.0, 14.5, 0.0, Some(0.0), Some(6.0), Some(0.0), 1.0, 0.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CLOUD_HIT, *ATTACK_REGION_SWORD);
    }
...
pub fn install() {
    ...
    .acmd("game_specialhi", ssbexo_cloud_grounded_up_special_1_acmd, Low)
    .acmd("game_specialairhi", ssbexo_cloud_aerial_up_special_1_acmd, Low)
    .acmd("effect_specialhi", ssbexo_cloud_up_special_1_effect, Low)
    .acmd("effect_specialairhi", ssbexo_cloud_up_special_1_effect, Low)
    .acmd("sound_specialhi", ssbexo_cloud_up_special_1_sound, Low)
    .acmd("sound_specialairhi", ssbexo_cloud_up_special_1_sound, Low)
    .acmd("expression_specialhi", ssbexo_cloud_up_special_1_expression, Low)
    .acmd("expression_specialairhi", ssbexo_cloud_up_special_1_expression, Low)
    .install()
    ;
}