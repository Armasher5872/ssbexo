...
unsafe extern "C" fn roy_special_hi_4_pre_status(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    ...
    .status(Pre, *FIGHTER_ROY_STATUS_KIND_SPECIAL_HI_4, roy_special_hi_4_pre_status)
    .install()
    ;
}