...
unsafe extern "C" fn littlemac_status_attack_hi4_hold_common(fighter: &mut L2CFighterCommon, motion_kind: L2CValue) -> L2CValue {
    ...
    let hi4_hold_frame = WorkModule::get_param_int(boma, hash40("attack_hi4_hold_frame"), 0);
    let keep_frame = WorkModule::get_param_int(boma, hash40("attack_hi4_hold_keep_frame"), 0);
    ...
    MotionModule::change_motion(boma, motion_kind.get_hash(), 0.0, hi4_hold_frame as f32/ratio, false, 0.0, false, false);
