...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_littlemac_forward_tilt_1_acmd, Low)
    .acmd("effect_attacks3", ssbexo_littlemac_forward_tilt_1_effect, Low)
    .acmd("sound_attacks3", ssbexo_littlemac_forward_tilt_1_sound, Low)
    .acmd("expression_attacks3", ssbexo_littlemac_forward_tilt_1_expression, Low)
    .acmd("game_attacks32", ssbexo_littlemac_forward_tilt_2_acmd, Low)
    .acmd("effect_attacks32", ssbexo_littlemac_forward_tilt_2_effect, Low)
    .acmd("sound_attacks32", ssbexo_littlemac_forward_tilt_2_sound, Low)
    .acmd("expression_attacks32", ssbexo_littlemac_forward_tilt_2_expression, Low)
    .acmd("game_attackhi3", ssbexo_littlemac_up_tilt_acmd, Low)
    .acmd("effect_attackhi3", ssbexo_littlemac_up_tilt_effect, Low)
    .acmd("sound_attackhi3", ssbexo_littlemac_up_tilt_sound, Low)
    .acmd("expression_attackhi3", ssbexo_littlemac_up_tilt_expression, Low)
    .acmd("game_attacklw3", ssbexo_littlemac_down_tilt_acmd, Low)
    .install()
    ;
}