...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_littlemac_nair_acmd, Low)
    .acmd("game_attackairf", ssbexo_littlemac_fair_acmd, Low)
    .acmd("effect_attackairf", ssbexo_littlemac_fair_effect, Low)
    .acmd("sound_attackairf", ssbexo_littlemac_fair_sound, Low)
    .acmd("expression_attackairf", ssbexo_littlemac_fair_expression, Low)
    .acmd("game_attackairb", ssbexo_littlemac_bair_acmd, Low)
    .acmd("effect_attackairb", ssbexo_littlemac_bair_effect, Low)
    .acmd("sound_attackairb", ssbexo_littlemac_bair_sound, Low)
    .acmd("expression_attackairb", ssbexo_littlemac_bair_expression, Low)
    .acmd("game_attackairhi", ssbexo_littlemac_uair_acmd, Low)
    .acmd("effect_attackairhi", ssbexo_littlemac_uair_effect, Low)
    .acmd("sound_attackairhi", ssbexo_littlemac_uair_sound, Low)
    .acmd("expression_attackairhi", ssbexo_littlemac_uair_expression, Low)
    .acmd("game_attackairlw", ssbexo_littlemac_dair_acmd, Low)
    .acmd("effect_attackairlw", ssbexo_littlemac_dair_effect, Low)
    .acmd("sound_attackairlw", ssbexo_littlemac_dair_sound, Low)
    .acmd("expression_attackairlw", ssbexo_littlemac_dair_expression, Low)
    .install()
    ;
}