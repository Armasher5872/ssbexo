...
pub fn install() {
    ...
    .acmd("game_specialhi", ssbexo_metaknight_up_special_acmd, Low)
    .acmd("effect_specialhi", ssbexo_metaknight_up_special_effect, Low)
    .acmd("sound_specialhi", ssbexo_metaknight_up_special_sound, Low)
    .install()
    ;
}