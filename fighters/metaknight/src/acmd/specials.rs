...
unsafe extern "C" fn ssbexo_metaknight_galaxia_beam_grounded_fire_sound(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        PLAY_SE(agent, Hash40::new("se_metaknight_jump01"));
    } 
    frame(agent.lua_state_agent, 16.0);
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_metaknight_galaxia_beam_effect(agent: &mut L2CAgentBase) {
    ...
    || StatusModule::situation_kind(agent.module_accessor) == *SITUATION_KIND_AIR {
        if is_excute(agent) {
            EFFECT_FOLLOW(agent, Hash40::new("miiswordsman_final_edge_yellow"), Hash40::new("rot"), 0, 0, 0, 45, 0, 0, 500, true);
        }
    }
    else {
        if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_metaknight_glide_start_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        LAST_EFFECT_SET_COLOR(agent, /*R*/ 0.68, /*G*/ 0.87, /*B*/ 2.0);
    }
}
...
unsafe extern "C" fn ssbexo_metaknight_glide_start_sound(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 18.0);
    if is_excute(agent) {
        PLAY_SE_REMAIN(agent, Hash40::new("se_metaknight_glide_start")); //Index 112
    }
    frame(agent.lua_state_agent, 19.0);
    if is_excute(agent) {
        PLAY_SE_REMAIN(agent, Hash40::new("se_metaknight_glide_loop")); //Index 113
    }
}
...
pub fn install() {
    ...
    .game_acmd("game_specialnspin", ssbexo_metaknight_neutral_special_spin_acmd, Low)
    .game_acmd("game_specialnend", ssbexo_metaknight_neutral_special_end_acmd, Low)
    .game_acmd("game_specialairnend", ssbexo_metaknight_neutral_special_end_acmd, Low)
    .game_acmd("game_specialsstart", ssbexo_metaknight_galaxia_beam_fire_acmd, Low)
    .effect_acmd("effect_specialsstart", ssbexo_metaknight_galaxia_beam_grounded_fire_effect, Low)
    .sound_acmd("sound_specialsstart", ssbexo_metaknight_galaxia_beam_grounded_fire_sound, Low)
    .expression_acmd("expression_specialsstart", ssbexo_metaknight_galaxia_beam_grounded_fire_expression, Low)
    .game_acmd("game_specialairsstart", ssbexo_metaknight_galaxia_beam_fire_acmd, Low)
    .effect_acmd("effect_specialairsstart", ssbexo_metaknight_galaxia_beam_aerial_fire_effect, Low)
    .sound_acmd("sound_specialairsstart", ssbexo_metaknight_galaxia_beam_aerial_fire_sound, Low)
    .expression_acmd("expression_specialairsstart", ssbexo_metaknight_galaxia_beam_aerial_fire_expression, Low)
    ...
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_shoot", ssbexo_metaknight_galaxia_beam_acmd, Low)
    .effect_acmd("effect_shoot", ssbexo_metaknight_galaxia_beam_effect, Low)
    .sound_acmd("sound_shoot", ssbexo_metaknight_galaxia_beam_sound, Low)
    .install()
    ;
}