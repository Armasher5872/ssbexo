...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_metaknight_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_metaknight_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_metaknight_pivot_grab_acmd, Low)
    .install()
    ;
}