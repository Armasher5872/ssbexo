...
pub fn install() {
    ...
    .game_acmd("game_attacks3", ssbexo_wolf_forward_tilt_f_acmd, Low)
    .game_acmd("game_attacks3hi", ssbexo_wolf_forward_tilt_hi_acmd, Low)
    .game_acmd("game_attacks3lw", ssbexo_wolf_forward_tilt_lw_acmd, Low)
    .game_acmd("game_attackhi3", ssbexo_wolf_up_tilt_acmd, Low)
    .effect_acmd("effect_attackhi3", ssbexo_wolf_up_tilt_effect, Low)
    .sound_acmd("sound_attackhi3", ssbexo_wolf_up_tilt_sound, Low)
    .expression_acmd("expression_attackhi3", ssbexo_wolf_up_tilt_expression, Low)
    .game_acmd("game_attacklw3", ssbexo_wolf_down_tilt_acmd, Low)
    .install()
    ;
}