...
pub fn install() {
    ...
    .acmd("game_specialn", ssbexo_wolf_grounded_neutral_special_acmd, Low)
    .acmd("game_specialairn", ssbexo_wolf_aerial_neutral_special_acmd, Low)
    .acmd("game_specialsend", ssbexo_wolf_side_special_end_acmd, Low)
    .acmd("game_specialairsend", ssbexo_wolf_side_special_end_acmd, Low)
    .install()
    ;
    Agent::new("wolf_blaster_bullet")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_fly", ssbexo_wolf_blaster_bullet_fly_acmd, Low)
    .install()
    ;
}