...
unsafe extern "C" fn ssbexo_samusd_neutral_special_start_acmd(agent: &mut L2CAgentBase) {
    ...
    if !IS_EXIST_ARTICLE(agent, *FIGHTER_SAMUSD_GENERATE_ARTICLE_CSHOT) {
        if is_excute(agent) {
            ArticleModule::generate_article_enable(boma, *FIGHTER_SAMUSD_GENERATE_ARTICLE_CSHOT, false, 0);
...
unsafe extern "C" fn ssbexo_samusd_charge_shot_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        AttackModule::set_poison_param(boma, 0, 600, 15, 0.2, false);
        AttackModule::set_poison_param(boma, 1, 600, 15, 0.2, false);
        AttackModule::set_paralyze_frame(boma, 2, 25, false);
        AttackModule::set_attack_level(boma, 3, *FIGHTER_RYU_SAVING_LV_3 as u8);
...
unsafe extern "C" fn ssbexo_samusd_super_missile_initial_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        AttackModule::enable_safe_pos(boma);
        AttackModule::set_poison_param(boma, 0, 1200, 15, 0.2, false);
    }
}
...
pub fn install() {
    ...
    .acmd("game_specialnstart", ssbexo_samusd_neutral_special_start_acmd, Low)
    .acmd("game_specialairnstart", ssbexo_samusd_neutral_special_start_acmd, Low)
    .acmd("game_specialhi", ssbexo_samusd_up_special_acmd, Low)
    .acmd("game_specialairhi", ssbexo_samusd_up_special_acmd, Low)
    .acmd("effect_specialhi", ssbexo_samusd_up_special_effect, Low)
    .acmd("effect_specialairhi", ssbexo_samusd_up_special_effect, Low)
    .acmd("sound_specialhi", ssbexo_samusd_up_special_sound, Low)
    .acmd("sound_specialairhi", ssbexo_samusd_up_special_sound, Low)
    .acmd("expression_specialhi", ssbexo_samusd_up_special_expression, Low)
    .acmd("expression_specialairhi", ssbexo_samusd_up_special_expression, Low)
    .acmd("game_specialairhiappeal", ssbexo_samusd_up_special_taunt_acmd, Low)
    .acmd("effect_specialairhiappeal", ssbexo_samusd_up_special_taunt_effect, Low)
    .acmd("sound_specialairhiappeal", ssbexo_samusd_up_special_taunt_sound, Low)
    .acmd("expression_specialairhiappeal", ssbexo_samusd_up_special_taunt_expression, Low)
    .install()
    ;
    Agent::new("samusd_cshot")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_shoot", ssbexo_samusd_charge_shot_acmd, Low)
    .install()
    ;
    Agent::new("samusd_missile")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_homing", ssbexo_samusd_missile_acmd, Low)
    .acmd("effect_hburst", ssbexo_samusd_missile_effect, Low)
    .install()
    ;
    Agent::new("samusd_supermissile")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_ready", ssbexo_samusd_super_missile_initial_acmd, Low)
    .acmd("game_straight", ssbexo_samusd_super_missile_fire_acmd, Low)
    .acmd("effect_sburst", ssbexo_samusd_super_missile_effect, Low)
    .install()
    ;
    Agent::new("samusd_bomb")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_fall", ssbexo_samusd_bomb_fall_acmd, Low)
    .acmd("game_burstattack", ssbexo_samusd_bomb_burst_attack_acmd, Low)
    .acmd("effect_burstattack", ssbexo_samusd_bomb_burst_attack_effect, Low)
    .acmd("expression_burstattack", ssbexo_samusd_bomb_burst_attack_expression, Low)
    .install()
    ;
}