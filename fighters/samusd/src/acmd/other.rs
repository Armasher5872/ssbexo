...
pub fn install() {
    ...
    .game_acmd("game_finalstart", ssbexo_samusd_final_smash_start_acmd, Low)
    .game_acmd("game_finalairstart", ssbexo_samusd_final_smash_start_acmd, Low)
    .game_acmd("game_final", ssbexo_samusd_final_smash_acmd, Low)
    .game_acmd("game_finalair", ssbexo_samusd_final_smash_acmd, Low)
    .install()
    ;
    Agent::new("samusd_laser")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_shoot", ssbexo_samusd_laser_shoot_acmd, Low)
    .install()
    ;
    Agent::new("samusd_laser2")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_lower", ssbexo_samusd_laser_2_lower_acmd, Low)
    .game_acmd("game_upper", ssbexo_samusd_laser_2_upper_acmd, Low)
    .install()
    ;
}