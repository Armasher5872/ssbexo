...
pub fn install() {
    ...
    .game_acmd("game_attacks3", ssbexo_samusd_forward_tilt_acmd, Low)
    .game_acmd("game_attacks3hi", ssbexo_samusd_forward_tilt_acmd, Low)
    .game_acmd("game_attacks3lw", ssbexo_samusd_forward_tilt_acmd, Low)
    .effect_acmd("effect_attacks3", ssbexo_samusd_forward_tilt_effect, Low)
    .effect_acmd("effect_attacks3hi", ssbexo_samusd_forward_tilt_effect, Low)
    .effect_acmd("effect_attacks3lw", ssbexo_samusd_forward_tilt_effect, Low)
    .sound_acmd("sound_attacks3", ssbexo_samusd_forward_tilt_sound, Low)
    .sound_acmd("sound_attacks3hi", ssbexo_samusd_forward_tilt_sound, Low)
    .sound_acmd("sound_attacks3lw", ssbexo_samusd_forward_tilt_sound, Low)
    .game_acmd("game_attackhi3", ssbexo_samusd_up_tilt_acmd, Low)
    .effect_acmd("effect_attackhi3", ssbexo_samusd_up_tilt_effect, Low)
    .game_acmd("game_attacklw3", ssbexo_samusd_down_tilt_acmd, Low)
    .effect_acmd("effect_attacklw3", ssbexo_samusd_down_tilt_effect, Low)
    .install()
    ;
}