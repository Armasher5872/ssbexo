...
pub fn install() {
    ...
    .game_acmd("game_catch", ssbexo_samusd_grab_acmd, Low)
    .game_acmd("game_catchdash", ssbexo_samusd_dash_grab_acmd, Low)
    .game_acmd("game_catchturn", ssbexo_samusd_pivot_grab_acmd, Low)
    .game_acmd("game_catchattack", ssbexo_samusd_pummel_acmd, Low)
    .game_acmd("game_throwf", ssbexo_samusd_forward_throw_acmd, Low)
    .effect_acmd("effect_throwf", ssbexo_samusd_forward_throw_effect, Low)
    .sound_acmd("sound_throwf", ssbexo_samusd_forward_throw_sound, Low)
    .game_acmd("game_throwb", ssbexo_samusd_back_throw_acmd, Low)
    .effect_acmd("effect_throwb", ssbexo_samusd_back_throw_effect, Low)
    .sound_acmd("sound_throwb", ssbexo_samusd_back_throw_sound, Low)
    .game_acmd("game_throwhi", ssbexo_samusd_up_throw_acmd, Low)
    .effect_acmd("effect_throwhi", ssbexo_samusd_up_throw_effect, Low)
    .sound_acmd("sound_throwhi", ssbexo_samusd_up_throw_sound, Low)
    .install()
    ;
}