...
unsafe extern "C" fn ssbexo_gamewatch_judge_2_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        ATTACK(agent, 1, 0, Hash40::new("top"), 4.0, 361, 40, 0, 10, 3.0, 0.0, 7.0, 5.6, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 1.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_OBJECT);
    }
}
...
pub fn install() {
    ...
    .game_acmd("game_specials1_sub", ssbexo_gamewatch_judge_1_acmd, Low)
    .game_acmd("game_specials2_sub", ssbexo_gamewatch_judge_2_acmd, Low)
    .game_acmd("game_specials9_sub", ssbexo_gamewatch_judge_9_acmd, Low)
    .game_acmd("game_specialhi", ssbexo_gamewatch_grounded_up_special_acmd, Low)
    .game_acmd("game_specialairhi", ssbexo_gamewatch_aerial_up_special_acmd, Low)
    .install()
    ;
}