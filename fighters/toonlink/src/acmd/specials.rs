...
unsafe extern "C" fn ssbexo_toonlink_grounded_neutral_special_start_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        FOOT_EFFECT(agent, Hash40::new("sys_run_smoke"), Hash40::new("top"), 0, 0, -2, 0, 0, 0, 1, 3, 0, 5, 0, 0, 0, true);
    }
}
...
unsafe extern "C" fn ssbexo_toonlink_neutral_special_start_sound(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        PLAY_STATUS(agent, Hash40::new("se_toonlink_special_n01"));
    }
}
...
unsafe extern "C" fn ssbexo_toonlink_wind_blast_fly_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("sys_flyroll_smoke"), Hash40::new("root"), 0, 0, 0, 0, 0, 0, 1000, true);
    }
}
...
unsafe extern "C" fn ssbexo_toonlink_wind_blast_hit_stick_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("sys_erace_smoke"), Hash40::new("root"), 0, 0, 0, 0, 0, 0, 1000, true);
        EFFECT_FOLLOW(agent, Hash40::new("sys_steam3"), Hash40::new("root"), 0, 0, 0, 0, 0, 0, 1000, true);
    }
}
...
unsafe extern "C" fn ssbexo_toonlink_grounded_up_special_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 4, 0, Hash40::new("sword2"), 1.0, 180, 100, 50, 0, 3.0, -1.5, 0.0, -1.0, None, None, None, 0.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 3, 0, Hash40::new("sword2"), 1.0, 180, 100, 50, 0, 3.0, 2.0, 0.0, -1.0, None, None, None, 0.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 0, 0, Hash40::new("sword2"), 1.0, 180, 100, 50, 0, 2.7, 5.5, 0.0, -1.0, None, None, None, 0.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 1, 0, Hash40::new("top"), 1.0, 80, 100, 10, 0, 2.5, 0.0, 3.5, 0.0, None, None, None, 0.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 2, 0, Hash40::new("top"), 1.0, 355, 100, 10, 0, 1.5, 0.0, 9.5, 1.6, Some(0.0), Some(5.0), Some(1.6), 0.3, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 4, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
    }
    frame(agent.lua_state_agent, 13.0);
    if is_excute(agent) {
        ATTACK(agent, 4, 0, Hash40::new("sword2"), 1.0, 180, 100, 40, 0, 3.0, -1.5, 0.0, -1.0, None, None, None, 0.3, 0.8, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 5, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 3, 0, Hash40::new("sword2"), 1.0, 180, 100, 40, 0, 3.0, 2.0, 0.0, -1.0, None, None, None, 0.3, 0.8, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 5, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 0, 0, Hash40::new("sword2"), 1.0, 180, 100, 30, 0, 2.7, 5.5, 0.0, -1.0, None, None, None, 0.3, 0.8, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 5, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
        ATTACK(agent, 1, 0, Hash40::new("top"), 1.0, 80, 100, 10, 0, 2.5, 0.0, 3.5, 0.0, None, None, None, 0.3, 0.8, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 5, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_TOONLINK_HIT, *ATTACK_REGION_SWORD);
    }
...
pub fn install() {
    ...
    .game_acmd("game_specialnstart", ssbexo_toonlink_neutral_special_start_acmd, Low)
    .effect_acmd("effect_specialnstart", ssbexo_toonlink_grounded_neutral_special_start_effect, Low)
    .sound_acmd("sound_specialnstart", ssbexo_toonlink_neutral_special_start_sound, Low)
    .expression_acmd("expression_specialnstart", ssbexo_toonlink_neutral_special_start_expression, Low)
    .game_acmd("game_specialairnstart", ssbexo_toonlink_neutral_special_start_acmd, Low)
    .effect_acmd("effect_specialairnstart", ssbexo_toonlink_aerial_neutral_special_start_effect, Low)
    .sound_acmd("sound_specialairnstart", ssbexo_toonlink_neutral_special_start_sound, Low)
    .expression_acmd("expression_specialairnstart", ssbexo_toonlink_neutral_special_start_expression, Low)
    .game_acmd("game_specialnend", ssbexo_toonlink_neutral_special_end_acmd, Low)
    .game_acmd("game_specialairnend", ssbexo_toonlink_neutral_special_end_acmd, Low)
    .expression_acmd("expression_specialnend", ssbexo_toonlink_neutral_special_end_expression, Low)
    .expression_acmd("expression_specialairnend", ssbexo_toonlink_neutral_special_end_expression, Low)
    .game_acmd("game_specialhi", ssbexo_toonlink_grounded_up_special_acmd, Low)
    .game_acmd("game_specialairhi", ssbexo_toonlink_aerial_up_special_acmd, Low)
    .install()
    ;
    Agent::new("toonlink_bowarrow")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_fly", ssbexo_toonlink_wind_blast_fly_acmd, Low)
    .effect_acmd("effect_fly", ssbexo_toonlink_wind_blast_fly_effect, Low)
    .game_acmd("game_hitstick", ssbexo_toonlink_wind_blast_hit_stick_acmd, Low)
    .effect_acmd("effect_hitstick", ssbexo_toonlink_wind_blast_hit_stick_effect, Low)
    .install()
    ;
}