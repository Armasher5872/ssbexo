...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_kirby_forward_tilt_acmd, Low)
    .acmd("game_attacks3hi", ssbexo_kirby_forward_tilt_acmd, Low)
    .acmd("game_attacks3lw", ssbexo_kirby_forward_tilt_acmd, Low)
    .acmd("effect_attacks3", ssbexo_kirby_forward_tilt_effect, Low)
    .acmd("effect_attacks3hi", ssbexo_kirby_forward_tilt_effect, Low)
    .acmd("effect_attacks3lw", ssbexo_kirby_forward_tilt_effect, Low)
    .acmd("effect_attackhi3", ssbexo_kirby_up_tilt_effect, Low)
    .acmd("game_attacklw3", ssbexo_kirby_down_tilt_acmd, Low)
    .acmd("effect_attacklw3", ssbexo_kirby_down_tilt_effect, Low)
    .install()
    ;
}