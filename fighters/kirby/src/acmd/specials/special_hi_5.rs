...
pub fn install() {
    ...
    .acmd("game_specialhi5", ssbexo_kirby_up_special_5_acmd, Low)
    .acmd("effect_specialhi5", ssbexo_kirby_up_special_5_effect, Low)
    .acmd("sound_specialhi5", ssbexo_kirby_up_special_5_sound, Low)
    .acmd("expression_specialhi5", ssbexo_kirby_up_special_5_expression, Low)
    .install()
    ;
}