...
unsafe extern "C" fn kirby_special_hi_4_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    WorkModule::set_int64(boma, hash40("special_hi4") as i64, *FIGHTER_KIRBY_STATUS_WORK_ID_INT_FINALCUTTER_GROUND_MOT);
    WorkModule::set_int64(boma, hash40("special_hi4") as i64, *FIGHTER_KIRBY_STATUS_WORK_ID_INT_FINALCUTTER_AIR_MOT);
