...
pub unsafe extern "C" fn miifighter_special_s1_end_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if start_situation != *SITUATION_KIND_GROUND {
        MotionModule::change_motion(boma, Hash40::new("special_air_s1_end"), 0.0, 1.0, false, 0.0, false, false);
        fun_7100020d60(fighter);
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_AIR_STOP);
    }
    else {
        MotionModule::change_motion(boma, Hash40::new("special_s1_end"), 0.0, 1.0, false, 0.0, false, false);
        fun_7100020b40(fighter);
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_GROUND_STOP);
    }
    WorkModule::off_flag(boma, *FIGHTER_MIIFIGHTER_STATUS_WORK_ID_FLAG_100KICK_ENABLE_LANDING);
...
unsafe extern "C" fn miifighter_special_s1_end_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && situation_kind == *SITUATION_KIND_GROUND {
        if WorkModule::is_flag(boma, *FIGHTER_MIIFIGHTER_STATUS_WORK_ID_FLAG_100KICK_ENABLE_LANDING) {
