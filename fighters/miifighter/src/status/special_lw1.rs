...
unsafe extern "C" fn miifighter_special_lw1_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && prev_situation_kind == *SITUATION_KIND_AIR {
        ...
        GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_GROUND_CLIFF_STOP));
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_MOTION);
        MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_lw1"), -1.0, 1.0, 0.0, false, false);
    }
    ...
    && prev_situation_kind == *SITUATION_KIND_GROUND {
        ...
        GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_AIR));
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_FALL);
        MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_lw1"), -1.0, 1.0, 0.0, false, false);
    }
