...
unsafe extern "C" fn miifighter_special_n3_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && prev_situation_kind == *SITUATION_KIND_AIR {
        ...
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_MOTION);
        MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_n3"), -1.0, 1.0, 0.0, false, false);
    }
    if situation_kind == *SITUATION_KIND_AIR
    && prev_situation_kind == *SITUATION_KIND_GROUND {
        GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_AIR));
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_MOTION_AIR);
        MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_n3"), -1.0, 1.0, 0.0, false, false);
    }
