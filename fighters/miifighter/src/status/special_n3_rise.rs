...
pub unsafe extern "C" fn miifighter_special_n3_rise_pre_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    StatusModule::init_settings(boma, SituationKind(*SITUATION_KIND_AIR), *FIGHTER_KINETIC_TYPE_MOTION_AIR, *GROUND_CORRECT_KIND_AIR as u32, GroundCliffCheckKind(*GROUND_CLIFF_CHECK_KIND_ALWAYS_BOTH_SIDES), true, *FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_FLAG, *FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_INT, *FIGHTER_STATUS_WORK_KEEP_FLAG_NONE_FLOAT, 0);
...
pub unsafe extern "C" fn miifighter_special_n3_rise_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    let boma = fighter.module_accessor;
    MotionModule::change_motion(boma, Hash40::new("special_n3_rise"), 0.0, 1.0, false, 0.0, false, false);
...
unsafe extern "C" fn miifighter_special_n3_rise_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && prev_situation_kind == *SITUATION_KIND_GROUND {
        ...
        MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_n3_rise"), -1.0, 1.0, 0.0, false, false);
    }
