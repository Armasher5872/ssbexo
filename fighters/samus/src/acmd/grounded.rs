...
pub fn install() {
    ...
    .acmd("effect_jumpfrontmini", ssbexo_samus_forward_shorthop_effect, Low)
    .acmd("effect_jumpbackmini", ssbexo_samus_backward_shorthop_effect, Low)
    .acmd("game_attack11", ssbexo_samus_jab_acmd, Low)
    .acmd("game_attackdash", ssbexo_samus_dash_attack_acmd, Low)
    .install()
    ;
}