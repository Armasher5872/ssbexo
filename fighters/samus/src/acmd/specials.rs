...
pub fn install() {
    ...
    .acmd("game_specialhi", ssbexo_samus_grounded_up_special_acmd, Low)
    .acmd("game_specialairhi", ssbexo_samus_aerial_up_special_acmd, Low)
    .install()
    ;
    Agent::new("samus_cshot")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_shoot", ssbexo_samus_charge_shot_shoot_acmd, Low)
    .install()
    ;
    Agent::new("samus_missile")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_homing", ssbexo_samus_homing_missile_homing_acmd, Low)
    .acmd("effect_homing", ssbexo_samus_homing_missile_homing_effect, Low)
    .install()
    ;
    Agent::new("samus_supermissile")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .acmd("game_ready", ssbexo_samus_super_missile_ready_acmd, Low)
    .acmd("game_straight", ssbexo_samus_super_missile_straight_acmd, Low)
    .install()
    ;
}