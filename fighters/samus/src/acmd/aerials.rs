...
pub fn install() {
    ...
    .game_acmd("game_attackairf", ssbexo_samus_fair_acmd, Low)
    .effect_acmd("effect_attackairf", ssbexo_samus_fair_effect, Low)
    .game_acmd("game_aircatch", ssbexo_samus_zair_acmd, Low)
    .install()
    ;
}