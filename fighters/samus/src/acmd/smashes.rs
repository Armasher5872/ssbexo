...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_samus_forward_smash_acmd, Low)
    .acmd("game_attacks4hi", ssbexo_samus_forward_smash_acmd, Low)
    .acmd("game_attacks4lw", ssbexo_samus_forward_smash_acmd, Low)
    .acmd("effect_attacks4", ssbexo_samus_forward_smash_effect, Low)
    .acmd("effect_attacks4hi", ssbexo_samus_forward_smash_hi_effect, Low)
    .acmd("effect_attacks4lw", ssbexo_samus_forward_smash_lw_effect, Low)
    .acmd("game_attackhi4", ssbexo_samus_up_smash_acmd, Low)
    .acmd("effect_attackhi4", ssbexo_samus_up_smash_effect, Low)
    .install()
    ;
}