...
unsafe extern "C" fn ssbexo_samus_forward_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 0, 0, Hash40::new("armr"), 12.0, 361, 112, 0, 16, 3.3, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 1, 0, Hash40::new("armr"), 12.0, 361, 112, 0, 16, 3.3, -4.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 2, 0, Hash40::new("armr"), 14.0, 361, 100, 0, 40, 4.5, 7.5, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_ice"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_FIRE, *ATTACK_REGION_PUNCH);
    }
...
unsafe extern "C" fn ssbexo_samus_forward_smash_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        LAST_EFFECT_SET_COLOR(agent, 0.604, 1.0, 1.0);
    }
}
...
pub fn install() {
    ...
    .game_acmd("game_attacks4", ssbexo_samus_forward_smash_acmd, Low)
    .game_acmd("game_attacks4hi", ssbexo_samus_forward_smash_acmd, Low)
    .game_acmd("game_attacks4lw", ssbexo_samus_forward_smash_acmd, Low)
    .effect_acmd("effect_attacks4", ssbexo_samus_forward_smash_effect, Low)
    .effect_acmd("effect_attacks4hi", ssbexo_samus_forward_smash_hi_effect, Low)
    .effect_acmd("effect_attacks4lw", ssbexo_samus_forward_smash_lw_effect, Low)
    .game_acmd("game_attackhi4", ssbexo_samus_up_smash_acmd, Low)
    .effect_acmd("effect_attackhi4", ssbexo_samus_up_smash_effect, Low)
    .install()
    ;
}