...
unsafe extern "C" fn ssbexo_palutena_grounded_up_special_start_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        EFFECT_FOLLOW(agent, Hash40::new("palutena_appeal_twinkle"), Hash40::new("footr"), 0, 0, 0, 0, 0, 0, 0.7, true);
        EFFECT_FOLLOW(agent, Hash40::new("palutena_appeal_twinkle"), Hash40::new("footl"), 0, 0, 0, 0, 0, 0, 0.7, true);
    }
...
unsafe extern "C" fn ssbexo_palutena_up_special_start_sound(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        PLAY_SE(agent, Hash40::new("vc_palutena_special_h01"));
    }
}
...
unsafe extern "C" fn ssbexo_palutena_up_special_glide_effect(agent: &mut L2CAgentBase) {
    for _ in 0..i32::MAX {
        if is_excute(agent) {
            ...
            EFFECT_OFF_KIND(agent, Hash40::new("palutena_backlight"), false, false);
            EFFECT_FOLLOW(agent, Hash40::new("palutena_appeal_twinkle"), Hash40::new("footr"), 0, 0, 0, 0, 0, 0, 0.7, true);
            EFFECT_FOLLOW(agent, Hash40::new("palutena_appeal_twinkle"), Hash40::new("footl"), 0, 0, 0, 0, 0, 0, 0.7, true);
            EFFECT_FOLLOW_ALPHA(agent, Hash40::new("palutena_backlight"), Hash40::new("top"), 0, 21.5, -1, 0, -90, 0, 1, true, 0.7);
        }
...
unsafe extern "C" fn ssbexo_palutena_down_special_sound(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        PLAY_SE(agent, Hash40::new("vc_palutena_special_l01"));
    }
    frame(agent.lua_state_agent, 20.0);
    if is_excute(agent) {
...
pub fn install() {
    ...
    .game_acmd("game_specialn", ssbexo_palutena_neutral_special_acmd, Low)
    .game_acmd("game_specialairn", ssbexo_palutena_neutral_special_acmd, Low)
    .effect_acmd("effect_specialn", ssbexo_palutena_grounded_neutral_special_effect, Low)
    .effect_acmd("effect_specialairn", ssbexo_palutena_aerial_neutral_special_effect, Low)
    .sound_acmd("sound_specialn", ssbexo_palutena_neutral_special_sound, Low)
    .sound_acmd("sound_specialairn", ssbexo_palutena_neutral_special_sound, Low)
    .expression_acmd("expression_specialn", ssbexo_palutena_neutral_special_expression, Low)
    .expression_acmd("expression_specialairn", ssbexo_palutena_neutral_special_expression, Low)
    .game_acmd("game_specials", ssbexo_palutena_side_special_acmd, Low)
    .game_acmd("game_specialairs", ssbexo_palutena_side_special_acmd, Low)
    .effect_acmd("effect_specials", ssbexo_palutena_grounded_side_special_effect, Low)
    .effect_acmd("effect_specialairs", ssbexo_palutena_aerial_side_special_effect, Low)
    .sound_acmd("sound_specials", ssbexo_palutena_side_special_sound, Low)
    .sound_acmd("sound_specialairs", ssbexo_palutena_side_special_sound, Low)
    .expression_acmd("expression_specials", ssbexo_palutena_side_special_expression, Low)
    .expression_acmd("expression_specialairs", ssbexo_palutena_side_special_expression, Low)
    .game_acmd("game_specialhistart", ssbexo_palutena_up_special_start_acmd, Low)
    .game_acmd("game_specialairhistart", ssbexo_palutena_up_special_start_acmd, Low)
    .effect_acmd("effect_specialhistart", ssbexo_palutena_grounded_up_special_start_effect, Low)
    .effect_acmd("effect_specialairhistart", ssbexo_palutena_aerial_up_special_start_effect, Low)
    .sound_acmd("sound_specialhistart", ssbexo_palutena_up_special_start_sound, Low)
    .sound_acmd("sound_specialairhistart", ssbexo_palutena_up_special_start_sound, Low)
    .expression_acmd("expression_specialhistart", ssbexo_palutena_up_special_start_expression, Low)
    .expression_acmd("expression_specialairhistart", ssbexo_palutena_up_special_start_expression, Low)
    .game_acmd("game_specialhi", ssbexo_palutena_up_special_glide_acmd, Low)
    .game_acmd("game_specialairhi", ssbexo_palutena_up_special_glide_acmd, Low)
    .effect_acmd("effect_specialhi", ssbexo_palutena_up_special_glide_effect, Low)
    .effect_acmd("effect_specialairhi", ssbexo_palutena_up_special_glide_effect, Low)
    .sound_acmd("sound_specialhi", ssbexo_palutena_up_special_glide_sound, Low)
    .sound_acmd("sound_specialairhi", ssbexo_palutena_up_special_glide_sound, Low)
    .expression_acmd("expression_specialhi", ssbexo_palutena_up_special_glide_expression, Low)
    .expression_acmd("expression_specialairhi", ssbexo_palutena_up_special_glide_expression, Low)
    .game_acmd("game_specialhiturn", ssbexo_palutena_up_special_turn_acmd, Low)
    .game_acmd("game_specialairhiturn", ssbexo_palutena_up_special_turn_acmd, Low)
    .effect_acmd("effect_specialhiturn", ssbexo_palutena_up_special_turn_effect, Low)
    .effect_acmd("effect_specialairhiturn", ssbexo_palutena_up_special_turn_effect, Low)
    .sound_acmd("sound_specialhiturn", ssbexo_palutena_up_special_turn_sound, Low)
    .sound_acmd("sound_specialairhiturn", ssbexo_palutena_up_special_turn_sound, Low)
    .expression_acmd("expression_specialhiturn", ssbexo_palutena_up_special_turn_expression, Low)
    .expression_acmd("expression_specialairhiturn", ssbexo_palutena_up_special_turn_expression, Low)
    .game_acmd("game_speciallw", ssbexo_palutena_down_special_acmd, Low)
    .game_acmd("game_specialairlw", ssbexo_palutena_down_special_acmd, Low)
    .effect_acmd("effect_speciallw", ssbexo_palutena_down_special_effect, Low)
    .effect_acmd("effect_specialairlw", ssbexo_palutena_down_special_effect, Low)
    .sound_acmd("sound_speciallw", ssbexo_palutena_down_special_sound, Low)
    .sound_acmd("sound_specialairlw", ssbexo_palutena_down_special_sound, Low)
    .expression_acmd("expression_speciallw", ssbexo_palutena_down_special_expression, Low)
    .expression_acmd("expression_specialairlw", ssbexo_palutena_down_special_expression, Low)
    .install()
    ;
    Agent::new("palutena_reflectionboard")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_shoot", ssbexo_palutena_reflection_board_shoot_acmd, Low)
    .effect_acmd("effect_break", ssbexo_palutena_reflection_board_break_effect, Low)
    .install()
    ;
}