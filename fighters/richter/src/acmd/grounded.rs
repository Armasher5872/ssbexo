...
unsafe extern "C" fn ssbexo_richter_jab_3_effect(agent: &mut L2CAgentBase) {
    ...
    frame(agent.lua_state_agent, 3.0);
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("richter_attack100_end"), Hash40::new("top"), 0, 14, 7, 0, 0, 0, 1, true);
    }
}
...
unsafe extern "C" fn ssbexo_richter_dash_attack_acmd(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 4.0);
    if is_excute(agent) {
        SEARCH(agent, 0, 0, Hash40::new("top"), 12.0, 0.0, 6.5, 2.5, Some(0.0), Some(6.5), Some(8.0), *COLLISION_KIND_MASK_ATTACK, *HIT_STATUS_MASK_NORMAL, 60, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false);
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("kneel"), 12.0, 80, 55, 0, 60, 4.0, 4.5, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 1, 0, Hash40::new("kneel"), 12.0, 80, 55, 0, 60, 4.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        ATTACK(agent, 2, 0, Hash40::new("waist"), 8.0, 361, 55, 0, 60, 6.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
        ATTACK(agent, 3, 0, Hash40::new("bust"), 8.0, 361, 55, 0, 60, 6.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_BODY);
    }
...
unsafe extern "C" fn ssbexo_richter_dash_attack_effect(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 7.0);
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("sys_attack_arc"), Hash40::new("top"), 0, 12, 0, -180, 140, -25, 1.1, true);
...
pub fn install() {
    ...
    .game_acmd("game_attack11", ssbexo_richter_jab_1_acmd, Low)
    .game_acmd("game_attack12", ssbexo_richter_jab_2_acmd, Low)
    .game_acmd("game_attack13", ssbexo_richter_jab_3_acmd, Low)
    .effect_acmd("effect_attack13", ssbexo_richter_jab_3_effect, Low)
    .sound_acmd("sound_attack13", ssbexo_richter_jab_3_sound, Low)
    .expression_acmd("expression_attack13", ssbexo_richter_jab_3_expression, Low)
    .game_acmd("game_attackdash", ssbexo_richter_dash_attack_acmd, Low)
    .effect_acmd("effect_attackdash", ssbexo_richter_dash_attack_effect, Low)
    .sound_acmd("sound_attackdash", ssbexo_richter_dash_attack_sound, Low)
    .expression_acmd("expression_attackdash", ssbexo_richter_dash_attack_expression, Low)
    .install()
    ;
    Agent::new("richter_whip")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_attack13", ssbexo_richter_whip_jab_3_acmd, Low)
    .effect_acmd("effect_attack13", ssbexo_richter_whip_jab_3_effect, Low)
    .install()
    ;
}