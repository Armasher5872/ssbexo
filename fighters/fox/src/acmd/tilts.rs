...
//Up Tilt ACMD
unsafe extern "C" fn ssbexo_fox_up_tilt_acmd(agent: &mut L2CAgentBase) {
...
pub fn install() {
    ...
    .game_acmd("game_attackhi3", ssbexo_fox_up_tilt_acmd, Low)
    .install()
    ;
}