...
unsafe extern "C" fn armstrong_special_s_run_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if !StatusModule::is_changing(boma) {
        ...
        && prev_situation_kind == *SITUATION_KIND_AIR {
            ...
            sv_kinetic_energy!(set_speed, fighter, *FIGHTER_KINETIC_ENERGY_ID_STOP, 2.0*lr, 0.0);
            sv_kinetic_energy!(set_stable_speed, fighter, *FIGHTER_KINETIC_ENERGY_ID_STOP, 2.0*lr, 0.0);
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_s_run"), -1.0, 1.0, 0.0, false, false);
        }
        ...
        && prev_situation_kind == *SITUATION_KIND_GROUND {
            ...
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_s_run"), -1.0, 1.0, 0.0, false, false);
        }
    }
    if WorkModule::get_int(boma, *FIGHTER_ARMSTRONG_INSTANCE_WORK_ID_INT_SPECIAL_S_RUN_TIME) > 10+charge_frames {
...
unsafe extern "C" fn armstrong_special_s_run_exec_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    let boma = fighter.module_accessor;
    WorkModule::inc_int(boma, *FIGHTER_ARMSTRONG_INSTANCE_WORK_ID_INT_SPECIAL_S_RUN_TIME);
    0.into()
}
