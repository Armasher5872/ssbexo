...
unsafe extern "C" fn armstrong_final_init_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    WorkModule::on_flag(boma, *FIGHTER_INSTANCE_WORK_ID_FLAG_NO_DEAD);
    0.into()
}
...
unsafe extern "C" fn armstrong_final_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if !StatusModule::is_changing(boma) {
        ...
        && prev_situation_kind == *SITUATION_KIND_AIR {
            ...
            fighter.set_situation(SITUATION_KIND_GROUND.into());
            GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_GROUND_CLIFF_STOP));
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("final_start"), -1.0, 1.0, 0.0, false, false);
        }
        if situation_kind == *SITUATION_KIND_AIR
        && prev_situation_kind == *SITUATION_KIND_GROUND {
            ...
            fighter.set_situation(SITUATION_KIND_AIR.into());
            GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_AIR));
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("final_air_start"), -1.0, 1.0, 0.0, false, false);
        }
    }
