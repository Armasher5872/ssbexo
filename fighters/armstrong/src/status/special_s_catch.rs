...
unsafe extern "C" fn armstrong_special_s_catch_init_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    WorkModule::set_float(boma, get_sum_speed_y, *FIGHTER_ARMSTRONG_INSTANCE_WORK_ID_FLOAT_SPECIAL_S_CATCH_INIT_Y_VEL);
...
unsafe extern "C" fn armstrong_special_s_catch_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    let boma = fighter.module_accessor;
    let init_y_vel = WorkModule::get_float(boma, *FIGHTER_ARMSTRONG_INSTANCE_WORK_ID_FLOAT_SPECIAL_S_CATCH_INIT_Y_VEL);
    if !StatusModule::is_changing(boma) {
        ...
        && prev_situation_kind == *SITUATION_KIND_GROUND {
            ...
            MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_s_catch"), -1.0, 1.0, 0.0, false, false);
        }
    }
    if WorkModule::is_flag(boma, *FIGHTER_ARMSTRONG_INSTANCE_WORK_ID_FLAG_SPECIAL_S_JUMP) {
