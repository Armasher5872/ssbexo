...
unsafe extern "C" fn ssbexo_armstrong_back_throw_acmd(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    let vector = Vector3f{x: -15.0, y: 15.0, z: 0.0};
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_armstrong_up_throw_acmd(agent: &mut L2CAgentBase) {
    ...
    let boma = agent.module_accessor;
    if is_excute(agent) {
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 14.0, 80, 50, 0, 90, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, 0, 3.0, 361, 100, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
    }
    frame(lua_state, 27.0);
    if is_excute(agent) {
...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_armstrong_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_armstrong_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_armstrong_pivot_grab_acmd, Low)
    .acmd("effect_catchattack", ssbexo_armstrong_pummel_effect, Low)
    .acmd("game_throwf", ssbexo_armstrong_forward_throw_acmd, Low)
    .acmd("effect_throwf", ssbexo_armstrong_forward_throw_effect, Low)
    .acmd("sound_throwf", ssbexo_armstrong_forward_throw_sound, Low)
    .acmd("expression_throwf", ssbexo_armstrong_forward_throw_expression, Low)
    .acmd("game_throwb", ssbexo_armstrong_back_throw_acmd, Low)
    .acmd("effect_throwb", ssbexo_armstrong_back_throw_effect, Low)
    .acmd("sound_throwb", ssbexo_armstrong_back_throw_sound, Low)
    .acmd("expression_throwb", ssbexo_armstrong_back_throw_expression, Low)
    .acmd("game_throwhi", ssbexo_armstrong_up_throw_acmd, Low)
    .acmd("effect_throwhi", ssbexo_armstrong_up_throw_effect, Low)
    .acmd("sound_throwhi", ssbexo_armstrong_up_throw_sound, Low)
    .acmd("expression_throwhi", ssbexo_armstrong_up_throw_expression, Low)
    .acmd("game_throwlw", ssbexo_armstrong_down_throw_acmd, Low)
    .acmd("effect_throwlw", ssbexo_armstrong_down_throw_effect, Low)
    .acmd("sound_throwlw", ssbexo_armstrong_down_throw_sound, Low)
    .acmd("expression_throwlw", ssbexo_armstrong_down_throw_expression, Low)
    .install()
    ;
}