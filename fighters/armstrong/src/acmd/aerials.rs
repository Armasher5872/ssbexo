...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_armstrong_nair_acmd, Low)
    .acmd("effect_attackairn", ssbexo_armstrong_nair_effect, Low)
    .acmd("sound_attackairn", ssbexo_armstrong_nair_sound, Low)
    .acmd("expression_attackairn", ssbexo_armstrong_nair_expression, Low)
    .acmd("game_attackairf", ssbexo_armstrong_fair_acmd, Low)
    .acmd("effect_attackairf", ssbexo_armstrong_fair_effect, Low)
    .acmd("game_attackairb", ssbexo_armstrong_bair_acmd, Low)
    .acmd("effect_attackairb", ssbexo_armstrong_bair_effect, Low)
    .acmd("sound_attackairb", ssbexo_armstrong_bair_sound, Low)
    .acmd("expression_attackairb", ssbexo_armstrong_bair_expression, Low)
    .acmd("game_attackairhi", ssbexo_armstrong_uair_acmd, Low)
    .acmd("effect_attackairhi", ssbexo_armstrong_uair_effect, Low)
    .acmd("sound_attackairhi", ssbexo_armstrong_uair_sound, Low)
    .acmd("expression_attackairhi", ssbexo_armstrong_uair_expression, Low)
    .acmd("game_attackairlw", ssbexo_armstrong_dair_acmd, Low)
    .acmd("effect_attackairlw", ssbexo_armstrong_dair_effect, Low)
    .install()
    ;
}