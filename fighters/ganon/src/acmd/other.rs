...
pub fn install() {
    ...
    .acmd("effect_walkmiddle", ssbexo_ganon_middle_walk_effect, Low)
    .acmd("sound_walkmiddle", ssbexo_ganon_middle_walk_sound, Low)
    .acmd("expression_walkmiddle", ssbexo_ganon_middle_walk_expression, Low)
    ...
    .acmd("sound_dash", ssbexo_ganon_dash_sound, Low)
    .acmd("sound_turndash", ssbexo_ganon_turn_dash_sound, Low)
    .acmd("sound_run", ssbexo_ganon_run_sound, Low)
    .acmd("game_guardon", ssbexo_ganon_guard_off_acmd, Low)
    .acmd("game_guardoff", ssbexo_ganon_guard_on_acmd, Low)
    ...
    .acmd("effect_escapeair", ssbexo_ganon_air_dodge_effect, Low)
    .acmd("effect_escapeairslide", ssbexo_ganon_air_dodge_effect, Low)
