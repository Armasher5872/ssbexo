...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_ganon_nair_acmd, Low)
    .acmd("effect_attackairn", ssbexo_ganon_nair_effect, Low)
    .acmd("sound_attackairn", ssbexo_ganon_nair_sound, Low)
    .acmd("expression_attackairn", ssbexo_ganon_nair_expression, Low)
    .acmd("game_attackairf", ssbexo_ganon_fair_acmd, Low)
    .acmd("effect_attackairf", ssbexo_ganon_fair_effect, Low)
    .acmd("sound_attackairf", ssbexo_ganon_fair_sound, Low)
    .acmd("expression_attackairf", ssbexo_ganon_fair_expression, Low)
    .acmd("game_attackairb", ssbexo_ganon_bair_acmd, Low)
    .acmd("effect_attackairb", ssbexo_ganon_bair_effect, Low)
    .acmd("sound_attackairb", ssbexo_ganon_bair_sound, Low)
    .acmd("expression_attackairb", ssbexo_ganon_bair_expression, Low)
    .acmd("game_landingairb", ssbexo_ganon_bair_landing_acmd, Low)
    .acmd("game_attackairhi", ssbexo_ganon_uair_acmd, Low)
    .acmd("effect_attackairhi", ssbexo_ganon_uair_effect, Low)
    .acmd("sound_attackairhi", ssbexo_ganon_uair_sound, Low)
    .acmd("expression_attackairhi", ssbexo_ganon_uair_expression, Low)
    .acmd("effect_attackairlw", ssbexo_ganon_dair_effect, Low)
    .install()
    ;
}