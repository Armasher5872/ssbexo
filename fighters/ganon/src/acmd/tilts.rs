...
unsafe extern "C" fn ssbexo_ganon_down_tilt_expression(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ControlModule::set_rumble(boma, Hash40::new("rbkind_impact"), 15, false, *BATTLE_OBJECT_ID_INVALID as u32);
    }
}
...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_ganon_forward_tilt_acmd, Low)
    .acmd("game_attacks3hi", ssbexo_ganon_forward_tilt_acmd, Low)
    .acmd("game_attacks3lw", ssbexo_ganon_forward_tilt_acmd, Low)
    .acmd("effect_attacks3", ssbexo_ganon_forward_tilt_effect, Low)
    .acmd("effect_attacks3hi", ssbexo_ganon_forward_tilt_hi_effect, Low)
    .acmd("effect_attacks3lw", ssbexo_ganon_forward_tilt_lw_effect, Low)
    .acmd("sound_attacks3", ssbexo_ganon_forward_tilt_sound, Low)
    .acmd("sound_attacks3hi", ssbexo_ganon_forward_tilt_hi_sound, Low)
    .acmd("sound_attacks3lw", ssbexo_ganon_forward_tilt_lw_sound, Low)
    .acmd("expression_attacks3hi", ssbexo_ganon_forward_tilt_hi_expression, Low)
    .acmd("expression_attacks3lw", ssbexo_ganon_forward_tilt_lw_expression, Low)
    .acmd("game_attackhi3", ssbexo_ganon_up_tilt_acmd, Low)
    .acmd("effect_attackhi3", ssbexo_ganon_up_tilt_effect, Low)
    .acmd("sound_attackhi3", ssbexo_ganon_up_tilt_sound, Low)
    .acmd("expression_attackhi3", ssbexo_ganon_up_tilt_expression, Low)
    .acmd("game_attacklw3", ssbexo_ganon_down_tilt_acmd, Low)
    .acmd("effect_attacklw3", ssbexo_ganon_down_tilt_effect, Low)
    .acmd("sound_attacklw3", ssbexo_ganon_down_tilt_sound, Low)
    .acmd("expression_attacklw3", ssbexo_ganon_down_tilt_expression, Low)
    .install()
    ;
}