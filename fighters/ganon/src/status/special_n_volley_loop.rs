...
unsafe extern "C" fn ganon_special_n_volley_loop_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && prev_situation_kind == *SITUATION_KIND_AIR {
        ...
        if special_n_loop_count > 4 {
            MotionModule::change_motion_inherit_frame(fighter.module_accessor, Hash40::new("special_air_n_volley_max"), -1.0, 1.0, 0.0, false, false);
        }
        else if special_n_loop_count == 4 {
            MotionModule::change_motion_inherit_frame(fighter.module_accessor, Hash40::new("special_air_n_volley_max_start"), -1.0, 1.0, 0.0, false, false);
        }
        else {
            MotionModule::change_motion_inherit_frame(fighter.module_accessor, Hash40::new("special_air_n_volley_loop"), -1.0, 1.0, 0.0, false, false);
        }
    }
    if situation_kind == *SITUATION_KIND_AIR
    && prev_situation_kind == *SITUATION_KIND_GROUND {
        ...
        if special_n_loop_count > 4 {
            MotionModule::change_motion_inherit_frame(fighter.module_accessor, Hash40::new("special_n_volley_max"), -1.0, 1.0, 0.0, false, false);
        }
        else if special_n_loop_count == 4 {
            MotionModule::change_motion_inherit_frame(fighter.module_accessor, Hash40::new("special_n_volley_max_start"), -1.0, 1.0, 0.0, false, false);
        }
        else {
            MotionModule::change_motion_inherit_frame(fighter.module_accessor, Hash40::new("special_n_volley_loop"), -1.0, 1.0, 0.0, false, false);
        }
    }
