...
pub fn install() {
    ...
    update_float_2(*FIGHTER_KIND_GANON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), (hash40("jump_speed_x"), 0, 0.577));
    ...
    update_float_2(*FIGHTER_KIND_GANON, vec![0, 1, 2, 3, 4, 5, 6, 7].clone(), (hash40("combo_attack_12_end"), 0, 20.0)); //Vanilla Value is 0
}