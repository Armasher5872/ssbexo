...
pub fn install() {
    ...
    .game_acmd("game_attack100", ssbexo_pit_rapid_jab_acmd, Low)
    .game_acmd("game_attack100sub", ssbexo_pit_rapid_jab_sub_acmd, Low)
    .game_acmd("game_attackdash", ssbexo_pit_dash_attack_acmd, Low)
    .install()
    ;
}