...
pub fn install() {
    ...
    .acmd("game_speciallwstart", ssbexo_wario_grounded_down_special_start_acmd, Low)
    .acmd("effect_speciallwstart", ssbexo_wario_grounded_down_special_start_effect, Low)
    .acmd("sound_speciallwstart", ssbexo_wario_grounded_down_special_start_sound, Low)
    .acmd("expression_speciallwstart", ssbexo_wario_grounded_down_special_start_expression, Low)
    .acmd("game_specialairlwstart", ssbexo_wario_aerial_down_special_start_acmd, Low)
    .acmd("effect_specialairlwstart", ssbexo_wario_aerial_down_special_start_effect, Low)
    .acmd("sound_specialairlwstart", ssbexo_wario_aerial_down_special_start_sound, Low)
    .acmd("expression_specialairlwstart", ssbexo_wario_aerial_down_special_start_expression, Low)
    .install()
    ;
}