...
pub fn install() {
    ...
    .acmd("game_kamikaze", ssbexo_wario_kamikaze_burst_acmd, Low)
    .acmd("effect_kamikaze", ssbexo_wario_kamikaze_burst_effect, Low)
    .acmd("sound_kamikaze", ssbexo_wario_kamikaze_burst_sound, Low)
    .install()
    ;
}