...
pub fn install() {
    ...
    .acmd("game_speciallwland", ssbexo_wario_down_special_land_acmd, Low)
    .acmd("effect_speciallwland", ssbexo_wario_down_special_land_effect, Low)
    .acmd("sound_speciallwland", ssbexo_wario_down_special_land_sound, Low)
    .acmd("expression_speciallwland", ssbexo_wario_down_special_land_expression, Low)
    .install()
    ;
}