...
pub fn install() {
    ...
    .acmd("game_specials", ssbexo_wario_grounded_side_special_acmd, Low)
    .acmd("effect_specials", ssbexo_wario_grounded_side_special_effect, Low)
    .acmd("sound_specials", ssbexo_wario_grounded_side_special_sound, Low)
    .acmd("expression_specials", ssbexo_wario_grounded_side_special_expression, Low)
    .acmd("game_specialairs", ssbexo_wario_aerial_side_special_acmd, Low)
    .acmd("effect_specialairs", ssbexo_wario_aerial_side_special_effect, Low)
    .acmd("sound_specialairs", ssbexo_wario_aerial_side_special_sound, Low)
    .acmd("expression_specialairs", ssbexo_wario_aerial_side_special_expression, Low)
    .install()
    ;
}