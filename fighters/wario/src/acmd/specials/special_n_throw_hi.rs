...
pub fn install() {
    ...
    .acmd("game_specialnthrowhi", ssbexo_wario_neutral_special_up_throw_acmd, Low)
    .acmd("effect_specialnthrowhi", ssbexo_wario_neutral_special_up_throw_effect, Low)
    .acmd("sound_specialnthrowhi", ssbexo_wario_neutral_special_up_throw_sound, Low)
    .acmd("expression_specialnthrowhi", ssbexo_wario_neutral_special_up_throw_expression, Low)
    .acmd("game_specialairnthrowhi", ssbexo_wario_neutral_special_up_throw_acmd, Low)
    .acmd("effect_specialairnthrowhi", ssbexo_wario_neutral_special_up_throw_effect, Low)
    .acmd("sound_specialairnthrowhi", ssbexo_wario_neutral_special_up_throw_sound, Low)
    .acmd("expression_specialairnthrowhi", ssbexo_wario_neutral_special_up_throw_expression, Low)
    .install()
    ;
}