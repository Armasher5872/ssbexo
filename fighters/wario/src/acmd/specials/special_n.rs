...
pub fn install() {
    ...
    .acmd("game_specialn", ssbexo_wario_neutral_special_acmd, Low)
    .acmd("effect_specialn", ssbexo_wario_neutral_special_effect, Low)
    .acmd("sound_specialn", ssbexo_wario_neutral_special_sound, Low)
    .acmd("expression_specialn", ssbexo_wario_neutral_special_expression, Low)
    .acmd("game_specialairn", ssbexo_wario_neutral_special_acmd, Low)
    .acmd("effect_specialairn", ssbexo_wario_neutral_special_effect, Low)
    .acmd("sound_specialairn", ssbexo_wario_neutral_special_sound, Low)
    .acmd("expression_specialairn", ssbexo_wario_neutral_special_expression, Low)
    .install()
    ;
}