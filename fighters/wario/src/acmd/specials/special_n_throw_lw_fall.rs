...
pub fn install() {
    ...
    .acmd("game_specialairnthrowlwfall", ssbexo_wario_neutral_special_throw_lw_fall_acmd, Low)
    .acmd("effect_specialairnthrowlwfall", ssbexo_wario_neutral_special_throw_lw_fall_effect, Low)
    .acmd("sound_specialairnthrowlwfall", ssbexo_wario_neutral_special_throw_lw_fall_sound, Low)
    .acmd("expression_specialairnthrowlwfall", ssbexo_wario_neutral_special_throw_lw_fall_expression, Low)
    .install()
    ;
}