...
pub fn install() {
    ...
    .acmd("game_specialairlwend", ssbexo_wario_aerial_down_special_end_acmd, Low)
    .acmd("effect_specialairlwend", ssbexo_wario_aerial_down_special_end_effect, Low)
    .acmd("sound_specialairlwend", ssbexo_wario_aerial_down_special_end_sound, Low)
    .acmd("expression_specialairlwend", ssbexo_wario_aerial_down_special_end_expression, Low)
    .install()
    ;
}