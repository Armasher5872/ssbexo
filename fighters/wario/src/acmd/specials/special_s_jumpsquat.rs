...
pub fn install() {
    ...
    .acmd("game_specialsjumpsquat", ssbexo_wario_side_special_jumpsquat_acmd, Low)
    .acmd("effect_specialsjumpsquat", ssbexo_wario_side_special_jumpsquat_effect, Low)
    .acmd("sound_specialsjumpsquat", ssbexo_wario_side_special_jumpsquat_sound, Low)
    .acmd("expression_specialsjumpsquat", ssbexo_wario_side_special_jumpsquat_expression, Low)
    .install()
    ;
}