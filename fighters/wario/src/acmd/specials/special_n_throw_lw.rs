...
pub fn install() {
    ...
    .acmd("game_specialairnthrowlw", ssbexo_wario_neutral_special_throw_lw_acmd, Low)
    .acmd("effect_specialairnthrowlw", ssbexo_wario_neutral_special_throw_lw_effect, Low)
    .acmd("sound_specialairnthrowlw", ssbexo_wario_neutral_special_throw_lw_sound, Low)
    .acmd("expression_specialairnthrowlw", ssbexo_wario_neutral_special_throw_lw_expression, Low)
    .install()
    ;
}