...
pub fn install() {
    ...
    .acmd("game_specialncatchwalk", ssbexo_wario_neutral_special_catch_walk_acmd, Low)
    .acmd("effect_specialncatchwalk", ssbexo_wario_neutral_special_catch_walk_effect, Low)
    .acmd("sound_specialncatchwalk", ssbexo_wario_neutral_special_catch_walk_sound, Low)
    .acmd("expression_specialncatchwalk", ssbexo_wario_neutral_special_catch_walk_expression, Low)
    .install()
    ;
}