...
pub fn install() {
    ...
    .acmd("game_specialairlwloop", ssbexo_wario_aerial_down_special_loop_acmd, Low)
    .acmd("effect_specialairlwloop", ssbexo_wario_aerial_down_special_loop_effect, Low)
    .acmd("sound_specialairlwloop", ssbexo_wario_aerial_down_special_loop_sound, Low)
    .acmd("expression_specialairlwloop", ssbexo_wario_aerial_down_special_loop_expression, Low)
    .install()
    ;
}