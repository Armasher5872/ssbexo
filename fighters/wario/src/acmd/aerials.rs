...
unsafe extern "C" fn ssbexo_wario_fair_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("handl"), 6.2, 76, 98, 0, 43, 7.0, 0.0, 0.0, 0.6, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 1, 0, Hash40::new("arml"), 6.2, 76, 98, 0, 43, 5.3, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 2, 0, Hash40::new("shoulderl"), 6.2, 76, 98, 0, 43, 4.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
    }
    frame(lua_state, 26.0);
    if is_excute(agent) {
        AttackModule::clear_all(boma);
...
unsafe extern "C" fn ssbexo_wario_dair_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 2, 0, Hash40::new("handl"), 14.5, 270, 108, 0, 17, 6.0, 0.4, -1.0, -1.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ATTACK(agent, 1, 0, Hash40::new("arml"), 14.5, 270, 108, 0, 17, 4.3, 0.2, 0.6, 0.0, None, None, None, 1.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_wario_nair_acmd, Low)
    .acmd("effect_attackairn", ssbexo_wario_nair_effect, Low)
    .sound_acmd("sound_attackairn", ssbexo_wario_nair_sound, Low)
    .acmd("expression_attackairn", ssbexo_wario_nair_expression, Low)
    .acmd("game_attackairf", ssbexo_wario_fair_acmd, Low)
    .acmd("effect_attackairf", ssbexo_wario_fair_effect, Low)
    .sound_acmd("sound_attackairf", ssbexo_wario_fair_sound, Low)
    .acmd("expression_attackairf", ssbexo_wario_fair_expression, Low)
    .acmd("game_attackairb", ssbexo_wario_bair_acmd, Low)
    .acmd("effect_attackairb", ssbexo_wario_bair_effect, Low)
    .sound_acmd("sound_attackairb", ssbexo_wario_bair_sound, Low)
    .acmd("expression_attackairb", ssbexo_wario_bair_expression, Low)
    .acmd("game_attackairhi", ssbexo_wario_uair_acmd, Low)
    .acmd("game_attackairlw", ssbexo_wario_dair_acmd, Low)
    .acmd("effect_attackairlw", ssbexo_wario_dair_effect, Low)
    .sound_acmd("sound_attackairlw", ssbexo_wario_dair_sound, Low)
    .acmd("expression_attackairlw", ssbexo_wario_dair_expression, Low)
    .acmd("effect_landingairlw", ssbexo_wario_dair_landing_effect, Low)
    .install()
    ;
}