...
unsafe extern "C" fn ssbexo_wario_up_special_jump_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        CATCH(agent, 0, Hash40::new("top"), 4.0, 0.0, 7.0, 4.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        CATCH(agent, 1, Hash40::new("top"), 4.0, 0.0, 7.0, -3.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        CATCH(agent, 2, Hash40::new("top"), 4.0, 0.0, 13.0, 4.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        CATCH(agent, 3, Hash40::new("top"), 4.0, 0.0, 13.0, -3.0, None, None, None, *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
    }
...
unsafe extern "C" fn ssbexo_wario_up_special_grab_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ...
        EFFECT_FOLLOW_FLIP_ALPHA(agent, Hash40::new("wario_attack_air_n"), Hash40::new("wario_attack_air_n"), Hash40::new("rot"), 0, 5, 0, 0, -90, 0, 1.0, true, *EF_FLIP_YZ, 0.6);
        LAST_EFFECT_SET_RATE(agent, 1.25);
    }
...
unsafe extern "C" fn ssbexo_wario_up_special_grounded_throw_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 12.0, 85, 95, 0, 55, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
...
unsafe extern "C" fn ssbexo_wario_up_special_aerial_throw_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 12.0, 85, 65, 0, 55, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
        ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, 0, 3.0, 361, 100, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
        CHECK_FINISH_CAMERA(agent, 1, 1);
        lua_bind::FighterCutInManager::set_throw_finish_zoom_rate(singletons::FighterCutInManager(), 1.5);
        sv_kinetic_energy!(set_speed, agent, FIGHTER_KINETIC_ENERGY_ID_GRAVITY, 3.5);
...
pub fn install() {
    ...
    .effect_acmd("effect_specialhicatch", ssbexo_wario_up_special_grab_effect, Low)
    .sound_acmd("sound_specialhicatch", ssbexo_wario_up_special_grab_sound, Low)
    .expression_acmd("expression_specialhicatch", ssbexo_wario_up_special_grab_expression, Low)
    .game_acmd("game_specialhithrow", ssbexo_wario_up_special_grounded_throw_acmd, Low)
    .effect_acmd("effect_specialhithrow", ssbexo_wario_up_special_grounded_throw_effect, Low)
    .sound_acmd("sound_specialhithrow", ssbexo_wario_up_special_grounded_throw_sound, Low)
    .expression_acmd("expression_specialhithrow", ssbexo_wario_up_special_grounded_throw_expression, Low)
    .game_acmd("game_specialhithrowair", ssbexo_wario_up_special_aerial_throw_acmd, Low)
    .effect_acmd("effect_specialhithrowair", ssbexo_wario_up_special_aerial_throw_effect, Low)
    .sound_acmd("sound_specialhithrowair", ssbexo_wario_up_special_aerial_throw_sound, Low)
    .expression_acmd("expression_specialhithrowair", ssbexo_wario_up_special_aerial_throw_expression, Low)
    .game_acmd("game_speciallwlr", ssbexo_wario_half_charge_down_special_acmd, Low)
    .game_acmd("game_specialairlwlr", ssbexo_wario_half_charge_down_special_acmd, Low)
    .game_acmd("game_speciallwflyr", ssbexo_wario_full_charge_down_special_acmd, Low)
    .game_acmd("game_specialairlwflyr", ssbexo_wario_full_charge_down_special_acmd, Low)
    .install()
    ;
}