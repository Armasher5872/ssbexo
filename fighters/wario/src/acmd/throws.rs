...
unsafe extern "C" fn ssbexo_wario_back_throw_expression(agent: &mut L2CAgentBase) {
    ...
    frame(lua_state, 17.0);
    if is_excute(agent) {
        ControlModule::set_rumble(boma, Hash40::new("rbkind_attacks"), 12, false, *BATTLE_OBJECT_ID_INVALID as u32);
    }
    frame(lua_state, 29.0);
    if is_excute(agent) {
...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_wario_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_wario_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_wario_pivot_grab_acmd, Low)
    .acmd("game_catchattack", ssbexo_wario_pummel_acmd, Low)
    .acmd("effect_catchattack", ssbexo_wario_pummel_effect, Low)
    .acmd("sound_catchattack", ssbexo_wario_pummel_sound, Low)
    .acmd("game_throwf", ssbexo_wario_forward_throw_acmd, Low)
    .acmd("game_throwb", ssbexo_wario_back_throw_acmd, Low)
    .acmd("effect_throwb", ssbexo_wario_back_throw_effect, Low)
    .acmd("sound_throwb", ssbexo_wario_back_throw_sound, Low)
    .acmd("expression_throwb", ssbexo_wario_back_throw_expression, Low)
    .acmd("game_throwhi", ssbexo_wario_up_throw_acmd, Low)
    .acmd("game_throwlw", ssbexo_wario_down_throw_acmd, Low)
    .acmd("effect_throwlw", ssbexo_wario_down_throw_effect, Low)
    .acmd("sound_throwlw", ssbexo_wario_down_throw_sound, Low)
    .acmd("expression_throwlw", ssbexo_wario_down_throw_expression, Low)
    .install()
    ;
}