...
unsafe extern "C" fn wario_special_lw_land_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if prev_status_kind == *FIGHTER_WARIO_STATUS_KIND_SPECIAL_AIR_LW_END {
        MotionModule::change_motion(boma, Hash40::new("landing_heavy"), 0.0, 31.0/28.0, false, 0.0, false, false);
    }
    else {
        MotionModule::change_motion(boma, Hash40::new("special_lw_land"), 0.0, 1.0, false, 0.0, false, false);
    }
