...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_duckhunt_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_duckhunt_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_duckhunt_pivot_grab_acmd, Low)
    .install()
    ;
}