...
pub fn install() {
    ...
    .game_acmd("game_catch", ssbexo_pikachu_grab_acmd, Low)
    .game_acmd("game_catchdash", ssbexo_pikachu_dash_grab_acmd, Low)
    .game_acmd("game_catchturn", ssbexo_pikachu_pivot_grab_acmd, Low)
    .install()
    ;
}