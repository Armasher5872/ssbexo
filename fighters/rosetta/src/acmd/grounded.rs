...
pub fn install() {
    ...
    .game_acmd("game_attack13", ssbexo_rosetta_tico_jab_3_acmd, Low)
    .game_acmd("game_attackdash", ssbexo_rosetta_dash_attack_acmd, Low)
    .install()
    ;
}