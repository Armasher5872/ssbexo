...
pub fn install() {
    ...
    .game_acmd("game_specialhi", ssbexo_rosetta_up_special_acmd, Low)
    .game_acmd("game_speciallw", ssbexo_rosetta_down_special_acmd, Low)
    .effect_acmd("effect_speciallw", ssbexo_rosetta_down_special_effect, Low)
    .sound_acmd("sound_speciallw", ssbexo_rosetta_down_special_sound, Low)
    .expression_acmd("expression_speciallw", ssbexo_rosetta_down_special_expression, Low)
    .install()
    ;
}