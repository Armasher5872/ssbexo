...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_rosetta_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_rosetta_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_rosetta_pivot_grab_acmd, Low)
    .install()
    ;
}