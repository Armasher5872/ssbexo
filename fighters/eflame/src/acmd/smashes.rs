...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_eflame_forward_smash_acmd, Low)
    .acmd("game_attackhi4", ssbexo_eflame_up_smash_acmd, Low)
    .acmd("game_attacklw4", ssbexo_eflame_down_smash_acmd, Low)
    .install()
    ;
}