...
unsafe extern "C" fn gekkouga_special_s_end_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if !front {
        if situation_kind != *SITUATION_KIND_GROUND {
            ...
            MotionModule::change_motion(boma, Hash40::new("special_air_s_end_b"), 0.0, 1.0, false, 0.0, false, false);
        }
        else {
            GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_GROUND));
            MotionModule::change_motion(boma, Hash40::new("special_s_end_b"), 0.0, 1.0, false, 0.0, false, false);
        }
        ...
        if situation_kind != *SITUATION_KIND_GROUND {
            GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_AIR));
            MotionModule::change_motion(boma, Hash40::new("special_air_s_end_f"), 0.0, 1.0, false, 0.0, false, false);
        }
        else {
            GroundModule::correct(boma, GroundCorrectKind(*GROUND_CORRECT_KIND_GROUND));
            MotionModule::change_motion(boma, Hash40::new("special_s_end_f"), 0.0, 1.0, false, 0.0, false, false);
        }
    }
    if situation_kind == *SITUATION_KIND_GROUND {
        ...
        if prev_situation_kind != *SITUATION_KIND_GROUND {
            if situation_kind == *SITUATION_KIND_GROUND {
                ...
                if motion_kind != hash40("special_air_s_end_f") {
                    MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_s_end_b"), -1.0, 1.0, 0.0, false, false);
                }
                else {
                    MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_s_end_f"), -1.0, 1.0, 0.0, false, false);
                }
            }
        }
        else {
            if situation_kind == *SITUATION_KIND_AIR {
                ...
                if motion_kind != hash40("special_s_end_f") {
                    MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_s_end_b"), -1.0, 1.0, 0.0, false, false);
                }
                else {
                    MotionModule::change_motion_inherit_frame(boma, Hash40::new("special_air_s_end_f"), -1.0, 1.0, 0.0, false, false);
                }
            }
        }
    }
