...
pub fn install() {
    ...
    .acmd("game_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_acmd, Low)
    .acmd("game_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_acmd, Low)
    .acmd("effect_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_effect, Low)
    .acmd("effect_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_effect, Low)
    .acmd("sound_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_sound, Low)
    .acmd("sound_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_sound, Low)
    .acmd("expression_specialsattackhi", ssbexo_gekkouga_side_special_attack_hi_expression, Low)
    .acmd("expression_specialairsattackhi", ssbexo_gekkouga_side_special_attack_hi_expression, Low)
    .acmd("game_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_acmd, Low)
    .acmd("game_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_acmd, Low)
    .acmd("effect_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_effect, Low)
    .acmd("effect_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_effect, Low)
    .acmd("sound_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_sound, Low)
    .acmd("sound_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_sound, Low)
    .acmd("expression_specialsattacklw", ssbexo_gekkouga_side_special_attack_lw_expression, Low)
    .acmd("expression_specialairsattacklw", ssbexo_gekkouga_side_special_attack_lw_expression, Low)
    .acmd("game_speciallw", ssbexo_gekkouga_grounded_down_special_acmd, Low)
    .acmd("game_specialairlw", ssbexo_gekkouga_aerial_down_special_acmd, Low)
    .acmd("effect_speciallw", ssbexo_gekkouga_grounded_down_special_effect, Low)
    .acmd("effect_specialairlw", ssbexo_gekkouga_aerial_down_special_effect, Low)
    .acmd("sound_speciallw", ssbexo_gekkouga_grounded_down_special_sound, Low)
    .acmd("sound_specialairlw", ssbexo_gekkouga_aerial_down_special_sound, Low)
    .acmd("expression_speciallw", ssbexo_gekkouga_down_special_expression, Low)
