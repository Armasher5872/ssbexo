...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_gekkouga_forward_smash_acmd, Low)
    .acmd("game_attackhi4", ssbexo_gekkouga_up_smash_acmd, Low)
    .acmd("game_attacklw4", ssbexo_gekkouga_down_smash_acmd, Low)
    .install()
    ;
}