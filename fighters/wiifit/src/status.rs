...
unsafe extern "C" fn wiifit_special_lw_pre_status(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    ...
    .status(Pre, *FIGHTER_STATUS_KIND_SPECIAL_LW, wiifit_special_lw_pre_status)
    .install()
    ;
}