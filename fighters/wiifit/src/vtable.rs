...
#[skyline::hook(offset = get_agent_virtual_function(*FIGHTER_KIND_WIIFIT, 7, false, false))]
...
pub fn install() {
    let _ = skyline::patching::Patch::in_text(get_agent_virtual_function(*FIGHTER_KIND_WIIFIT, 4, false, true)).data(wiifit_reset_initialization as *const () as u64);
