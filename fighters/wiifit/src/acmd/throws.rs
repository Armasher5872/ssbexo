...
pub fn install() {
    ...
    .game_acmd("game_catch", ssbexo_wiifit_grab_acmd, Low)
    .game_acmd("game_catchdash", ssbexo_wiifit_dash_grab_acmd, Low)
    .game_acmd("game_catchturn", ssbexo_wiifit_pivot_grab_acmd, Low)
    .install()
    ;
}