...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_wiifit_forward_tilt_acmd, Low)
    .acmd("effect_attacks3", ssbexo_wiifit_forward_tilt_effect, Low)
    .acmd("effect_attackhi3", ssbexo_wiifit_up_tilt_effect, Low)
    .acmd("game_attacklw3", ssbexo_wiifit_down_tilt_acmd, Low)
    .acmd("effect_attacklw3", ssbexo_wiifit_down_tilt_effect, Low)
    .install()
    ;
}