...
unsafe extern "C" fn ssbexo_mario_forward_smash_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        FT_MOTION_RATE(agent, 12.0/15.0);
    }
