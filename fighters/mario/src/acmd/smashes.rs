...
pub fn install() {
    ...
    .acmd("effect_attacks4charge", ssbexo_mario_forward_smash_charge_effect, Low)
    .acmd("sound_attacks4charge", ssbexo_mario_forward_smash_charge_sound, Low)
    .acmd("game_attacks4", ssbexo_mario_forward_smash_acmd, Low)
    .acmd("effect_attacks4", ssbexo_mario_forward_smash_effect, Low)
    .acmd("sound_attacks4", ssbexo_mario_forward_smash_sound, Low)
    .acmd("expression_attacks4", ssbexo_mario_forward_smash_expression, Low)
    .acmd("game_attacks4hi", ssbexo_mario_forward_smash_hi_acmd, Low)
    .acmd("effect_attacks4hi", ssbexo_mario_forward_smash_hi_effect, Low)
    .acmd("sound_attacks4hi", ssbexo_mario_forward_smash_hi_sound, Low)
    .acmd("expression_attacks4hi", ssbexo_mario_forward_smash_hi_expression, Low)
    .acmd("game_attacks4lw", ssbexo_mario_forward_smash_lw_acmd, Low)
    .acmd("effect_attacks4lw", ssbexo_mario_forward_smash_lw_effect, Low)
    .acmd("sound_attacks4lw", ssbexo_mario_forward_smash_lw_sound, Low)
    .acmd("expression_attacks4lw", ssbexo_mario_forward_smash_lw_expression, Low)
    .acmd("game_attackhi4", ssbexo_mario_up_smash_acmd, Low)
    .install()
    ;
}