...
//Airdodge ACMD
unsafe extern "C" fn ssbexo_mario_airdodge_acmd(_agent: &mut L2CAgentBase) {}
...
pub fn install() {
    ...
    .acmd("game_escapeair", ssbexo_mario_airdodge_acmd, Low)
    .acmd("game_escapeairslide", ssbexo_mario_airdodge_acmd, Low)
    .acmd("effect_appeallwr", ssbexo_mario_down_taunt_effect, Low)
    .acmd("sound_appeallwr", ssbexo_mario_down_taunt_sound, Low)
    .acmd("expression_appeallwr", ssbexo_mario_down_taunt_expression, Low)
    .acmd("effect_appeallwl", ssbexo_mario_down_taunt_effect, Low)
    .acmd("sound_appeallwl", ssbexo_mario_down_taunt_sound, Low)
    .acmd("expression_appeallwl", ssbexo_mario_down_taunt_expression, Low)
    .acmd("game_squatf", ssbexo_mario_crawl_acmd, Low)
    .acmd("effect_squatf", ssbexo_mario_crawl_effect, Low)
    .acmd("sound_squatf", ssbexo_mario_crawl_sound, Low)
    .acmd("expression_squatf", ssbexo_mario_crawl_expression, Low)
    .acmd("game_squatb", ssbexo_mario_crawl_acmd, Low)
    .acmd("effect_squatb", ssbexo_mario_crawl_effect, Low)
    .acmd("sound_squatb", ssbexo_mario_crawl_sound, Low)
    .acmd("expression_squatb", ssbexo_mario_crawl_expression, Low)
    .install()
    ;
}