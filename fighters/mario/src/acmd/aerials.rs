...
unsafe extern "C" fn ssbexo_mario_footstool_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("footl"), 2.0, 0, 0, 0, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 0.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, true, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_none"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_KICK);
        ATTACK(agent, 1, 0, Hash40::new("footr"), 2.0, 0, 0, 0, 0, 5.0, 0.0, 0.0, 0.0, None, None, None, 0.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, 0, 0.0, 0, false, false, true, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_none"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_KICK);
    }
    frame(lua_state, 9.0);
    if is_excute(agent) {
...
unsafe extern "C" fn ssbexo_mario_nair_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 1, 0, Hash40::new("footr"), 7.0, 60, 75, 0, 45, 2.0, 1.2, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
    ...
    if is_excute(agent) {
        ...
        ATTACK(agent, 1, 0, Hash40::new("footr"), 4.0, 60, 45, 0, 40, 2.0, 1.2, 0.0, 0.0, None, None, None, 0.8, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe extern "C" fn ssbexo_mario_dair_bounce_effect(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        sv_animcmd::EFFECT_FOLLOW_FLIP_RND(lua_state);
...
pub fn install() {
    ...
    .acmd("game_stepjump", ssbexo_mario_footstool_acmd, Low)
    .acmd("game_attackairn", ssbexo_mario_nair_acmd, Low)
    .acmd("effect_attackairn", ssbexo_mario_nair_effect, Low)
    .acmd("sound_attackairn", ssbexo_mario_nair_sound, Low)
    .acmd("expression_attackairn", ssbexo_mario_nair_expression, Low)
    .acmd("game_attackairf", ssbexo_mario_fair_acmd, Low)
    .acmd("effect_attackairf", ssbexo_mario_fair_effect, Low)
    .acmd("game_attackairlw", ssbexo_mario_dair_acmd, Low)
    .acmd("effect_attackairlw", ssbexo_mario_dair_effect, Low)
    .acmd("sound_attackairlw", ssbexo_mario_dair_sound, Low)
    .acmd("expression_attackairlw", ssbexo_mario_dair_expression, Low)
    .acmd("game_attackairlwbounce", ssbexo_mario_dair_bounce_acmd, Low)
    .acmd("effect_attackairlwbounce", ssbexo_mario_dair_bounce_effect, Low)
    .acmd("sound_attackairlwbounce", ssbexo_mario_dair_bounce_sound, Low)
    .acmd("expression_attackairlwbounce", ssbexo_mario_dair_bounce_expression, Low)
    .acmd("game_landingairlw", ssbexo_mario_dair_landing_acmd, Low)
    .install()
    ;
}