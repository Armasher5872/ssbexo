...
unsafe extern "C" fn ssbexo_mario_down_special_acmd(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        WorkModule::set_float(boma, 4.0, *FIGHTER_MARIO_STATUS_SPECIAL_S_WORK_ID_FLOAT_REFLECT_MOTION_FRAME);
    }
    frame(lua_state,4.0);
    if is_excute(agent) {
    ...
    frame(lua_state, 8.0);
    if is_excute(agent) {
        WorkModule::on_flag(boma, *FIGHTER_MARIO_INSTANCE_WORK_ID_FLAG_SPECIAL_LW_JUMP);
...
unsafe extern "C" fn ssbexo_mario_down_special_effect(agent: &mut L2CAgentBase) {
    ...
    for _ in 0..3 {
        if is_excute(agent) {
            ...
            let spin1: u32 = EffectModule::req_follow(boma, Hash40::new("sys_spin_wind"), Hash40::new("top"), &spv1, &Vector3f::zero(), 1.0, true, 0, 0, 0, 0, 0, true, true) as u32;
            let spin2: u32 = EffectModule::req_follow(boma, Hash40::new("sys_spin_wind"), Hash40::new("top"), &spv2, &Vector3f::zero(), 1.0, true, 0, 0, 0, 0, 0, true, true) as u32;
            let spin3: u32 = EffectModule::req_follow(boma, Hash40::new("sys_spin_wind"), Hash40::new("top"), &spv3, &Vector3f::zero(), 1.0, true, 0, 0, 0, 0, 0, true, true) as u32;
            let spin4: u32 = EffectModule::req_follow(boma, Hash40::new("sys_spin_wind"), Hash40::new("top"), &spv4, &Vector3f::zero(), 1.0, true, 0, 0, 0, 0, 0, true, true) as u32;
            let spin5: u32 = EffectModule::req_follow(boma, Hash40::new("sys_spin_wind"), Hash40::new("top"), &spv5, &Vector3f::zero(), 1.0, true, 0, 0, 0, 0, 0, true, true) as u32;
            ...
            let star4: u32 = EffectModule::req_follow(boma, Hash40::new("sys_starrod_splash"), Hash40::new("top"), &Vector3f::zero(), &Vector3f::zero(), 1.0, true, 0, 0, 0, 0, 0, true, true) as u32;
            let star5: u32 = EffectModule::req_follow(boma, Hash40::new("sys_starrod_splash"), Hash40::new("top"), &Vector3f::zero(), &Vector3f::zero(), 1.0, true, 0, 0, 0, 0, 0, true, true) as u32;
            ...
            EffectModule::set_rgb(boma, spin1, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, spin2, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, spin3, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, spin4, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, spin5, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, star1, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, star2, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, star3, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, star4, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, star5, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, star6, 0.045, 0.345, 2.05);
            EffectModule::set_rgb(boma, star7, 0.045, 0.345, 2.05);
