...
pub fn install() {
    ...
    .acmd("game_catch", ssbexo_rockman_grab_acmd, Low)
    .acmd("game_catchdash", ssbexo_rockman_dash_grab_acmd, Low)
    .acmd("game_catchturn", ssbexo_rockman_pivot_grab_acmd, Low)
    .install()
    ;
}