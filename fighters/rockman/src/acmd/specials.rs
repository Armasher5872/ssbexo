...
unsafe extern "C" fn ssbexo_rockman_leafshield_acmd(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        ATTACK(agent, 0, 0, Hash40::new("leafshield1"), 8.0, 55, 50, 0, 60, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_NONE);
        ATTACK(agent, 1, 0, Hash40::new("leafshield2"), 8.0, 55, 50, 0, 60, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_NONE);
        ATTACK(agent, 2, 0, Hash40::new("leafshield3"), 8.0, 55, 50, 0, 60, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_NONE);
        ATTACK(agent, 3, 0, Hash40::new("leafshield4"), 8.0, 55, 50, 0, 60, 3.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_NONE);
    }
}
...
unsafe extern "C" fn ssbexo_rockman_leafshield_fly_effect(agent: &mut L2CAgentBase) {
    if is_excute(agent) {
        EFFECT_FOLLOW(agent, Hash40::new("rockman_leafshield_fly"), Hash40::new("top"), 0, 0, 0, 0, -0.0, 0, 1, true);
    }
    for _ in 0..i32::MAX {
        if is_excute(agent) {
            agent.clear_lua_stack();
...
pub fn install() {
    ...
    .game_acmd("game_specialnhi", ssbexo_rockman_neutral_special_hi_acmd, Low)
    .game_acmd("game_specialairnhi", ssbexo_rockman_neutral_special_hi_acmd, Low)
    .effect_acmd("effect_specialnhi", ssbexo_rockman_grounded_neutral_special_hi_effect, Low)
    .effect_acmd("effect_specialairnhi", ssbexo_rockman_aerial_neutral_special_hi_effect, Low)
    .expression_acmd("expression_specialnhi", ssbexo_rockman_neutral_special_hi_expression, Low)
    .expression_acmd("expression_specialairnhi", ssbexo_rockman_neutral_special_hi_expression, Low)
    .effect_acmd("effect_speciallw", ssbexo_rockman_grounded_down_special_effect, Low)
    .effect_acmd("effect_specialairlw", ssbexo_rockman_aerial_down_special_effect, Low)
    .install()
    ;
    Agent::new("rockman_leafshield")
    .set_costume([0, 1, 2, 3, 4, 5, 6, 7].to_vec())
    .game_acmd("game_start", ssbexo_rockman_leafshield_acmd, Low)
    .game_acmd("game_startreverse", ssbexo_rockman_leafshield_acmd, Low)
    .game_acmd("game_shield", ssbexo_rockman_leafshield_acmd, Low)
    .game_acmd("game_shieldreverse", ssbexo_rockman_leafshield_acmd, Low)
    .game_acmd("game_fly", ssbexo_rockman_leafshield_acmd, Low)
    .game_acmd("game_flyreverse", ssbexo_rockman_leafshield_acmd, Low)
    .effect_acmd("effect_start", ssbexo_rockman_leafshield_start_effect, Low)
    .effect_acmd("effect_startreverse", ssbexo_rockman_leafshield_start_effect, Low)
    .effect_acmd("effect_shield", ssbexo_rockman_leafshield_shield_effect, Low)
    .effect_acmd("effect_shieldreverse", ssbexo_rockman_leafshield_shield_effect, Low)
    .effect_acmd("effect_fly", ssbexo_rockman_leafshield_fly_effect, Low)
    .effect_acmd("effect_flyreverse", ssbexo_rockman_leafshield_fly_effect, Low)
    .install()
    ;
}