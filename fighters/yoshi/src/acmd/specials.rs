...
pub fn install() {
    ...
    .game_acmd("game_specialairsstart", ssbexo_yoshi_side_special_start_acmd, Low)
    .game_acmd("game_specialsloop", ssbexo_yoshi_side_special_loop_acmd, Low)
    .game_acmd("game_specialairsloop", ssbexo_yoshi_side_special_loop_acmd, Low)
    .install()
    ;
}