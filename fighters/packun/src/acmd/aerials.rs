...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_packun_nair_acmd, Low)
    .acmd("game_attackairf", ssbexo_packun_fair_acmd, Low)
    .acmd("game_attackairhi", ssbexo_packun_uair_acmd, Low)
    .acmd("game_attackairlw", ssbexo_packun_dair_acmd, Low)
    .install()
    ;
}