...
//Poison Breath Start ACMD
unsafe extern "C" fn ssbexo_packun_poison_breath_start_acmd(agent: &mut L2CAgentBase) {
...
pub fn install() {
    ...
    .game_acmd("game_start", ssbexo_packun_poison_breath_start_acmd, Low)
    .game_acmd("game_startmax", ssbexo_packun_poison_breath_start_acmd, Low)
    .install()
    ;
}