...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_packun_forward_tilt_1_acmd, Low)
    .acmd("game_attacks32", ssbexo_packun_forward_tilt_2_acmd, Low)
    .acmd("game_attackhi3", ssbexo_packun_up_tilt_acmd, Low)
    .acmd("game_attacklw3", ssbexo_packun_down_tilt_acmd, Low)
    .install()
    ;
}