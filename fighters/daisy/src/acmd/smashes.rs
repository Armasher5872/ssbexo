...
unsafe extern "C" fn ssbexo_daisy_forward_smash_expression(agent: &mut L2CAgentBase) {
    ...
    let boma = agent.module_accessor;
    if is_excute(agent) {
        AttackModule::set_attack_reference_joint_id(boma, Hash40::new("footl"), AttackDirectionAxis(*ATTACK_DIRECTION_Z), AttackDirectionAxis(*ATTACK_DIRECTION_X), AttackDirectionAxis(*ATTACK_DIRECTION_Y));
...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_daisy_forward_smash_acmd, Low)
    .acmd("effect_attacks4", ssbexo_daisy_forward_smash_effect, Low)
    .acmd("sound_attacks4", ssbexo_daisy_forward_smash_sound, Low)
    .acmd("expression_attacks4", ssbexo_daisy_forward_smash_expression, Low)
    .acmd("game_attacks4hi", ssbexo_daisy_forward_smash_acmd, Low)
    .acmd("effect_attacks4hi", ssbexo_daisy_forward_smash_effect, Low)
    .acmd("sound_attacks4hi", ssbexo_daisy_forward_smash_sound, Low)
    .acmd("expression_attacks4hi", ssbexo_daisy_forward_smash_expression, Low)
    .acmd("game_attacks4lw", ssbexo_daisy_forward_smash_acmd, Low)
    .acmd("effect_attacks4lw", ssbexo_daisy_forward_smash_effect, Low)
    .acmd("sound_attacks4lw", ssbexo_daisy_forward_smash_sound, Low)
    .acmd("expression_attacks4lw", ssbexo_daisy_forward_smash_expression, Low)
    .acmd("game_attackhi4", ssbexo_daisy_up_smash_acmd, Low)
    .acmd("effect_attackhi4", ssbexo_daisy_up_smash_effect, Low)
    .acmd("sound_attackhi4", ssbexo_daisy_up_smash_sound, Low)
    .acmd("expression_attackhi4", ssbexo_daisy_up_smash_expression, Low)
    .acmd("game_attacklw4", ssbexo_daisy_down_smash_acmd, Low)
    .acmd("effect_attacklw4", ssbexo_daisy_down_smash_effect, Low)
    .acmd("sound_attacklw4", ssbexo_daisy_down_smash_sound, Low)
    .acmd("expression_attacklw4", ssbexo_daisy_down_smash_expression, Low)
    .install()
    ;
}