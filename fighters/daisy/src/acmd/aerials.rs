...
pub fn install() {
    ...
    .acmd("game_attackairn", ssbexo_daisy_nair_acmd, Low)
    .acmd("effect_attackairn", ssbexo_daisy_nair_effect, Low)
    .acmd("sound_attackairn", ssbexo_daisy_nair_sound, Low)
    .acmd("expression_attackairn", ssbexo_daisy_nair_expression, Low)
    .acmd("game_attackairf", ssbexo_daisy_fair_acmd, Low)
    .acmd("effect_attackairf", ssbexo_daisy_fair_effect, Low)
    .acmd("sound_attackairf", ssbexo_daisy_fair_sound, Low)
    .acmd("expression_attackairf", ssbexo_daisy_fair_expression, Low)
    .acmd("game_attackairb", ssbexo_daisy_bair_acmd, Low)
    .acmd("effect_attackairb", ssbexo_daisy_bair_effect, Low)
    .acmd("sound_attackairb", ssbexo_daisy_bair_sound, Low)
    .acmd("expression_attackairb", ssbexo_daisy_bair_expression, Low)
    .acmd("game_attackairhi", ssbexo_daisy_uair_acmd, Low)
    .acmd("effect_attackairhi", ssbexo_daisy_uair_effect, Low)
    .acmd("sound_attackairhi", ssbexo_daisy_uair_sound, Low)
    .acmd("expression_attackairhi", ssbexo_daisy_uair_expression, Low)
    .acmd("game_attackairlw", ssbexo_daisy_dair_acmd, Low)
    .acmd("effect_attackairlw", ssbexo_daisy_dair_effect, Low)
    .acmd("sound_attackairlw", ssbexo_daisy_dair_sound, Low)
    .acmd("expression_attackairlw", ssbexo_daisy_dair_expression, Low)
    .install()
    ;
}