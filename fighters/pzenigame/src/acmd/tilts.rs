...
pub fn install() {
    ...
    .acmd("game_attacks3", ssbexo_pzenigame_forward_tilt_acmd, Low)
    .acmd("game_attacks3hi", ssbexo_pzenigame_forward_tilt_acmd, Low)
    .acmd("game_attacks3lw", ssbexo_pzenigame_forward_tilt_acmd, Low)
    .acmd("game_attackhi3", ssbexo_pzenigame_up_tilt_acmd, Low)
    .install()
    ;
}