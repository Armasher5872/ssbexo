...
pub fn install() {
    ...
    .acmd("game_attacks4", ssbexo_pzenigame_forward_smash_acmd, Low)
    .acmd("game_attacks4hi", ssbexo_pzenigame_forward_smash_hi_acmd, Low)
    .acmd("game_attacks4lw", ssbexo_pzenigame_forward_smash_lw_acmd, Low)
    .acmd("game_attackhi4", ssbexo_pzenigame_up_smash_acmd, Low)
    .install()
    ;
}