...
pub const FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_TWIN_FANG_STATURE_SMASH: LuaConst = LuaConst::new(0x200000FA);
pub const FIGHTER_DEMON_INSTANCE_WORK_ID_FLAG_TWIN_FANG_DOUBLE_KICK: LuaConst = LuaConst::new(0x200000FB);