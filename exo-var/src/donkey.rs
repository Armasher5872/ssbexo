...
pub const WEAPON_DONKEY_BARREL_STATUS_KIND_THROW: LuaConst = LuaConst::new(0x1);
pub const WEAPON_DONKEY_BARREL_STATUS_KIND_ROLL: LuaConst = LuaConst::new(0x2);
pub const WEAPON_DONKEY_BARREL_STATUS_KIND_IDLE: LuaConst = LuaConst::new(0x3);
pub const WEAPON_DONKEY_BARREL_STATUS_KIND_BREAK: LuaConst = LuaConst::new(0x4);
